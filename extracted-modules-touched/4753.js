...
(e, t, i) => {
  ...
  function v(e, t, i, s) {
    ...
    for (; e.length;) {
      const r = Math.max(1, (0, _.upperbound)(n, s, ((s, o) => (0, u.measureText)(e.slice(0, o + 1), t, i)
        .width > s), 0, e.length));
  ...
  function S(e, t, i, s = !0, o) {
    ...
    if ((0, u.measureText)("x", t, i)
      .width > o) return n;
    const r = [];
    for (let e = 0; e < n.length; e++) {
      const a = n[e];
      if ((0, u.measureText)(a.text, t, i)
        .width <= o) {
        r.push(a);
        continue
      }
      ...
      for (; d < l.length;) {
        ...
        let _ = n.length;
        if (n = `${h}${e.word}${e.spaces}`, a = (0, u.measureText)(n, t, i)
          .width, a < o) {
          h = n, d += 1;
          continue
        }
  ...
  class k {
    constructor(e, t) {
      this._data = null, this._textWidthCache = new p.TextWidthCache, this._internalData = null, this._boxSize = null,
        this._box = null, this._polygonPoints = null, this._linesInfo = null, this._fontInfo = null, this
    ...
    setData(e) {
      null !== e ? ((0, o.assert)(!e.decorator || void 0 === e.wordWrapWidth,
        ...
        void 0 === e.text && (e.text = ""), e.horzTextAlign || (e.horzTextAlign = e.horzAlign), ! function(e, t) {
          ...
          var i, s;
          return e.text === t.text && e.decorator === t.decorator && e.vertAlign === t.vertAlign && e.horzAlign ===
            t.horzAlign && e.horzTextAlign === t.horzTextAlign && e.font === t.font && e.offsetX === t.offsetX && e
            .offsetY === t.offsetY && e.bold === t.bold && e.italic === t.italic && e.fontsize === t.fontsize && e
            .fontSize === t.fontSize && e.backgroundRoundRect === t.backgroundRoundRect && e.forceTextAlign === t
            .forceTextAlign && e.wordWrapWidth === t.wordWrapWidth && e.forceCalculateMaxLineWidth === t
            .forceCalculateMaxLineWidth && e.lineHeight === t.lineHeight && e.lineSpacing === t.lineSpacing && e
            .scale === t.scale && e.boxPadding === t.boxPadding && e.boxPaddingVert === t.boxPaddingVert && e
            .boxPaddingLeft === t.boxPaddingLeft && e.boxPaddingRight === t.boxPaddingRight && e.boxPaddingHorz ===
            t.boxPaddingHorz && e.angle === t.angle && e.maxHeight === t.maxHeight && e.outlineBorder?.width === t
            .outlineBorder?.width && e.outlineBorder?.color === t.outlineBorder?.color
    ...
    isOutOfScreen(e, t) {
      ...
      if (i + o < 0 || i > e) {
        ...
        return this.getPolygonPoints()
          .every((e => !(0, n.pointInBox)(e, i)))
      }
      return !1
    }
    setPoints(e, t) {
      (0, o.ensureNotNull)(this._data)
      .points = e, this._hitTest = t || new l.HitTestResult(l.HitTarget.MovePoint)
    }
    setPoint(e, t, i) {
    ...
    fontStyle(e) {
      return null === this._data ? "" : this._getFontInfo()
        .fontStyle
    }
    lineHeight() {
    ...
    draw(e, t) {
      ...
      if (this._data.backgroundColor || this._data.borderColor) {
        ...
        if (this._data.backgroundRoundRect) {
          ...
          s && ((0, c.drawRoundRect)(e, _, m, p - _, g - m, o * n), e.closePath(), e.fillStyle = s, e.fill(), t && (e
            .restore(), t = !1)), i && ((0, c.drawRoundRect)(e, _ - v, m - v, p - _ + y, g - m + y, o * n + y), e
          ...
          s && (e.fillStyle = s, e.fillRect(_, m, p - _, g - m), t && (e.restore(), t = !1)), i && (e.strokeStyle = i,
            e.lineWidth = y, e.beginPath(), e.moveTo(_ - v, m - v), e.lineTo(_ - v, g + v), e.lineTo(p + v, g + v),
            e.lineTo(p + v, m - v), e.lineTo(_ - v, m - v), e.closePath(), e.stroke(), t && e.restore())
        }
      }
    ...
    _getLinesMaxWidth(e) {
      ...
      if (null !== this._data && this._data.wordWrapWidth && !this._data.forceCalculateMaxLineWidth) return this._data
        .wordWrapWidth * A(this._data);
      let i = 0;
      for (const s of e) i = Math.max(i, (0, u.measureText)(s.text, t, this._textWidthCache)
        .width);
      return i
    }
    _getBoxSize() {
