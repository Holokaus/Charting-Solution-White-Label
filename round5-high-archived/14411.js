...
14411: (watchedValue_e, t, i) => {
    "use strict";
    i.d(t, {
      ChartChangesWatcher: () => a,
      changedAll: () => r
    });
    var watchedValue_s, o = i(67455),
    ...
    class a {
      constructor(watchedValue_e, t, i) {
        this._undoHistoryHasChanges = !1, this._changesMask = 0, this._handleLayoutNameChanged = () => {
            ...
            this._changesMask = t | i, watchedValue_e !== this._changesMask && this._onValueChanged.fire(0 !== this._changesMask)
          ...
          .lineToolsSynchronizerHasChanges, this._chartSaver = t, this._globalEvents = i, this._onValueChanged = new watchedValue_n
