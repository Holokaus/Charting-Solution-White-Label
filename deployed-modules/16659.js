...
16659: (watchedValue_e, watchedValue_t, watchedValue_i) => {
    "use strict";
    watchedValue_i.watchedValue_d(watchedValue_t, {
      CircularCacheBuffer: () => watchedValue_r
    });
    ...
    function watchedValue_n(watchedValue_e) {
      const {
        ...
        nextItem: watchedValue_i
      } = watchedValue_e;
      null !== watchedValue_t && (watchedValue_t.nextItem = watchedValue_i), null !== watchedValue_i && (watchedValue_i.prevItem = watchedValue_t)
    ...
    class watchedValue_r {
      ...
      set(watchedValue_e, watchedValue_t) {
        ...
        null !== this._lastItem && (this._lastItem.nextItem = watchedValue_i);
        const watchedValue_s = this._cache.get(watchedValue_e);
        return void 0 !== watchedValue_s && (watchedValue_n(watchedValue_s), watchedValue_s === this._firstItem && (this._firstItem = watchedValue_s.nextItem)), this._cache.set(watchedValue_e, watchedValue_i),
          this._lastItem = watchedValue_i, null === this._firstItem && (this._firstItem = watchedValue_i), this._sizeLimited && this._cache
      ...
      get(watchedValue_e) {
        ...
        if (watchedValue_t === this._firstItem && (this._firstItem = watchedValue_t.nextItem ?? watchedValue_t), watchedValue_t !== this._lastItem) {
          ...
          const watchedValue_e = (0, watchedValue_o.ensureNotNull)(this._lastItem);
      ...
      state() {
        ...
        for (const [watchedValue_t, watchedValue_i] of this.entries()) watchedValue_e.push([watchedValue_t, watchedValue_i]);
      ...
      _removeExtraItems() {
        ...
        let watchedValue_t = (0,
          watchedValue_o.ensureNotNull)(this._firstItem);
        for (let watchedValue_i = 0; watchedValue_i < watchedValue_e; watchedValue_i += 1) this._cache.delete(watchedValue_t.key), watchedValue_t = (0, watchedValue_o.ensureNotNull)(watchedValue_t.nextItem);
