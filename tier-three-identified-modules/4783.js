 ...
 * Semantic: series
 * Confidence: 100.0%
 * Generated: 2026-05-03T17:33:52.718Z
...
4783: (exports, t, i) => {
    "use strict";
    const series = i(58978).getHexColorByName,
      o = i(19979).Std,
      newSeries = s("color-ripe-red-100"),
    ...
    JSServer.studyLibrary = [{
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i, s) {
          return o.or(o.and(o.eq(exports, t), o.eq(exports, i)), o.eq(t, i)) ? 0 : (2 * e - i - t) / (t - i) * s
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          var i = t.new_var(o.open(t)),
            series = t.new_var(o.high(t)),
            newSeries = t.new_var(o.low(t)),
            ...
            d = o.max(a, l),
            u = o.iff(a >= o.max(l, c), a - .5 * l + .25 * h, o.iff(l >= o.max(a, c), l - .5 * a + .25 * h, c +
              .25 * h));
          return o.iff(0 === u, 0, (r - r.get(1) + .5 * (r - i) + .25 * (r.get(1) - i.get(1))) / u * d / e * 50)
        }, this.f_1 = function(exports, t) {
          var i = this.f_0(exports, t);
          return o.cum(i, t)
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this._input(0);
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          return o.gt(exports, t)
        }, this.f_1 = function(exports, t) {
          return o.lt(exports, t)
        }, this.f_2 = function(exports, t) {
          return 0 === t ? e : e / t
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this._input(0),
            series = this.f_0(o.close(this._context), o.open(this._context)),
            newSeries = this._context.new_var(series),
            r = o.sum(newSeries, i, this._context),
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = o.close(this._context),
            series = this._input(0),
            newSeries = this._input(1),
            r = this._input(2),
            a = this._context.new_var(i);
          return [o.alma(a, series, newSeries, r)]
        }
      }
    }, {
      name: "Aroon",
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          this._context = exports, this._input = t;
          var i = this._input(0),
            series = o.high(this._context),
            newSeries = i + 1,
            r = this._context.new_var(series),
            a = o.highestbars(r, newSeries, this._context),
            l = this.f_0(a, i),
            c = o.low(this._context),
            h = this._context.new_var(c),
            d = o.lowestbars(h, newSeries, this._context);
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, "" !== t(0) && this._context.new_sym(t(0), o.period(this._context))
        }, this.main = function(exports, t) {
          if (this._context = exports, this._input = t, "" === this._input(0)) return [o.ohlc4(this._context)];
          this._context.select_sym(0);
          const i = this._context.new_var(this._context.symbol.time);
          this._context.select_sym(1);
          const series = this._context.new_var(o.ohlc4(this._context)).adopt(this._context.new_var(this._context
            .symbol.time), i, 1);
      ...
      constructor: function() {
        this.f_0 = function(exports) {
            var t = this._context.new_var(o.high(this._context)),
              i = o.change(t),
              series = this._context.new_var(o.low(this._context)),
              newSeries = -o.change(series),
              r = this._context.new_var(o.tr(void 0, this._context)),
              a = o.rma(r, exports, this._context),
              l = this._context.new_var(o.and(o.gt(i, n), o.gt(i, 0)) ? i : 0),
              c = o.fixnan(100 * o.rma(l, exports, this._context) / a, this._context),
              h = this._context.new_var(o.and(o.gt(newSeries, i), o.gt(newSeries, 0)) ? n : 0);
            return [c, o.fixnan(100 * o.rma(h, exports, this._context) / a, this._context)]
          }, this.f_1 = function(exports, t) {
            var i = this.f_0(exports),
              series = i[0],
              newSeries = i[1],
              r = s + newSeries,
          ...
          this.main = function(exports, t) {
            return this._context = exports, this._input = t, this._context.setMinimumAdditionalDepth(this._input(0) +
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          return o.le(exports, 0) ? 0 : 1
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = o.hl2(this._context),
            series = this._context.new_var(i),
            newSeries = o.sma(series, 5, this._context),
            r = this._context.new_var(i),
            a = o.sma(r, 34, this._context),
            l = this.f_0(newSeries, a),
            c = l,
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i, s) {
          ...
          return this._context = exports, this._input = t, [this.f_0(o.close(this._context), o.open(this._context), o
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var i = o.close(this._context),
            ...
            newSeries = this._input(1),
            r = this._context.new_var(i),
            a = o.sma(r, series, this._context),
            l = this._context.new_var(i),
            c = o.stdev(l, series, this._context),
            h = this.f_0(newSeries, c);
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var i = this._context.new_var(o.time(this._context)),
            series = o.close(this._context),
            newSeries = this._input(0),
            r = this._input(1),
            a = this._input(2),
            l = this._input(3);
          if ("" !== n) {
            ...
            series = this._context.new_var(o.close(this._context)).adopt(c, i, 1), this._context.select_sym(0)
          }
          var h = this._context.new_var(series),
            d = o.sma(h, r, this._context),
            u = this._context.new_var(series),
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i, s) {
          ...
          this._context = exports, this._input = t;
          var i = this._input(0),
            series = this.f_0(o.close(this._context), o.high(this._context), o.low(this._context), o.volume(this
              ._context)),
            newSeries = this._context.new_var(series),
            r = o.sum(newSeries, i, this._context),
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          this._context = exports, this._input = t;
          var i = this._input(0),
            series = this._input(1),
            newSeries = o.accdist(this._context),
            r = this._context.new_var(newSeries),
            a = o.ema(r, i, this._context),
            l = this._context.new_var(newSeries),
            c = o.ema(l, series, this._context);
          return [this.f_0(a, c)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.period = this._input(0), this.rocLookback = this._input(1)
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t, this._context.setMinimumAdditionalDepth(this.period + this
            .rocLookback);
          var i = this._context.new_var(o.high(this._context) - o.low(this._context)),
            series = this._context.new_var(o.ema(i, this.period, this._context));
          return [o.roc(series, this.rocLookback)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i) {
          return e - t * i
        }, this.f_1 = function(exports, t, i) {
          return e + t * i
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this._input(0),
            series = this._input(1),
            newSeries = this._input(2),
            r = o.high(this._context),
            a = this._context.new_var(r),
            l = o.highest(a, i, this._context),
            c = o.atr(i, this._context),
            h = this.f_0(l, series, c),
            d = this._context.new_var(r),
            u = o.lowest(d, i, this._context),
            _ = this.f_1(u, series, c),
            p = this._context.new_var(h),
            m = o.highest(p, newSeries, this._context),
            g = this._context.new_var(_);
          return [o.lowest(g, newSeries, this._context), m]
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function(exports) {
          return o.ge(exports, 0) ? e : 0
        }, this.f_1 = function(exports) {
          return o.ge(exports, 0) ? 0 : -e
        }, this.f_2 = function(exports, t) {
          return 100 * e / t
        }, this.f_3 = function(exports, t) {
      ...
      constructor: function() {
        this.f_0 = function() {
          var exports = o.close(this._context),
            t = o.hlc3(this._context),
            i = this._context.new_var(o.high(this._context)),
            series = o.highest(i, 30, this._context),
            newSeries = o.lowest(i, 30, this._context),
            r = 25 / (s - n) * newSeries,
            a = this._context.new_var(exports),
          ...
          return this._context = exports, this._input = t, this.f_0()
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i) {
          ...
          var a, l = this._context.new_var(i),
            c = o.sma(l, series, this._context),
            h = this._context.new_var(i),
            d = o.dev(h, series, this._context),
            u = this.f_0(i, c, d),
            _ = this._context.new_var(u);
          return "EMA" === n ? a = o.ema(_, r, this._context) : "WMA" === n ? a = o.wma(_, r, this._context) :
            "SMA" === n && (a = o.sma(_, r, this._context)), [u, a]
        }
      }
    }, {
      name: "Connors RSI",
      ...
      constructor: function() {
        var exports;
        this.f_1 = function(exports, t, i) {
          var series = i.new_var(o.max(o.change(exports), 0));
          return o.rma(series, t, i)
        }, this.f_2 = function(exports, t, i) {
          var series = i.new_var(-o.min(o.change(exports), 0));
          return o.rma(series, t, i)
        }, this.f_3 = (exports = 0, function(t) {
          var i = t.get(0),
            series = t.get(1);
          return exports = i === s ? 0 : i > s ? o.nz(exports) <= 0 ? 1 : o.nz(exports) + 1 : o.nz(exports) >= 0 ? -1 : o.nz(exports) - 1,
          ...
          var l = o.rsi(this.f_1(series, newSeries, this._context), this.f_2(series, newSeries, this._context)),
            c = this.f_3(series),
            h = o.rsi(this.f_1(c, r, this._context), this.f_2(c, r, this._context)),
            d = this._context.new_var(o.roc(series, 1)),
            u = o.percentrank(d, a);
          return [o.avg(l, h, u)]
        }
      }
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var i = this._input(0),
            series = this._input(1),
            newSeries = this._input(2);
          this._context.setMinimumAdditionalDepth(i + Math.max(series, n));
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this._context.new_sym(this._input(0), o.period(this._context))
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this._context.new_unlimited_var(this._context.symbol.time),
            series = (this._input(0), o.period(this._context), o.close(this._context)),
            newSeries = this._input(1);
          this._context.select_sym(1);
          ...
          this._context.select_sym(0);
          var c = l.adopt(r, i, 0),
            h = this._context.new_var(series),
            d = this._context.new_var(c);
          return [o.correlation(h, d, newSeries, this._context)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
        ...
        }, this.correlationLog = function(exports, t, i, s) {
          var newSeries = o.sma(exports, i, s),
            r = o.sma(t, i, s),
            a = series.new_var(exports.get() * t.get());
          return (o.sma(a, i, s) - n * r) / Math.sqrt(o.variance2(exports, newSeries, i) * o.variance2(t, r, i))
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this._context.new_var(this._context.symbol.time);
          this._context.select_sym(2);
          var series = this._context.new_var(o.close(this._context)),
            newSeries = this._context.new_var(o.log(series.get() / series.get(1))),
          ...
          var a = this._context.new_var(this._context.symbol.time),
            ...
            h = this._context.new_var(newSeries.adopt(r, a, 0)),
      ...
      constructor: function() {
        this.f_0 = function() {
          ...
          var series = this._context.new_var(o.close(this._context)),
            newSeries = this._context.new_var(o.sma(series, exports, this._context)),
            r = this._context.new_var(o.close(this._context)).get(i) - newSeries,
            a = o.close(this._context) - newSeries.get(i);
          return [t ? r : a, t ? -i : 0]
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this.f_0();
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = this._input(0),
            series = this._input(1);
          return this._context.setMinimumAdditionalDepth(2 * i + s), o.dmi(i, series, this._context)
        }
      }
    }, {
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = this._input(0),
            series = this._input(1),
            newSeries = o.low(this._context),
            r = this._context.new_var(newSeries);
          this._context.setMinimumAdditionalDepth(i + Math.max(series, 0));
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var series = o.close(this._context),
            newSeries = this._context.new_var(series),
            r = o.ema(newSeries, i, this._context),
            a = this._context.new_var(r),
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i, series, o) {
          return e * t * (i - s) / o
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this._input(0),
            series = this._input(1),
            newSeries = o.hl2(this._context),
            r = this._context.new_var(newSeries),
            a = o.change(r),
            l = this.f_0(i, a, o.high(this._context), o.low(this._context), o.volume(this._context)),
            c = this._context.new_var(l);
          return [o.sma(c, series, this._context)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var i = this._input(0),
            series = this._input(1),
            newSeries = o.close(this._context),
            r = this._context.new_var(newSeries),
            a = o.ema(r, i, this._context),
            l = this._context.new_var(newSeries),
            c = o.ema(l, series, this._context),
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var i = this._context.new_var(o[this._input(4)](this._context)),
            series = o.sma(i, this._input(0), this._context);
          return "Exponential" === this._input(3) ? series = o.ema(i, this._input(0), this._context) : "Weighted" ===
            this._input(3) && (series = o.wma(i, this._input(0), this._context)), [this.f_0(series, this._input(1) / 100),
              series, this.f_1(series, this._input(2) / 100)
            ]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.period = this._input(0)
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          for (var i, series, newSeries = this._context.new_var(o.close(this._context)), r = 0, a = 0, l = 0; l < this
            .period; l++) r += l + 1, a += newSeries.get(l);
          i = r / this.period, series = a / this.period;
          var c = 0,
            h = 0,
            d = 0;
          for (l = 0; l < this.period; l++) d += Math.pow(s - newSeries.get(l), 2), h += (i - l - 1) * (s - newSeries.get(l)),
            c += Math.pow(i - l - 1, 2);
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.period = this._input(0), this.errorDeviation = this._input(
          ...
          var u, _, p, m = Math.sqrt((d - h / c) / (this.period - 2)),
            g = o.linreg(newSeries, this.period, 0),
      ...
      constructor: function() {
        this.f_0 = function(exports) {
          var t = o.lt(exports, -.99) ? -.999 : exports;
          return [o.gt(exports, .99) ? .999 : t]
        }, this.f_1 = function() {
          var exports = this._input(0),
            t = this._context.new_var(o.hl2(this._context)),
            i = o.highest(t, exports, this._context),
            series = this._context.new_var(o.hl2(this._context)),
            newSeries = o.lowest(series, exports, this._context),
            r = this._context.new_var(),
            a = this.f_0(.66 * ((o.hl2(this._context) - n) / o.max(i - newSeries, .001) - .5) + .67 * o.nz(r.get(1)));
          r.set(a[0]);
          ...
          return this._context = exports, this._input = t, this.f_1()
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function() {
          var exports = this._input(0),
            t = o.or(o.isintraday(this._context), o.and(o.isdaily(this._context), o.eq(o.interval(this
              ._context), 1))) ? 1 : 7,
            i = this._context.new_var(o.close(this._context)),
            series = this._context.new_var(o.log(o.close(this._context) / i.get(1)));
          return [100 * o.stdev(series, exports, this._context) * o.sqrt(365 / t)]
        }, this.main = function(exports, t) {
          return this._context = exports, this._input = t, this.f_0()
        }
      }
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var r = this._context.new_var(i),
            a = o.wma(r, newSeries, this._context),
            l = this._context.new_var(i),
            c = o.wma(l, series, this._context),
            h = this.f_0(a, c),
            d = o.sqrt(series),
            u = o.round(d),
      ...
      constructor: function() {
        this.donchian = function(exports, t, i) {
          var series = this._context.new_var(exports),
            newSeries = this._context.new_var(t);
          return o.avg(o.lowest(series, i, this._context), o.highest(newSeries, i, this._context))
        }, this.f_1 = function() {
          var exports = this._input(1),
            t = this._input(2),
            i = this._input(3),
            series = this._input(4) - 1,
            newSeries = this._input(5) - 1,
          ...
          if ("" !== this._input(0)) {
            ...
            a = this._context.new_var(d).adopt(h, r, 1), l = this._context.new_var(u).adopt(h, r, 1), c = this
          ...
          return [p, m, a, g, f, -s, series, newSeries, o.gt(g, f) ? 0 : 1]
        }, this.init = function(exports, t) {
          this._context = exports, "" !== t(0) && this._context.new_sym(t(0), o.period(this._context))
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i, s) {
          ...
          var i = o.close(this._context),
            ...
            r = this._input(2),
            a = this._context.new_var(i),
            l = o.ema(a, newSeries, this._context),
            c = this.f_0(series, o.tr(void 0, this._context), o.high(this._context), o.low(this._context)),
            h = this._context.new_var(c),
            d = o.ema(h, newSeries, this._context);
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var series = this._context.new_var(i),
            newSeries = o.change(series),
            r = this.f_0(newSeries, o.volume(this._context)),
            a = this._context.new_var(r),
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i, s) {
          ...
          var i = this._input(0),
            ...
            h = this._input(7),
            d = this._input(8);
          this._context.setMinimumAdditionalDepth(Math.max(a + i, l + series, c + newSeries, h + r) + d);
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = o.close(this._context),
            series = this._input(0),
            newSeries = this._context.new_var(i);
          return [o.linreg(newSeries, series, 0)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.period = this._input(0)
        }, this.linregSlope = function(exports, t, i) {
          var series, o, newSeries, r = 0,
            a = 0,
            l = 0,
            c = 0;
          for (series = 0; s < t; ++s) r += newSeries = t - 1 - s + 1, a += o = exports.get(series), l += n * newSeries, c += o * newSeries;
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          this._context = exports, this._input = t;
          var i = this._input(0),
            series = this.f_0(o.high(this._context), o.low(this._context)),
            newSeries = this._context.new_var(series),
            r = o.ema(newSeries, 9, this._context),
            a = this._context.new_var(r),
      ...
      constructor: function() {
        this.f_0 = function() {
          var exports = this._input(0),
            ...
            series = o.ema(i, exports, this._context),
            newSeries = this._context.new_var(),
            r = newSeries.get(1) + (t - newSeries.get(1)) / (e * o.pow(t / newSeries.get(1), 4));
          return newSeries.set(o.na(newSeries.get(1)) ? s : o.nz(r, s)), [newSeries.get(0)]
        }, this.main = function(exports, t) {
          return this._context = exports, this._input = t, this.f_0()
        }
      }
      ...
      constructor: function() {
        this.main = function(exports, t) {
          return this._context = exports, this._input = t, [o.hl2(this._context)]
        }
      }
    }, {
      name: "Momentum",
      ...
      constructor: function() {
        this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this._input(0),
            series = o[this._input(1)](this._context),
            newSeries = this._context.new_var(series).get(i);
          return [n ? s - n : null]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          ...
          this._context = exports, this._input = t;
          var i = this._context.new_var(this._context.symbol.time),
            series = o[this._input(2)](this._context),
            newSeries = this._input(1),
            r = this._input(3),
            a = this._input(4),
            l = this._input(5);
          if (this._context.setMinimumAdditionalDepth(n + l), "" !== this._input(0)) {
            ...
            series = this._context.new_var(h).adopt(c, i, 1), this._context.select_sym(0)
          }
          var d, u = this._context.new_var(series),
            _ = o.sma(u, newSeries, this._context),
            p = this._context.new_var(_);
          return "EMA" === a ? d = o.ema(p, l, this._context) : "WMA" === a ? d = o.wma(p, l, this._context) :
            "SMA" === a && (d = o.sma(p, l, this._context)), [{
              value: _,
              offset: r
            }, {
              value: d,
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = o.high(this._context),
            ...
            h = this._context.new_var(series);
          return [{
            value: o.sma(c, newSeries, this._context),
            offset: a
          }, {
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var t = e > 0 ? 1 : 3,
            i = o.change(this._context.new_var(exports));
          ...
          this._context = exports, this._input = t;
          var i = this._context.new_var(this._context.symbol.time),
            series = o[this._input(3)](this._context),
            newSeries = this._input(1),
            r = this._input(2),
            a = this._input(4),
            l = this._input(5),
            c = this._input(6);
          if (this._context.setMinimumAdditionalDepth(Math.max(newSeries, r) + a), "" !== this._input(0)) {
            this._context.select_sym(1);
            var h = this._context.new_var(this._context.symbol.time),
              d = o[this._input(3)](this._context);
            series = this._context.new_var(d).adopt(h, i, 0), this._context.select_sym(0)
          }
          var u, _, p = this._context.new_var(series);
          "EMA" === l ? u = o.ema(p, newSeries, this._context) : "WMA" === l ? u = o.wma(p, newSeries, this._context) :
            "SMA" === l && (u = o.sma(p, newSeries, this._context)), "EMA" === l ? _ = o.ema(p, r, this._context) :
            "WMA" === l ? _ = o.wma(p, r, this._context) : "SMA" === l && (_ = o.sma(p, r, this._context));
          var m, g = this.f_0(u, _),
            f = this._context.new_var(g);
          "EMA" === c ? m = o.ema(f, a, this._context) : "WMA" === c ? m = o.wma(f, a, this._context) :
            "SMA" === c && (m = o.sma(f, a, this._context));
          var y = this.f_0(g, m);
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var l, c = this._context.new_var(i),
            h = o.ema(c, series, this._context),
            d = this._context.new_var(h);
          return "EMA" === r ? l = o.ema(d, a, this._context) : "WMA" === r ? l = o.wma(d, a, this._context) :
            "SMA" === r && (l = o.sma(d, a, this._context)), [{
              value: h,
              offset: n
            }, {
              value: l,
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = o[this._input(1)](this._context),
            ...
            r = this._context.new_var(i);
          return [{
            value: o.wma(r, series, this._context),
            offset: n
          }]
        }
      }
      ...
      constructor: function() {
        this.init = function(exports, t) {
          ...
          if ("" !== this._input(0)) {
            this._context.select_sym(1);
            var newSeries = this._context.new_var(o.time(this._context)),
              r = o.close(this._context);
            series = this._context.new_var(r).adopt(newSeries, i, 1), this._context.select_sym(0)
          }
          var a, l, c = this._context.new_var(series);
          return "Exponential" === this._input(2) ? (a = o.ema(c, this._input(1), this._context), l = o.ema(c,
            this._input(2), this._context)) : "Weighted" === this._input(2) ? (a = o.wma(c, this._input(1),
            this._context), l = o.wma(c, this._input(2), this._context)) : (a = o.sma(c, this._input(1), this
            ._context), l = o.sma(c, this._input(2), this._context)), [a, l]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          ...
          if ("" !== this._input(0)) {
            this._context.select_sym(1);
            var newSeries = this._context.new_var(this._context.symbol.time),
              r = o.close(this._context);
            series = this._context.new_var(r).adopt(newSeries, i, 1), this._context.select_sym(0)
          }
          var a, l, c, h = this._context.new_var(series);
          return "Exponential" === this._input(4) ? (a = o.ema(h, this._input(1), this._context), l = o.ema(h,
              this._input(2), this._context), c = o.ema(h, this._input(3), this._context)) : "Weighted" === this
            ._input(4) ? (a = o.wma(h, this._input(1), this._context), l = o.wma(h, this._input(2), this
              ._context), c = o.wma(h, this._input(3), this._context)) : (a = o.sma(h, this._input(1), this
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.periods = this._input(0)
        }, this.ama = function(exports, t) {
          var i = this.periods,
            series = this._context.new_var(),
            newSeries = exports.get(),
            r = o.stdev(t, i, this._context),
            a = o.log(n / exports.get(i)) / (r * Math.sqrt(i)),
            l = .1 * Math.abs(a),
            c = (n - series.get(1)) * l + series.get(1);
          return series.set(isNaN(c) ? n : c), c
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this._context.new_var(o.close(this._context)),
            series = this._context.new_var(o.log(i.get() / i.get(1)));
          return [this.ama(i, s)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.periods = this._input(0);
          for (var i = [], series = 0, o = 1; o <= this.periods; ++o) {
            var newSeries = Math.sin((1 + o) / this.periods * Math.PI / 2);
            i.unshift(newSeries), s += n
          }
          this.hmaFactors = i, this.hmaFactorsSum = s
        }, this.hma = function(exports) {
          for (var t = this.periods, i = 0, series = 0; s < t; ++s) i += exports.get(t - s - 1) * this.hmaFactors[s];
      ...
      constructor: function() {
        this.init = function(exports, t) {
          ...
          var a, l, c, h, d, u, _ = this._context.new_var(series);
          return "Exponential" === this._input(7) ? (a = o.ema(_, this._input(1), this._context), l = o.ema(_,
            ...
            ._input(6), this._context)) : "Weighted" === this._input(7) ? (a = o.wma(_, this._input(1), this
            ...
            ._context), u = o.wma(_, this._input(6), this._context)) : (a = o.sma(_, this._input(1), this
            ...
            ._context), u = o.sma(_, this._input(6), this._context)), [a, l, c, h, d, u]
        }
      }
    }, {
      name: "Majority Rule",
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.rollingPeriod = this._input(0)
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i, series = o.close(this._context);
          return i = s > this._context.new_var(series).get(1) ? 1 : 0, [100 * o.sma(this._context.new_var(i), this
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i) {
          return o.gt(exports, 0) ? t : o.lt(i, 0) ? -t : 0 * t
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = o.close(this._context),
            series = this._context.new_var(i),
            newSeries = o.change(series);
          return [this.f_0(newSeries, o.volume(this._context), n)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i) {
          ...
          this._context.setMinimumAdditionalDepth(series);
          var h, d = this._context.new_var(c);
          return "EMA" === i ? h = o.ema(d, series, this._context) : "WMA" === i ? h = o.wma(d, series, this._context) :
            "SMA" === i && (h = o.sma(d, series, this._context)), [c, h]
        }
      }
    }, {
      name: "Parabolic SAR",
      ...
      constructor: function() {
        this.init = function(exports, t) {
          ...
          this._context.select_sym(0);
          const series = this._context.new_var(this._context.symbol.time);
          this._context.select_sym(1);
          const newSeries = this._context.new_var(i()).adopt(this._context.new_var(this._context.symbol.time), series, 1);
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = o.high(this._context),
            ...
            a = this._input(0),
            l = this._input(1),
            c = o.highest(series, a, this._context),
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var i = o.close(this._context),
            ...
            a = o.sma(r, series, this._context),
            l = this._context.new_var(i),
            c = o.sma(l, newSeries, this._context);
          return [this.f_0(a, c)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function() {
          var exports = this._context.new_var(o.close(this._context));
          return [o.cum(o.change(exports) / exports.get(1) * o.volume(this._context), this._context)]
        }, this.main = function(exports, t) {
      ...
      constructor: function() {
        this.orderRank = function(exports, t, i) {
          let series = exports.get(t),
            newSeries = 1,
            r = 0;
          for (let t = 0; t < i; t++) {
            const i = exports.get(t);
            if (o.na(i)) return o.na();
            s < i ? n += 1 : series === i && (r += 1)
          }
          return n + (r - 1) / 2
        }, this.rankDifferences = function(exports, t) {
          var i = 0;
          for (let series = 0; s < t; s++) i += Math.pow(s + 1 - this.orderRank(exports, series, t), 2);
          return i
        }, this.rci = function(exports, t) {
          return 1 - 6 * this.rankDifferences(exports, t) / (t * (t * t - 1))
        }, this.main = function(exports, t) {
          var i = exports.new_var(o.close(exports)),
            series = t(0);
          return [this.rci(i, s)]
        }
      }
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = this._context.new_var(o.close(this._context)),
            series = this._input(0);
          return [100 * (i.get(0) - i.get(series)) / i.get(series)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function(exports) {
          return o.max(exports, 0)
        }, this.f_1 = function(exports) {
          return -o.min(exports, 0)
        }, this.f_2 = function(exports, t) {
          return o.eq(exports, 0) ? 100 : o.eq(t, 0) ? 0 : 100 - 100 / (1 + t / e)
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = o.close(this._context),
            series = this._input(0),
          ...
          var a, l = this._context.new_var(i),
            ...
            h = this.f_0(c),
            d = this._context.new_var(h),
            u = o.rma(d, series, this._context),
            _ = this.f_1(c),
            p = this._context.new_var(_),
            m = o.rma(p, series, this._context),
            g = this.f_2(m, u),
            f = this._context.new_var(g);
          return "EMA" === n ? a = o.ema(f, r, this._context) : "WMA" === n ? a = o.wma(f, r, this._context) :
            "SMA" === n && (a = o.sma(f, r, this._context)), [{
              value: g
            }, {
              value: a
            }]
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var i = this._input(0),
            series = this.f_0(o.close(this._context), o.open(this._context)),
            newSeries = this._context.new_var(series),
            r = o.swma(newSeries, this._context),
            a = this._context.new_var(r),
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          return o.le(exports, 0) ? 0 : t
        }, this.f_1 = function(exports, t) {
          return o.gt(exports, 0) ? 0 : t
        }, this.f_2 = function(exports, t) {
          return e / (e + t) * 100
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          ...
          var series = o.close(this._context),
            newSeries = this._context.new_var(series),
            r = o.stdev(newSeries, i, this._context),
            a = this._context.new_var(series),
            l = o.change(a),
            c = this.f_0(l, r),
            h = this._context.new_var(c),
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var r = o.close(this._context),
            a = this._context.new_var(r),
            l = o.tsi(a, i, series, this._context),
            c = this._context.new_var(l),
            h = o.ema(c, newSeries, this._context);
      ...
      constructor: function() {
        this.f_0 = function() {
          ...
          return [o.smma(t, exports, this._context)]
        }, this.main = function(exports, t) {
          return this._context = exports, this._input = t, this.f_0()
        }
      }
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = this._input(0),
            series = this._input(1),
            newSeries = this._context.new_var(o.close(this._context));
          return [o.stdev(newSeries, i, this._context) * s]
        }
      }
    }, {
      name: "Stochastic",
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var r = o.close(this._context),
            ...
            _ = this._context.new_var(u),
            p = o.sma(_, series, this._context),
            m = this._context.new_var(p);
          return [p, o.sma(m, newSeries, this._context)]
        }
      }
    }, {
      name: "Stochastic RSI",
      ...
      constructor: function() {
        this.f_1 = function(exports, t, i) {
          ...
          var i = o.close(this._context),
            ...
            r = this._input(2),
            a = this._input(3);
          exports.setMinimumAdditionalDepth(s + n + r + a);
          var l = this._context.new_var(i),
            c = o.rsi(this.f_1(l, series, this._context), this.f_2(l, series, this._context)),
            h = this._context.new_var(c),
            d = this._context.new_var(c),
            u = this._context.new_var(c),
            _ = o.stoch(h, d, u, newSeries, this._context),
            p = this._context.new_var(_),
      ...
      constructor: function() {
        this.f_0 = function(exports) {
          return o.log(exports)
        }, this.f_1 = function(exports) {
          return 1e4 * e
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          var i = this._input(0);
          exports.setMinimumAdditionalDepth(3 * i);
          var series = this.f_0(o.close(this._context)),
            newSeries = this._context.new_var(series),
            r = o.ema(newSeries, i, this._context),
            a = this._context.new_var(r),
            l = o.ema(a, i, this._context),
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var r = o.close(this._context),
            a = this._context.new_var(r),
            l = o.tsi(a, series, i, this._context),
            c = this._context.new_var(l);
          return [l, o.ema(c, newSeries, this._context)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.period = this._input(0), this.invertedPeriod = 1 / this
          ...
          for (var exports = this._context.new_var(o.close(this._context)), t = o.sum(exports, this.period, this._context),
              i = 0, series = 0, newSeries = 0; n < this.period; n++) {
            var r = exports.get(newSeries);
          ...
          return this._context = exports, this._input = t, [this.trendStrengthIndex()]
        }
      }
    }, {
      name: "Typical Price",
      ...
      constructor: function() {
        this.main = function(exports, t) {
          return this._context = exports, this._input = t, [o.hlc3(this._context)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i) {
          var series = this._context.new_var(exports),
            newSeries = this._context.new_var(t);
          return [o.sum(series, i, this._context) / o.sum(newSeries, i, this._context)]
        }, this.f_1 = function() {
          var exports = this._input(0),
            t = this._input(1),
            i = this._input(2),
            series = this._context.new_var(o.close(this._context)),
            newSeries = o.max(o.high(this._context), series.get(1)),
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.period = this._input(0), this.daysPerYear = this._input(1)
        }, this.stdev = function(exports, t, i) {
          var series = this.variance(exports, t, i);
          return o.sqrt(series)
        }, this.variance = function(exports, t, i) {
          var series = o.sma(exports, t, i);
          return this.variance2(exports, series, t)
        }, this.variance2 = function(exports, t, i) {
          var series, o, newSeries = 0;
          for (series = 0; s < i; s++) n += (o = exports.get(series) - t) * o;
          return n / (i - 1)
        }, this.standardHistVol = function() {
          var exports = this._context.new_var(o.close(this._context)),
            t = this._context.new_var(o.log(exports.get() / exports.get(1)));
          return 100 * this.stdev(t, this.period, this._context) * o.sqrt(this.daysPerYear)
        }, this.main = function(exports, t) {
          return this._context = exports, this._input = t, [this.standardHistVol()]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          ...
          for (var exports = this._context.new_var(o.close(this._context)), t = this._context.new_var(exports.symbol.time),
              i = Math.sqrt((t.get(0) - t.get(1)) / 864e5 / this.daysPerYear), series = Math.log(o.close(this
                ._context) / exports.get(1)), newSeries = this._context.new_var(s / i), r = this._context.new_var(Math.pow(newSeries,
                2)), a = 0, l = 0; l < this.period; l++) a += r.get(l);
          return 100 * Math.sqrt(a / this.period)
        }, this.main = function(exports, t) {
          return this._context = exports, this._input = t, [this.volatliityZTCTC()]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this.period = this._input(0), this.marketClosedPercentage = this
          ...
          var exports = this._context.new_var(Math.log(o.open(this._context))),
            t = this._context.new_var(Math.log(o.high(this._context))),
            i = this._context.new_var(Math.log(o.low(this._context))),
            series = this._context.new_var(Math.log(o.close(this._context))),
            newSeries = this._context.new_var(o.close(this._context)),
            r = this._context.new_var(newSeries.symbol.time),
            a = (r.get(0) - r.get(1)) / 1e3,
            l = .5 * this.square(t.get() - i.get());
          l -= (Math.log(4) - 1) * this.square(series.get() - exports.get()), this.marketClosedPercentage > 0 && (l = .12 *
            this.square(exports.get() - series.get(1)) / this.marketClosedPercentage + .88 * l / (1 - this
              .marketClosedPercentage)), l /= a, l *= this.secondsPerYear;
          var c = this._context.new_var(l);
          return 100 * Math.sqrt(o.sum(c, this.period, this._context) / this.period)
        }, this.main = function(exports, t) {
          return this._context = exports, this._input = t, [this.volatilityOHLC()]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(exports, t) {
          ...
          var exports = o.high(this._context) - o.low(this._context),
            t = o.high(this._context) - this.bars[this.bars.length - 2],
            i = this.bars[this.bars.length - 2] - o.low(this._context);
          return this.tr = Math.max(exports, t, i), "Exponential" === this.maMethod ? this.atr = o.ema(this._context
          ...
          if (this.bars.push(o.close(this._context)), 1 === this.count) this.atr = o.high(this._context) - o
            ...
            var exports = o.high(this._context) - o.low(this._context),
              t = o.high(this._context) - this.bars[this.bars.length - 2],
              i = this.bars[this.bars.length - 2] - o.low(this._context);
            this.atr += Math.max(exports, t, i), o.close(this._context) > this.sic && (this.sic = o.close(this
              ._context))
          } else if (this.count === this.period) {
            exports = o.high(this._context) - o.low(this._context), t = o.high(this._context) - this.bars[this.bars
              .length - 2], i = this.bars[this.bars.length - 2] - o.low(this._context);
            this.atr += Math.max(exports, t, i), this.atr *= 1 / this.period, o.close(this._context) > this.sic && (
                this.sic = o.close(this._context)), this.position = "LONG", this.nextsar = this.sic - this.atr *
              this.atrMult
          } else {
            var series = this.nextsar;
            "LONG" === this.position ? o.close(this._context) < s ? (this.position = "SHORT", this.sic = o
              ...
              .computeATR()) : "SHORT" === this.position && (o.close(this._context) > s ? (this.position =
              ...
              this.sic + this.computeATR())), this.lastSar = s
          }
          return this.count++, s
        }, this.main = function(exports, t) {
          return this._context = exports, this._input = t, this._context.select_sym(0), [this.calculateVolatility()]
        }
      }
    }, {
      name: "VWAP",
      ...
      constructor: function() {
        this.f_1 = function(exports) {
          exports.reset_hist()
        }, this.createAnchorChecker = function(exports, t) {
          switch (t) {
            case "Week":
              return function(t, i) {
                return o.weekofyear(exports, t) !== o.weekofyear(exports, i) || o.year(exports, t) !== o.year(exports, i)
              };
            case "Month":
              return function(t, i) {
                return o.month(exports, t) !== o.month(exports, i) || o.year(exports, t) !== o.year(exports, i)
              };
            case "Quarter":
              return function(t, i) {
                return Math.floor(o.month(exports, t) / 3) !== Math.floor(o.month(exports, i) / 3) || o.year(exports, t) !== o
                  .year(exports, i)
              };
            case "Year":
              return function(t, i) {
                return o.year(exports, t) !== o.year(exports, i)
              };
            case "Decade":
              return function(t, i) {
                return Math.floor(o.year(exports, t) / 10) !== Math.floor(o.year(exports, i) / 10)
              };
            case "Century":
              return function(t, i) {
                return Math.floor(o.year(exports, t) / 100) !== Math.floor(o.year(exports, i) / 100)
              };
            default:
              return exports => this._isFirstBarInSession(exports)
          }
        }, this.init = function(exports, t) {
          this._input = t, this._isFirstBarInSession = null;
          const i = this._input(1) || "Session";
          this._anchorChecker = this.createAnchorChecker(exports, i)
        }, this.main = function(exports, t) {
          this._context = exports, this._input = t;
          const i = this._input(0);
          var series = exports.new_var(),
            newSeries = exports.new_var(),
            r = exports.new_var();
          const a = o.time(this._context),
            l = this._context.new_unlimited_var(a).get(1);
          if (a) {
            if (null === this._isFirstBarInSession) {
              const t = o.createNthBarInSessionCheck(exports);
              this._isFirstBarInSession = exports => t(exports, 0)
            }
            this._anchorChecker(a, l) && (this.f_1(series), this.f_1(newSeries), r.set(a))
          }
          return series.set(o.nz(series.get(1)) + o[i](this._context) * o.volume(this._context)), newSeries.set(o.nz(newSeries.get(1)) + o
            .volume(this._context)), o.na(r.get(0)) ? (exports.symbol.isLastBar && o.error(
            "To calculate the VWAP indicator, more data is needed. Zoom out or scroll left to load more historical data.",
            "VWAP is waiting for more data"), [NaN]) : [series.get(0) / newSeries.get(0)]
        }
      }
    }, {
      name: "VWMA",
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = o.close(this._context),
            series = this._input(0),
            newSeries = this._context.new_var(i);
          return [o.vwma(newSeries, series, this._context)]
        }
      }
    }, {
      ...
      constructor: function() {
        this.f_0 = function(exports, t) {
          ...
          var i = this._input(0),
            series = this._input(1),
            newSeries = o.volume(this._context),
            r = this._context.new_var(newSeries),
            a = o.ema(r, i, this._context),
            l = this._context.new_var(newSeries),
            c = o.ema(l, series, this._context);
      ...
      constructor: function() {
        this.f_0 = function() {
          var exports = this._input(0),
            ...
            series = o.sum(i, exports, this._context),
            newSeries = this._context.new_var(o.high(this._context)),
            r = this._context.new_var(o.abs(o.low(this._context) - newSeries.get(1))),
            a = o.sum(r, exports, this._context),
            l = this._context.new_var(o.atr(1, this._context)),
            c = o.sum(l, exports, this._context);
          return [s / c, a / c]
        }, this.main = function(exports, t) {
          return this._context = exports, this._input = t, this.f_0()
        }
      ...
      constructor: function() {
        this.f_0 = function(exports, t, i) {
          ...
          var i = this._input(0),
            series = o.high(this._context),
            newSeries = this._context.new_var(series),
            r = o.highest(newSeries, i, this._context),
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          return [{
            ...
            value: o.smma(c, series, this._context),
            offset: a
          }, {
            value: o.smma(c, newSeries, this._context),
            offset: l
          }]
        }
      }
      ...
      constructor: function() {
        this.f_0 = function() {
          for (var exports = this._input(0), t = this._context.new_var(o.high(this._context)), i = !0, series = !0, newSeries = !0,
              r = !0, a = !0, l = !0, c = 1; c <= exports; c++) i = o.and(i, o.lt(t.get(e - c), t.get(exports))), series = o.and(
              series, o.lt(t.get(e + c), t.get(exports))), newSeries = o.and(newSeries, o.and(o.le(t.get(e + 1), t.get(exports)), o.lt(t.get(e +
              c + 1), t.get(exports)))),
            r = o.and(r, o.and(o.le(t.get(e + 1), t.get(exports)), o.and(o.le(t.get(e + 2), t.get(exports)), o.lt(t.get(e +
              c + 2), t.get(exports))))), a = o.and(a, o.and(o.le(t.get(e + 1), t.get(exports)), o.and(o.le(t.get(e + 2), t
              .get(exports)), o.and(o.le(t.get(e + 3), t.get(exports)), o.lt(t.get(e + c + 3), t.get(exports)))))), l = o.and(l, o
              .and(o.le(t.get(e + 1), t.get(exports)), o.and(o.le(t.get(e + 2), t.get(exports)), o.and(o.le(t.get(e + 3), t
                .get(exports)), o.and(o.le(t.get(e + 4), t.get(exports)), o.lt(t.get(e + c + 4), t.get(exports)))))));
          var h = o.or(series, o.or(newSeries, o.or(r, o.or(a, l)))),
            d = o.and(i, h),
            ...
            f = 1,
            y = 1;
          for (c = 1; c <= exports; c++) _ = o.and(_, o.gt(u.get(e - c), u.get(exports))), p = o.and(p, o.gt(u.get(e + c), u
              .get(exports))), m = o.and(m, o.and(o.ge(u.get(e + 1), u.get(exports)), o.gt(u.get(e + c + 1), u.get(exports)))),
            g = o.and(g, o.and(o.ge(u.get(e + 1), u.get(exports)), o.and(o.ge(u.get(e + 2), u.get(exports)), o.gt(u.get(e +
              c + 2), u.get(exports))))), f = o.and(f, o.and(o.ge(u.get(e + 1), u.get(exports)), o.and(o.ge(u.get(e + 2), u
              .get(exports)), o.and(o.ge(u.get(e + 3), u.get(exports)), o.gt(u.get(e + c + 3), u.get(exports)))))), y = o.and(y, o
              .and(o.ge(u.get(e + 1), u.get(exports)), o.and(o.ge(u.get(e + 2), u.get(exports)), o.and(o.ge(u.get(e + 3), u
                .get(exports)), o.and(o.ge(u.get(e + 4), u.get(exports)), o.gt(u.get(e + c + 4), u.get(exports)))))));
      ...
      constructor: function() {
        this.main = function(exports, t) {
          ...
          var i = this._context.new_var(o.close(this._context)),
            ...
            l = this._input(4),
            c = this._input(5),
            h = o.ema(i, series, this._context),
            d = o.ema(i, newSeries, this._context),
      ...
      constructor: function() {
        this.init = function(exports, t) {
          this._context = exports, this._input = t, this._symbolSupports1DResolution = !this._context.symbol.info
          ...
          this._symbolSupports1DResolution || o.error(
            ...
            ._input = t, "1D" !== o.period(this._context) && this._context.select_sym(1);
          const i = this._input(0),
            series = this._input(1),
            newSeries = o.time(this._context),
            r = this._context.new_unlimited_var(newSeries),
          ...
          const c = o.add_years_considering_dst(this._context.symbol.info.timezone, new Date(newSeries), -1),
