...
(e, t, i) => {
  ...
  class B extends P.StatusProviderBase {
    ...
    _getTitleGenerationOptions() {
      ...
      return {
        ...
        style: this._series.properties()
          .childs()
          .style.value(),
        inputs: n,
        boxSize: this._series.data()
          .boxSize,
  ...
  class Ce extends me.PriceAxisView {
    ...
    _countdownText() {
      ...
      const i = 1e3 * (0, o.ensure)(t.value[0]),
        s = Q.Interval.parse(this._source.interval())
        .inMilliseconds(),
        n = i.valueOf() + s;
    ...
    _updateRendererData(e, t, i) {
      ...
      const a = this._model.properties()
        .childs()
  ...
  class Je extends Ye.SeriesValuesProvider {
    ...
    getValues(e) {
      ...
      if (t[0].visible = p && c && !d, t[1].visible = p && !d, t[2].visible = p && !d, t[3].visible = p && h, t[3]
        ...
        const e = this._series.properties()
          .childs()
          .hlcAreaStyle.childs();
  ...
  class ut {
    ...
    update(e) {
      if (this._invalidated = !0, "data-source-change" === e.type && e.sourceId === this._series.id() && e.realtime &&
    ...
    _updateImpl(e) {
      ...
      const n = new ot.Point(t.indexToCoordinate(o.index), this._series.priceScale()
          .priceToCoordinate(o.price, s)),
        r = o.color,
        a = this._series.properties()
        .childs();
      let l;
  ...
  class Pt {
    ...
    _onDataUnpacked(e, t, i) {
      ...
      this._dataEvents.fireDataUpdated(t, l, r, a, o), s !== this._data.bars()
  ...
  class Qt extends It {
    ...
    _updateImpl() {
      ...
      null !== t && (this._lineRendererData.visible = !0, this._lineRendererData.y = this._series.priceScale()
        .priceToCoordinate(t, t), this._lineRendererData.color = this._series.properties()
        .childs()
        .baseLineColor.value())
    }
  }
  ...
  class wi extends c.PriceDataSource {
    constructor(e, t, i, s) {
      ...
      li || di || (h = new Ce(this, e, {
        ...
        .subscribe(this, (() => e.realignLineTools())), this._intervalChanged.subscribe(this, (() => this
          ._checkChartStyle())), this._studyBindings?.syncStudy(this.style()), this.createPaneView(), this
      ...
      for (const [, e] of Object.entries(S.STYLE_SHORT_NAMES)) this._properties.child(`${e}Style`)
        ?.subscribe(this, (() => this.invalidateBarStylesCache()));
      ...
      _.boxSize.subscribe(this, (() => this._restartIfStyleMatches(6))), _.reversalAmount.subscribe(this, (() =>
        ...
        ._dataWindowValuesProvider = new Ye.SeriesValuesProvider(this, this.model()), this._valuesProvider = new Ye
        .SeriesValuesProvider(this, this.model()), this._chartFloatingTooltipValuesProvider = new Qe(this, this
          .model())
    }
    setId(e) {
    ...
    setPriceScale(e) {
      this._priceScale !== e && (this._priceScaleAboutToBeChanged.fire(), this._priceScale = e,
        this._properties.removeProperty("priceAxisProperties"), this._properties.addChild("priceAxisProperties", e
          .properties()), this._properties.childs()
    ...
    requestMoreData(e) {
      ...
      if (0 === this.bars()
        .size()) return;
      const i = t.lastBar() - (0, o.ensureNotNull)(this.data()
          .last())
        .index;
      ...
      const s = (0, o.ensureNotNull)(this.bars()
          .firstIndex()),
    ...
    isNeedRestart(e) {
      return 5 !== this._status.value()
        .seriesStatus && (void 0 === e && (e = this.properties()
          .childs()
    ...
    priceRange(e, t, i) {
      ...
      if (s.isLockScale()) {
        ...
        if (null !== e) {
          const i = s.internalHeight() / (this.model()
              .timeScale()
              .barSpacing() / e),
            n = (0, o.ensureNotNull)(this.data()
    ...
    onChartStyleChanged() {
      if (this._updateBarFunction(), this.isNeedRestart()) {
        ...
        0, this._saveLeftEdgeIfRequired(!1) || this.model()
          .timeScale()
          .scrollToRealtime(!1), this.restart(e)
      }
      const e = this.properties();
      this._prevChartStyle !== e.childs()
        .style.value() && this._studyBindings?.syncStudy(this.style()), this._prevChartStyle = e.childs()
        .style.value(), this._onStyleChanged.fire(e.childs()
          .style.value()), this.invalidateBarStylesCache(), this._updateLastPriceAnimationActive(), this
        ._styleToRecover?.originalStyle !== this.style() && (this._styleToRecover = null), this
        ._updateTimeScaleTimePointWeights()
    }
    ...
    updateAllViews(e) {
      this._studyBindings?.updateAllViews(e), "hover-change" !== e.type && (this._paneView?.update(e), this
        ...
        .value()
        ?.updateAllViews(e), this._model.replayStudyStrategy()
        .value()
        ?.updateAllViews(e), this._lineStyleLastPriceCirclePaneView.update(e))
    }
    styleStudyInfo(e) {
    ...
    symbolTitle(e, t, i) {
      ...
      let n = (0, x.translatedIntervalString)(this.properties()
        .childs()
        .interval.value());
    ...
    statusProvider(e) {
      return new B(this, this.properties()
        .childs()
        .statusViewStyle, e)
    }
    moveItem(e, t, i) {
    ...
    state(e) {
      ...
      const s = this.properties()
        .state(void 0, 2);
      if (s.symbol = (0, g.symbolToSaveInState)(this.symbolInfo() ?? this._model.chartApi()
    ...
    restoreState(e, t) {
      ...
      if (this._properties.mergeAndFire(e.state), this._prevChartStyle = this.properties()
        .childs()
    ...
    restoreData(e, t, i, s, o, n) {
      this._updateStatus({
          seriesStatus: 5
        }), this._data = new d.SeriesData, this._data.bars()
    ...
    _onSymbolError(e) {
      this._setStatus(4), this._properties.childs()
        .shortName.setValue(this._properties.childs()
          .symbol.value()), this._model.clearAllStudies(), this.updateAllViews((0, ve.sourceChangeEvent)(this
      .id())), this._model.updateSource(this), this._symbolResolvingActive.setValue(!1)
    }
    ...
    _onDataUpdated(e, t, i, s, n) {
      ...
      if (null !== this._volumePointWeights) {
        const e = t ? this.bars()
          .fullRangeIterator() : i ? this.bars()
          .rangeIterator(i.index, (0, o.ensureNotNull)(this.bars()
            .lastIndex())) : null;
        if (null !== e)
      ...
      t ? this._requestMoreDataAvailable = !0 : this._lastPriceAnimationActive && this._seriesLoaded && this
        ...
        e && e.closeTime || null, this._boxSizeValue.setValue(this.data()
    ...
    _setStatus(e) {
      ...
      this._updateStatus(t), this._statusView.update(), this.model()
    ...
    _onUnsupportedResolutionRequested() {
      ...
      this._seriesErrorMessage = e.reason, this._unsupportedResolutionState.setValue(e), this._setStatus(14), this
        ._seriesLoaded = !0, this.clearData(), this._model.timeScale()
        .points()
    ...
    _recreateFormatter() {
      let e = null;
      e = Yt.customFormatters?.priceFormatterFactory?.(this.symbolInfo(), this.properties()
        .childs()
        ...
        ._defaultFormatter = (0, g.createSeriesFormatter)(this.aliasSymbolInfo() ?? this._formattingDeps,
          ...
          ._formattingDeps, this.properties()
          .childs()
          .minTick.value()), this._ignoreMinMoveFormatter = (0, g.createSeriesFormatter)(this.symbolInfo(), this
          .properties()
          .childs()
    ...
    _checkChartStyle() {
      const e = this.style();
      (0, g.isCloseBasedSymbol)(this.symbolInfo()) || this.intervalObj()
        .value()
    ...
    _updateSymbolInfo(e) {
      ...
      i !== this._quotesProvider.symbol() && this._quotesLastSplits.setValue(null), this._quotesProvider
        ...
        ._recreatePriceFormattingDependencies(), this._statusView.update(), this.priceScale()
    ...
    _onSeriesCompleted(e) {
      ...
      if (null !== this._model.appliedTimeFrame()
        .value() && i.lockVisibleTimeRangeOnResize(), this._model.invalidate(i), !this.priceScale()
        .isLockScale() || this.model()
        .timeScale()
        .isEmpty() || this._seriesLoaded || (this.model()
          .timeScale()
          .correctOffset(), this.model()
          .timeScale()
          .correctBarSpacing(), this.model()
          .resetPriceScale(t, this.priceScale())), this._seriesLoaded = !0, this._seriesCompleted = !0, this.model()
    ...
    _saveLeftEdgeIfRequired(e, t = null) {
      if (this._savedLeftEdge = null, !t && !e && this._model.properties()
        .childs()
        .scalesProperties.childs()
        .saveLeftEdge.value()) {
        const e = this._model.timeScale();
        if (!e.isEmpty()) {
          let t = e.visibleBarsStrictRange()
            ?.firstBar();
          if (void 0 !== t) {
            const i = this._seriesSource.data()
              ?.bars()
              .first();
    ...
    async _applySymbolParamsChanges(e) {
      ...
      this.model()
        .recalcVisibleRangeStudies(h.RecalcVisibleRangeStudiesReason.SeriesRestart), this._saveLeftEdgeIfRequired(!!
          ...
          ._seriesSource.start()), (i || o || n) && this.disablePriceRangeReady(), this.updateAllViews((0, ve
          .sourceChangeEvent)(this.id())), this._model.lightUpdate(), this._pendingScrollToLeftEdge && await this
    ...
    _updateLastPriceAnimationActive() {
      ...
      this._lastPriceAnimationActive && e !== this._lastPriceAnimationActive && this.model()
