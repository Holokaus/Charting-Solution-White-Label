...
59064: (exports, module, require) => {
    ...
    // Export main series properties
    require.d(exports, {
      mainSeriesProperties: () => mainSeriesProperties
    });
    
    const lineStyleConstants = require(69558),
      rangeBarStyle = require(22033);
    
    // Default properties for all chart series types
    ...
    // Make properties available via module exports
    exports.mainSeriesProperties = mainSeriesProperties;
};
