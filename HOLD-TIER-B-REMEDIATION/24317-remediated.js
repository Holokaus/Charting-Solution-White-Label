/**
 * Module 24317 - Semantic Remediation
...
24317: (exports, t, i) => {
    ...
    function _e(exports) {
      return (0, o.clone)(exports === ae.StdTheme.Light ? le : exports === ae.StdTheme.Dark ? ce : void 0)
    }

    function pe(exports) {
      return {
        [ae.StdTheme.Light]: modes.t(null, {
          context: "colorThemeName"
        }, i(96870)),
        [ae.StdTheme.Dark]: modes.t(null, {
          context: "colorThemeName"
        }, i(85119))
      } [exports] || exports
    }