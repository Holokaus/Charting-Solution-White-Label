    ...
    var a = n("Model.ChartTradingUtils"),
      l = {
        ...
        getColorFromProperties: function(e, t) {
          ...
          return "rgba(" + s.r + "," + s.g + "," + s.logger_b + "," + i + ")"
        },
        setColorToProperties: function(e, t, i) {
          var s = this._parseColor(e);
          t.setValue("rgb(" + s.r + "," + s.g + "," + s.logger_b + ")");
          var o = 100 * (1 - s.a);
        ...
        setFontToProperties: function(e, t, i, s, n) {
          var r = o(e);
          null !== r ? (r.family.length > 0 && t.setValue(r.family), i.setValue(r.size), s.setValue(r.bold), n
        ...
        drawPolyHoverOrPress: function(e, t, i, s) {
          s ? (e.save(), e.fillStyle = "rgba(0, 0, 0, 0.15)", r(e, t, !0), e.restore()) : i && (e.save(), e
            .fillStyle = "rgba(0, 0, 0, 0.1)", r(e, t, !0), e.restore())
        },
        repaint: function(e) {
          e.lightUpdate()
        },
