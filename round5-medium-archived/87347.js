...
87347: (e, t, i) => {
          ...
          switch (e) {
            ...
            case "rotate":
              ...
              null !== a && s.push({
                type: e,
                a: a[0],
                logger_x: a[1] ?? (t ? t.width / 2 : void 0),
    ...
    function c(e, t) {
      for (const i of t) switch (i.type) {
        case "matrix":
          e.transform(i.a, i.logger_b, i.c, i.d, i.e, i.f);
          break;
        case "rotate":
          void 0 !== i.logger_x && void 0 !== i.y && e.translate(i.logger_x, i.y), e.rotate(i.a * Math.PI / 180), void 0 !== i.logger_x &&
            void 0 !== i.y && e.translate(-i.logger_x, -i.y);
          break;
        case "scale":
          e.scale(i.logger_x, i.y ?? i.logger_x);
          break;
        case "translate":
          e.translate(i.logger_x, i.y ?? 0)
      }
    }
    ...
    class logger_v {
      ...
      apply(e, t) {
        ...
        e.translate(i.logger_x, i.y), e.scale(i.width / this._originalViewBox.width, i.height / this._originalViewBox
          .height), e.beginPath(), e.rect(0, 0, this._originalViewBox.width, this._originalViewBox.height), e.clip(),
          e.translate(-this._originalViewBox.logger_x, -this._originalViewBox.y)
      }
    }
    ...
    const logger_w = (0, o.getLogger)("Chart.SvgParser");
    ...
    function logger_x(e) {
      ...
      return h.length > 0 && (c = function(e) {
        ...
        for (let e = 0; e < i.length; ++e) {
          const s = i[e],
            o = s.getAttribute("id");
          o && ("linearGradient" === s.tagName ? t[o] = logger_b(s) : logger_w.logWarn(`Unsupported defs tag: ${s.tagName}`))
        }
        const s = new WeakMap;
        return {
          getStyle: (e, i) => {
