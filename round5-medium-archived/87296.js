...
87296: (e, t, i) => {
    ...
    function seriesBarFunction_y(e) {
    ...
    function v(e) {
      ...
      return void 0 !== o ? void 0 !== o.find((e => seriesBarFunction_y(e) === i)) : t.isSeconds() ? Boolean(l.linking.seconds.value()) :
        t.isTicks() ? Boolean(l.linking.ticks.value()) : t.isIntraday() ? Boolean(l.linking.intraday.value()) : t
        .isDWM()
    }

    function S(e) {
      n.Interval.isValid(e) && (n.Interval.isRange(e) ? a.setValue("chart.lastUsedRangeResolution", e) : a.setValue(
    ...
    function x(...e) {
      let t = [].concat(...e);
      return t = (0, c.uniq)(t.filter(w).map(seriesBarFunction_y)), M(t)
    }
    ...
    function L(e, t) {
      ...
      return i.isMinuteHours() && (s = Math.floor(s / 60), o = n.SpecialResolutionKind.Hours), {
        ...
        shortKind: seriesBarFunction_k(o),
        hint: `${s} ${seriesBarFunction_k(o,s)}`,
        mayOmitMultiplier: i.isDWM() && 1 === s,
        mayOmitShortKind: i.isMinutes() && !i.isMinuteHours()
      }
    }

    function seriesBarFunction_k(e, t) {
      if (!t) return {
    ...
    function D(e) {
      return !(!E() && e.isSeconds() || !(0, d.isTicksEnabled)() && e.isTicks()) && !(!(0, d.isTicksEnabled)() && e
        .isTicks())
    }
    ...
    function V(e) {
      ...
      e.CustomUserResolutionsKey = "IntervalWidget.intervals", e.LastUsedRangeResolutionKey =
        "chart.lastUsedRangeResolution", e.LastUsedTimeBasedResolutionKey = "chart.lastUsedTimeBasedResolution",
