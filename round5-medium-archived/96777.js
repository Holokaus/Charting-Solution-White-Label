...
96777: (e, t, i) => {
    ...
    class a extends r.GraphicsObj {
      constructor(e, t, i, o, n, r) {
        super(e), (0, s.assert)(t < i), this._priceLow = this._mixinJSONObject.createDoubleField(t, "priceLow"),
          ...
          .createTimeField(n, "firstBarTime"), this._lastBarTime = this._mixinJSONObject.createTimeField(r,
            "lastBarTime")
      }
      isNaN() {
    ...
    class u {
      ...
      equals(e) {
        return e instanceof u && (!this.isNaN() && (!e.isNaN() && (this.index === e.index && this.offset === e
          .offset && d.Std.equal(this.level, e.level))))
      }
      getLevel() {
        return this.level
      }
        ...
        constructor(e, t, i, s, o = !1, n = !1) {
          super(e), this._endIndex = this._mixinJSONObject.createTimeField(i, "endIndex"), this._extendLeft = this
            ._mixinJSONObject.createField(o, "extendLeft"), this._extendRight = this._mixinJSONObject.createField(n,
              "extendRight"), this._level = this._mixinJSONObject.createDoubleField(s, "level"), this._startIndex =
    ...
    class g {
      constructor(e, t, i, o, n, r, a, l, c, d, u, _, p, g, f) {
        this._freezedBoxes = new h.GraphicsList, this._freezedHists = new h.GraphicsList, this._freezedPocs = new h
          ...
          ._idsGenerator = null, (0, s.assert)(1 === e || 2 === e), this._numOfSubHists = e, this._outHists = o, this
          ._outBoxLines = n, this._outPocLines = r, this._extendPocLeftRight = a, this._outVAHists = l, this
      ...
      _updateCurrentHistogram(e) {
        if (this._needRecalc = !1, d.Std.greater(this._minPrice, e.low) && (this._minPrice = e.low, this
            ._needRecalc = !0), d.Std.less(this._maxPrice, e.high) && (this._maxPrice = e.high, this._needRecalc = !
        ...
        this._needRecalc && 0 === (0, s.ensureNotNull)(this._rowsLayout).type() ? (this
            ._recalculateCurrentResultsOnHistoryBarSet(), this._applyUpdateToCurrentResults(e, !1)) : this
          ._applyUpdateToCurrentResults(e, !0), this._ctx.symbol.isBarClosed ? ((0, s.assert)(null === this
            ._prevRtBar || e.time === this._prevRtBar.time), this._historyBarSet.push(e), this._prevRtBar = null) :
          this._prevRtBar = e
      }
      _getMidLevel(e) {
      ...
      _getLargestHistItem() {
        ...
        for (const i of this._currentHists) d.Std.greater(i.ratesSum(), t.ratesSum()) ? (t = i, e = [t]) : d.Std
          .equal(i.ratesSum(), t.ratesSum()) && e.push(i);
        if (e.length > 1) {
      ...
      _applyUpdateToCurrentResults(e, t) {
        t && null !== this._prevRtBar && this._addHistoryBarToHistogram(this._prevRtBar, this._historyBarSet.length -
          1, this._currentHists, this._currentHistsMap, -1), this._addHistoryBarToHistogram(e, this._historyBarSet
      ...
      _updateResult(e, t, i, o, n) {
        ...
        let h = n.get(e);
        if (void 0 === h) h = new a(this, e.start, e.end, r, l, c), n.set(e, h), this
          ._verifyHistogramSizeIsNotTooLarge(n.size()), this._currentHistsGr.add(h), g._addInOrder(h, o, 0, o.length,
            ((e, t) => {
      ...
      _rebuildOutData() {
        ...
        (0, s.assert)(e === t && t === i + o, `Collections of HHistItems are out of sync ${e} ${t} ${i} ${o}`), this
          ...
          ._outBoxLines.addAll(this._freezedBoxes), this._outBoxLines.add((0, s.ensureNotNull)(this._currentBox))
      }
      _verifyHistogramSizeIsNotTooLarge(e) {
        ...
        0 === t.type() ? d.Std.error('Histogram is too large, please reduce "Row Size" input.') : ((0, s.assert)(1 ===
      ...
      static _addInOrder(e, t, i, s, n) {
        ...
        const r = (0, o.toInt)((i + s) / 2),
          a = t[r];
        n(e, a) < 0 ? g._addInOrder(e, t, i, r, n) : n(e, a) > 0 ? g._addInOrder(e, t, r + 1, s, n) : t.splice(r, 0,
          e)
      }
    }