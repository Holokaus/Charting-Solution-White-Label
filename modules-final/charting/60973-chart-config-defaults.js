...
(e, t, i) => {
  ...
  var tradedGroupAlignment = require(86572).TradedGroupHorizontalAlignment,
    styleConstants = require(82095),
    pitchforkStyles = require(36947).LineToolPitchforkStyle,
    barsPatternModes = require(45580).LineToolBarsPatternMode,
    studyConstants = require(4359),
    lineStudyPlotStyle = studyConstants.LineStudyPlotStyle,
    studyPlotDisplayTarget = studyConstants.STUDYPLOTDISPLAYTARGET,
    drawingDefaults = require(19679),
    priceAxisLastValueModes = require(97902).PriceAxisLastValueMode,
    magnetModes = require(7024).MagnetMode,
    lineEndStyles = require(25672).LineEnd,
    colorTypes = require(93201).ColorType;
  const defaultLineWidth = require(59883).DEFAULT_LINE_TOOL_LINE_WIDTH;
  var statsPositions = require(97760).StatsPosition,
    defaultSessionPrefs = require(57511).sessionsPreferencesDefault,
