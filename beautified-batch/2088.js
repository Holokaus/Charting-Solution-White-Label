/**
 * Module 2088 - Auto-beautified from TradingView webpack bundle
 *
 * @module 2088
 * @date 2026-04-23
 * @size 3933 bytes
 ...
 *
 * Dependencies: 2258, 19844, 37103, 50151, 62312, 72207, 88987
 *
 * Exports:
 *   - createStudy (internal: w)
 *   - hasConfirmInputs (internal: x)
 *   - hasPendingStudiesModuleLoading (internal: b)
 *   - isCompareOrOverlayStudy (internal: v)
 *   - isESDStudy (internal: f)
 *   - isFundamentalStudy (internal: g)
 *   - isOverlayStudy (internal: y)
 *   - isStudy (internal: _)
 *   - isStudyStrategy (internal: p)
 *   - isStudyStub (internal: m)
 *   - isSymbolicStudy (internal: I)
 *   - studyColorRotationMode (internal: C)
 *   - useSameColorRotationComparator (internal: P)
 *
 * Next Steps:
...
async function w(e, t, i, s, n, r, a, l) {
  ...
  u.studyConstructor || (S += 1, u.studyConstructor = await (0, o.ensureDefined)(u.studyConstructorAsyncGetter)(), S -= 1);
...
function C(e) {
  ...
  return i ? (0, s.default)(i.colorRotationMode) ? i.colorRotationMode(e) : i.colorRotationMode : void 0 === e.pine || r.StudyMetaInfo.isStandardPine(e.id) ? 1 !== e.plots.length ? "shift" : "loop" : null
}
...
const M = ["Overlay@tv-basicstudies", "CorrelationCoefficient@tv-basicstudies", "Correlation Coeff@tv-basicstudies", "Spread@tv-basicstudies", "Ratio@tv-basicstudies"];
