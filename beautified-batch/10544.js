/**
 * Module 10544 - Auto-beautified from TradingView webpack bundle
 *
 * @module 10544
 * @date 2026-04-23
 * @size 6793 bytes
 ...
 *
 * Dependencies: 922, 1145, 3348, 10268, 11542, 13896, 14724, 23403, 24866, 30585, 41414, 41706, 47977, 51077, 57726, 59189, 63375, 65045, 67948, 78176, 78273, 87380, 87957, 95804
 *
 * Exports:
 *   - LineToolElliott (internal: m)
 *   - LineToolElliottCorrection (internal: P)
 *   - LineToolElliottDegree (internal: s)
 *   - LineToolElliottDoubleCombo (internal: M)
 *   - LineToolElliottImpulse (internal: y)
 *   - LineToolElliottTriangle (internal: S)
 *   - LineToolElliottTripleCombo (internal: w)
 *
 * Next Steps:
...
class m extends a.LineDataSource {
  constructor(e, t, s, o) {
    super(e, t ?? m.createProperties(e.backgroundTheme().spawnOwnership()), s, o), this.version = 4, Promise.all([i.e(6290), i.e(986), i.e(6668), i.e(1583)]).then(i.bind(i, 60509)).then((e => {
  ...
  async _getPropertyDefinitionsViewModelClass() {
    return (await Promise.all([i.e(3198), i.e(5410), i.e(2745), i.e(8823), i.e(8537)]).then(i.bind(i, 6238))).ElliottPatternDefinitionsViewModel
  }
  static _configureProperties(e) {
    super._configureProperties(e), e.addChild("linesColors", new h.LineToolColorsProperty([e.childs().color])), e.addExcludedKey("linesColors", 3)
  }
}
class g extends m {
  pointsCount() {
...
const T = [["0", "A", "B", "C"], ["0", "a", "b", "c"], ["0", "A", "B", "C"], ["0", "a", "b", "c"], ["0", "A", "B", "C"]];
class P extends C {
  constructor(e, t, i, s) {
