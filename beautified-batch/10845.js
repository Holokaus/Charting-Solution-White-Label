/**
 * Module 10845 - Auto-beautified from TradingView webpack bundle
 *
 * @module 10845
 * @date 2026-04-23
 * @size 8426 bytes
 ...
 *
 * Dependencies: 1833, 1852, 5959, 6686, 9865, 10095, 10871, 11034, 11542, 13386, 14055, 14995, 19439, 19931, 20313, 21007, 23160, 23650, 24436, 24959, 25282, 26820, 27358, 28733, 28756, 30231, 30948, 31561, 31622, 32838, 33672, 34491, 36057, 36485, 36549, 37265, 37974, 38365, 38561, 38917, 39585, 40544, 40977, 42630, 47045, 48203, 48861, 48991, 50349, 52066, 52961, 53168, 53375, 54533, 55502, 59444, 60534, 61879, 62859, 63627, 64039, 64313, 65736, 66103, 67560, 67891, 69122, 70409, 70876, 70913, 71797, 72452, 73332, 73702, 73905, 75722, 76614, 77377, 78326, 79336, 79668, 79716, 79995, 81038, 81248, 86716, 86905, 87580, 90594, 91499, 91912, 94022, 94600, 95523, 98128, 98549, 99563
 *
 * Exports:
 *   - availableTimezones (internal: l)
 *   - timezoneIsAvailable (internal: u)
 *   - timezoneIsSupported (internal: _)
 *   - timezoneTitle (internal: p)
 *   - updateAvailableTimezones (internal: d)
 *
 * Next Steps:
...
const d = e => {
  l.splice(0, l.length, ...a(r, n, e)), l.forEach((e => {
    c.set(e.id, !0)
  }))
};
