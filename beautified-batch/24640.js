/**
 * Module 24640 - Auto-beautified from TradingView webpack bundle
 *
 * @module 24640
 * @date 2026-04-23
 * @size 1258 bytes
 ...
 *
 * Exports:
 *   - detectAutoDirection (internal: b)
 *   - forceLTRStr (internal: u)
 *   - forceLTRStrSsr (internal: _)
 *   - forceRTLStr (internal: m)
 *   - getLTRScrollLeft (internal: g)
 *   - getLTRScrollLeftOffset (internal: f)
 *   - isRtl (internal: o)
 *   - startWithLTR (internal: d)
 *   - stripLTRMarks (internal: h)
 *   - stripLTRStrSsr (internal: p)
 *
 * Next Steps:
