/**
 * Module 52974 - Auto-beautified from TradingView webpack bundle
 *
 * @module 52974
 * @date 2026-04-23
 * @size 1478 bytes
 ...
 *
 * Dependencies: 35727, 41414, 62301, 95059
 *
 * Next Steps:
...
52974: (e, t, i) => {
    ...
    class a extends s {
      constructor(e, t) {
        super(e, t), this.customization.forcePriceAxisLabel = !0, this.customization.disableErasing = !0, this.customization.showInObjectsTree = !1, this._createFormatter(e.mainSeries().symbolInfo()), this.setSelectionEnabled(!1)
      }
      isSynchronizable() {
        return !1
      }
      ...
      _createFormatter(e) {
        let t = null;
        t = n && n.priceFormatterFactory && n.priceFormatterFactory(e), null == t && (t = null), this._formatter = null !== t ? t : r(e, "default", !1, !0)
      }
    }
