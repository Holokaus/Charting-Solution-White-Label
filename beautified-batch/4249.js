/**
 * Module 4249 - Auto-beautified from TradingView webpack bundle
 *
 * @module 4249
 * @date 2026-04-23
 * @size 923 bytes
 ...
 *
 * Dependencies: 45801, 52859, 73773, 93463, 94602
 *
 * Exports:
 *   - SeriesAreaPaneView (internal: l)
 *
 * Next Steps:
...
class l extends a.SeriesSingleLinePaneView {
    renderer() {
      ...
      const t = this._source.properties().childs().areaStyle.childs(),
        ...
        l = new n.CompositeRenderer;
      return l.append(new o.PaneRendererArea(a)), this._model.selection().isSelected(this._source) && this._isMarkersEnabled && this._selectionData && l.append(new r.SelectionRenderer(this._selectionData)), l
    }
