/**
 * Module 73773 - Auto-beautified from TradingView webpack bundle
 *
 * @module 73773
 * @date 2026-04-23
 * @size 2320 bytes
 ...
 *
 * Dependencies: 2383, 5471, 10555, 12217, 13173, 37103, 50151, 69708
 *
 * Exports:
 *   - SeriesSingleLinePaneView (internal: d)
 *
 * Next Steps:
...
class d {
  constructor(e, t) {
    this._items = [], this._invalidated = !0, this._isMarkersEnabled = (0, r.enabled)("source_selection_markers"), this._selectionData = null, this._source = e, this._model = t, this._selectionIndexer = new a.SelectionIndexes(t.timeScale())
  }
  update() {
    this._invalidated = !0
  }
  _updateImpl() {
    ...
    if (u < .1 && this._source.supportsConflatedChunks()) {
      const e = this._source.conflatedChunks(u, (0, n.ensureNotNull)(this._source.priceSource())),
        t = (0, h.lowerbound)(e, r, ((e, t) => e.startTime < t)),
        i = Math.min(e.length - 1, (0, h.lowerbound)(e, a, ((e, t) => e.endTime < t)));
      for (let s = t; s <= i; s++) {
        const t = e[s];
      ...
      for (const {
        ...
        const i = d(t);
        (0, s.default)(i) && this._items.push({
          timePointIndex: e,
          y: i,
          left: NaN,
          center: NaN,
    ...
    if (null !== _)
      if (t.pointsArrayToCoordinates(this._items, _), e.fillBarBorders(this._items), this._model.selection().isSelected(this._source)) {
