/**
 * Module 88732 - Auto-beautified from TradingView webpack bundle
 *
 * @module 88732
 * @date 2026-04-23
 * @size 3983 bytes
 ...
 *
 * Dependencies: 2383, 4539, 12217, 20820, 33350, 45801, 48227, 49251, 59332, 68735, 84617, 94602
 *
 * Exports:
 *   - SeriesHiLoPaneView (internal: f)
 *
 * Next Steps:
...
class c extends l.MediaCoordinatesPaneRenderer {
  ...
  hitTest(e) {
    ...
    return l - o - h <= e.y && e.y <= l + o || c - o <= e.y && e.y <= c + o + h ? new a.HitTestResult(a.HitTarget.Regular) : null
  }
  _drawImpl(e) {
    ...
    for (let e = 0; e < n.length; ++e) {
      ...
      l.textBaseline = "alphabetic", l.fillText(r ? t.lowLabel : t.highLabel, o, i - a), l.textBaseline = "top", l.fillText(r ? t.highLabel : t.lowLabel, o, s + a)
    }
  }
}
var h, d = i(94602),
...
class f extends g.SeriesBarCandlesPaneView {
    constructor(e, t) {
      super(e, t), this._labelsRenderer = new c, this._candlesRenderer = new m.PaneRendererCandles, this._maxLengthLabel = "", this._calculateFontSize = (0, s.default)(((e, t) => Math.max(1, (0, n.lowerboundExt)((e => e + 1), null, (i => {
    ...
    renderer() {
      ...
      return this._model.selection().isSelected(this._source) && this._isMarkersEnabled && this._selectionData && t.append(new u.SelectionRenderer(this._selectionData)), t
    }
    topPixelMargin() {
      return this._margin()
    }
