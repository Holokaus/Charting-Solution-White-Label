/**
 * Module 27593 - Auto-beautified from TradingView webpack bundle
 *
 * @module 27593
 * @date 2026-04-23
 * @size 5990 bytes
 ...
 *
 * Dependencies: 5471, 32853, 37103, 40472, 41414, 50151, 67777, 78176
 *
 * Exports:
 *   - ExecutionLineAdapter (internal: _)
 *   - ExecutionsPositionController (internal: u)
 *   - LineToolExecution (internal: p)
 *
 * Next Steps:
...
class u {
  ...
  getXYCoordinate(e, t, i) {
    ...
    if (l.bars) {
      const e = r ? 10 : -10,
        t = l.bars().search(i, a.PlotRowSearchMode.NearestLeft);
      if (null !== t) {
        i = t.index;
        const n = r ? t.value[3] : t.value[2],
          a = l.priceScale(),
          c = (0, s.ensureNotNull)(l.firstValue());
    ...
    for (let s = h.length - 1; s >= 0; --s) {
      ...
      if ((a.adapter().alignedTimePointIndex() ?? t.timePointToIndex(a.adapter().getTime(), 1)) !== i || a.adapter().getDirection() !== n) continue;
      if (a === e.line()) break;
      const l = a.adapter().height();
      o = r ? o + l : o - l
    }
    return {
  ...
  static recreateOrderedByBarsSourcesCache(e) {
    ...
    for (const e of t) {
      ...
      u._cachedByBarIndexOrderedExecutions[t] = i, i.push(e)
    }
  }
...
class _ {
  constructor(e, t) {
    this._unixtime = NaN, this._line = e, this._model = t
  }
  ...
  getPrice() {
    return this._line.points().length > 0 ? this._line.points()[0].price : this._line.normalizedPoints().length > 0 ? this._line.normalizedPoints()[0].price : NaN
  }
  setPrice(e) {
    return this._line.points().length > 0 && (this._line.points()[0].price = e), this._line.normalizedPoints().length > 0 && (this._line.normalizedPoints()[0].price = e), this
  }
  getText() {
    return this._line.properties().childs().text.value()
  }
  setText(e) {
    return this._line.properties().childs().text.setValue(e || ""), this._line.updateAllViewsAndRedraw((0, h.sourceChangeEvent)(this._line.id())), this
  }
  getArrowHeight() {
  ...
  getArrowColor() {
    ...
    return "buy" === this.getDirection() ? e.arrowBuyColor.value() : e.arrowSellColor.value()
  }
  setArrowColor(e) {
    return "buy" === this.getDirection() ? this.setArrowBuyColor(e) : this.setArrowSellColor(e), this
  }
  setArrowBuyColor(e) {
    return this._line.properties().childs().arrowBuyColor.setValue(e), this
  }
  setArrowSellColor(e) {
    return this._line.properties().childs().arrowSellColor.setValue(e), this
  }
  getTextColor() {
    const e = this._line.properties().childs();
  ...
  setTextColor(e) {
    ...
    return n.setColorToProperties(e, t.textColor, t.textTransparency), this
  }
  getFont() {
    const e = this._line.properties().childs();
  ...
  setFont(e) {
    const t = this._line.properties().childs();
    return n.setFontToProperties(e, t.fontFamily, t.fontSize, t.fontBold, t.fontItalic), this
  }
  setTooltip(e) {
    return null == e ? e = "" : e += "", this._line.properties().childs().tooltip.setValue(e), this
  }
  getTooltip() {
...
class p extends o.LineDataSource {
    constructor(e, t, s, o) {
      super(e, t ?? p.createProperties(e.backgroundTheme().spawnOwnership()), s, o), this._adapter = new _(this, e), this.customization.forcePriceAxisLabel = !1, this.customization.disableErasing = !0, this.setSelectionEnabled(!1), Promise.all([i.e(6290), i.e(986), i.e(6668), i.e(1583)]).then(i.bind(i, 52361)).then((e => {
    ...
    updateAllViews(e) {
      if (this._isVisible()) return super.updateAllViews(e)
    }
    priceAxisViews(e, t) {
      return this._isVisible() ? super.priceAxisViews(e, t) : null
    }
    paneViews() {
      return window.TradingView.printing && !l.enabled("snapshot_trading_drawings") ? null : this._isVisible() ? super.paneViews() : null
    }
    userEditEnabled() {
      return !1
    }
