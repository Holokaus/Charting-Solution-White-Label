/**
 * Module 81922 - Auto-beautified from TradingView webpack bundle
 *
 * @module 81922
 * @date 2026-04-23
 * @size 3959 bytes
 ...
 *
 * Dependencies: 16738, 37293, 46082, 50151, 90054
 *
 * Exports:
 *   - getIntervalsVisibilitiesForMode (internal: _)
 *   - isActualInterval (internal: d)
 *   - makeIntervalsVisibilitiesVisibleAtInterval (internal: c)
 *   - mergeIntervalVisibilitiesDefaults (internal: u)
 *
 * Next Steps:
...
81922: (e, t, i) => {
    ...
    function c(e, t) {
      let i = t.multiplier();
      if (t.isTicks() && (e.ticks = !0), t.isSeconds() && (i < 60 ? (e.seconds = !0, e.secondsFrom = Math.min(e.secondsFrom, i), e.secondsTo = Math.max(e.secondsTo, i)) : (i = Math.floor(i / 60), t = new a.Interval(a.ResolutionKind.Minutes, i))), t.isMinutes())
    ...
    function d(e, t) {
      ...
      switch (e.kind()) {
        ...
        case a.ResolutionKind.Seconds:
          if (e.multiplier() < 60) return h(i.seconds.value(), i.secondsFrom.value(), i.secondsTo.value(), e.multiplier());
          {
        ...
        case a.ResolutionKind.Minutes:
          if (e.multiplier() < 60) return h(i.minutes.value(), i.minutesFrom.value(), i.minutesTo.value(), e.multiplier());
          {
            const t = Math.floor(e.multiplier() / 60);
    ...
    function _(e, t) {
      ...
      return [{
        ...
        if (s.checker(e)) {
          ...
          1 === t ? s.markIntervalAsVisible(o, o) : 3 === t ? s.markIntervalAsVisible(o, void 0) : s.markIntervalAsVisible(void 0, o)
        } else(!i && 2 === t || i && 3 === t) && s.markIntervalAsVisible(void 0, void 0)
      })), u(s)
    }! function(e) {
      e[e.All = 0] = "All", e[e.OnlyCurrent = 1] = "OnlyCurrent", e[e.CurrentAndBelow = 2] = "CurrentAndBelow", e[e.CurrentAndAbove = 3] = "CurrentAndAbove"
    }(s || (s = {}))
