/**
 * Module 28450 - Auto-beautified from TradingView webpack bundle
 *
 * @module 28450
 * @date 2026-04-23
 * @size 4189 bytes
 ...
 *
 * Dependencies: 2088, 11542, 21469, 50151, 61507, 97800
 *
 * Exports:
 *   - allPriceScaleSelectionStrategyInfo (internal: c)
 *   - createPriceScaleSelectionStrategy (internal: l)
 *
 * Next Steps:
...
class r {
  ...
  findSuitableScale(e, t, i, s) {
    ...
    if ((0, n.isStudy)(t)) {
      ...
      if (void 0 !== i && ((0, n.isStudy)(i) || e.isMainPane().value()) && s.is_price_study) return this._getPriceScaleTheSameAsForSource(i, e)
    }
    let o = !1;
    if ((0, n.isStudy)(t)) {
  ...
  _tryToGetDesiredPriceScale(e, t, i, o) {
    switch (i) {
      ...
      case "as-series":
        return void 0 !== o ? (0, s.ensureNotNull)(o.priceScale()) : e.isMainPane().value() ? (0, s.ensureNotNull)((0, s.ensureNotNull)(e.mainDataSource()).priceScale()) : this.createNewPriceScaleIfPossible(e);
      case "overlay":
