/**
 * Module 87347 - Auto-beautified from TradingView webpack bundle
 *
 * @module 87347
 * @date 2026-04-23
 * @size 6071 bytes
 ...
 *
 * Dependencies: 9343, 50151
 *
 * Exports:
 *   - svgRenderer (internal: x)
 *
 * Next Steps:
...
function c(e, t) {
  for (const i of t) switch (i.type) {
    case "matrix":
      ...
      break;
    case "rotate":
      void 0 !== i.x && void 0 !== i.y && e.translate(i.x, i.y), e.rotate(i.a * Math.PI / 180), void 0 !== i.x && void 0 !== i.y && e.translate(-i.x, -i.y);
      break;
    case "scale":
      e.scale(i.x, i.y ?? i.x);
      break;
...
class m {
  ...
  apply(e, t) {
    ...
    const h = i?.(e);
    "none" !== h && (t.doNotApplyColors || (void 0 !== a && (e.globalAlpha = a), e.fillStyle = h ?? "black"), this._fill(e));
    const d = s?.(e);
    void 0 !== d && "none" !== d && (void 0 !== o && (e.lineWidth = o), t.doNotApplyColors || (void 0 !== a && (e.globalAlpha = a), e.strokeStyle = d), this._stroke(e)), l && e.restore()
  }
  _fill(e) {
    e.fill()
  }
...
class v {
  ...
  apply(e, t) {
    ...
    e.translate(i.x, i.y), e.scale(i.width / this._originalViewBox.width, i.height / this._originalViewBox.height), e.beginPath(), e.rect(0, 0, this._originalViewBox.width, this._originalViewBox.height), e.clip(), e.translate(-this._originalViewBox.x, -this._originalViewBox.y)
  }
}
