/**
 * Module 60973 - Auto-beautified from TradingView webpack bundle
 *
 * @module 60973
 * @date 2026-04-23
 * @size 36626 bytes
 ...
 *
 * Dependencies: 4359, 7024, 9343, 19679, 22489, 24317, 25672, 36947, 45580, 49156, 52859, 57511, 59064, 59883, 69558, 72755, 82095, 86572, 87465, 93201, 97760, 97902
 *
 * Next Steps:
...
60973: (e, t, i) => {
    ...
    const {
      ...
      DEFAULT_THEME: l
    } = i(22489), c = i(49156).colors;
    var h = i(86572).TradedGroupHorizontalAlignment,
      d = i(82095),
      u = i(36947).LineToolPitchforkStyle,
      _ = i(45580).LineToolBarsPatternMode,
      p = i(4359),
      m = p.LineStudyPlotStyle,
      g = p.STUDYPLOTDISPLAYTARGET,
      f = i(19679),
      y = i(97902).PriceAxisLastValueMode,
      v = i(7024).MagnetMode,
      S = i(25672).LineEnd,
      b = i(93201).ColorType;
    const w = i(59883).DEFAULT_LINE_TOOL_LINE_WIDTH;
    var C = i(97760).StatsPosition,
      T = i(57511).sessionsPreferencesDefault,
      P = i(72755).axisLabelBackgroundColor,
      x = i(59064).mainSeriesProperties;
    const {
      LINESTYLE_SOLID: M,
      LINESTYLE_DASHED: I
    } = i(69558);
    ...
    var ke = function(e) {
      ...
      if (void 0 === TradingView.defaultProperties) {
        ...
        TradingView.defaultProperties = {
          ...
          linetoolganncomplex: {
            ...
            fanlines: [ke(O, !1, w, 8, 1), ke(J, !1, w, 5, 1), ke(Pe, !1, w, 4, 1), ke(ye, !1, w, 3, 1), ke(z, !0, w, 2, 1), ke(me, !0, w, 1, 1), ke(ue, !0, w, 1, 2), ke(ue, !1, w, 1, 3), ke(D, !1, w, 1, 4), ke(F, !1, w, 1, 5), ke(O, !1, w, 1, 8)],
            arcs: [ke(ye, !0, w, 1, 0), ke(ye, !0, w, 1, 1), ke(ye, !0, w, 1.5, 0), ke(z, !0, w, 2, 0), ke(z, !0, w, 2, 1), ke(me, !0, w, 3, 0), ke(me, !0, w, 3, 1), ke(ue, !0, w, 4, 0), ke(ue, !0, w, 4, 1), ke(D, !0, w, 5, 0), ke(D, !0, w, 5, 1)]
          },
          linetoolgannfixed: {
            fillBackground: !1,
            arcsBackground: {
      ...
      if (void 0 === TradingView.defaultProperties["study_VbPFixed@tv-volumebyprice"] && (TradingView.defaultProperties["study_VbPFixed@tv-volumebyprice"] = Fe), void 0 === TradingView.defaultProperties["study_VbPFixed@tv-basicstudies"] && (TradingView.defaultProperties["study_VbPFixed@tv-basicstudies"] = Fe), void 0 === TradingView.defaultProperties.linetoolanchoredvp && (TradingView.defaultProperties.linetoolanchoredvp = Oe(!0)),
        void 0 === TradingView.defaultProperties["study_VbPAutoAnchored@tv-volumebyprice"] && (TradingView.defaultProperties["study_VbPAutoAnchored@tv-volumebyprice"] = Oe(!0)), void 0 === TradingView.defaultProperties["study_ElliottWave@tv-basicstudies"] && (TradingView.defaultProperties["study_ElliottWave@tv-basicstudies"] = {
          inputs: {},
          level0: t($, !1),
          level1: t("#008000", !1),
          level2: t("#0000ff", !1),
      ...
      for (var We = e.split("."), He = TradingView.defaultProperties, ze = 0; ze < We.length; ze++) He && (He = He[We[ze]]);
      return null != He ? s(He) : {}
    };
    ...
    function Ee(e, t, i, s, o) {
      if (s)
        for (var n in s) {
          var r = n.split("."),
            a = c(r[0]),
            l = void 0 !== o && o === r[0];
          0 !== r.length && l && (a = c((r = r.slice(1))[0])), 0 !== r.length && e.hasOwnProperty(a) ? h(e, r, s[n]) || d(n) : l && d(n)
        }
      ...
      function h(e, t, i, s) {
        var o = c(t[0]);
        return !!e.hasOwnProperty(o) && (t.length > 1 ? h(e[o], t.slice(1), i) : (e[o] && e[o].setValue ? e[o].setValue(i) : e[o] = i, !0))
      }
    ...
    }, TradingView.factoryDefaults = ke, window.applyDefaultOverridesToLinetools = Ve, window.applyDefaultsOverrides = De, window.applyPropertiesOverrides = Ee, window.defaults = Re, t.applyDefaultOverridesToLinetools = Ve, t.applyDefaultsOverrides = De, t.applyPropertiesOverrides = Ee, t.defaults = Re, t.factoryDefaults = ke, t.saveDefaults = TradingView.saveDefaults, t.createDefaults = Re.create, t.removeDefaults = Re.remove
