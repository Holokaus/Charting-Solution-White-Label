/**
 * Module 36597 - Auto-beautified from TradingView webpack bundle
 *
 * @module 36597
 * @date 2026-04-23
 * @size 1455 bytes
 ...
 *
 * Dependencies: 37103, 46082, 95059
 *
 * Exports:
 *   - areEqualSymbols (internal: a)
 *   - compareSymbolParams (internal: d)
 *   - symbolParams (internal: h)
 *   - symbolSameAsCurrent (internal: c)
 *
 * Next Steps:
...
function d(e, t, i) {
  ...
  }(r, _), u = void 0 !== a && ! function(e, t, i) {
    return null === e && !(0, o.isConvertedToOtherUnit)(t, i) || e === (0, o.symbolUnit)(t, i)
  }(a, _, i)) : (d = void 0 !== r && r !== e.currency(), u = void 0 !== a && a !== e.unit());
  return {
    symbolChanged: h,
