/**
 * Module 13421 - Auto-beautified from TradingView webpack bundle
 *
 * @module 13421
 * @date 2026-04-23
 * @size 3770 bytes
 ...
 *
 * Dependencies: 31645, 75719, 87465
 *
 * Exports:
 *   - JStudyDataUpdate (internal: p)
 *
 * Next Steps:
...
class o {
  constructor() {
    this.isUpdate = !1, this.graphicsCmds = new s.GraphicsCmds, this._offsetsChanged = !1, this._disableGraphicsAndData = !1
  }
  isNaN() {
...
class u extends n {
  ...
  update(e) {
    (this._dataObj.checkForChangeAndResetChangedState(this._eraseCmds) || e) && (null !== this._dataObj.graphicsCmds.create && (this._dataObj.graphicsCmds.create.deleteErasedObjs(), this._dataObj.graphicsCmds.erase = [new s.EraseAll]), this._makeSnapshot(), this._isDirty = !0)
  }
  _makeSnapshot() {
...
class p extends u {
  ...
  update(e) {
    (this._dataObj.checkForChangeAndResetChangedState(this._eraseCmds) || e) && (null !== this._dataObj.graphicsCmds.create && (this._dataObj.graphicsCmds.erase = [new s.EraseAll]), this._dataObj.isUpdate = !0, this._makeSnapshot(), null !== this._dataObj.graphicsCmds.create && (this._dataObj.graphicsCmds.erase = this._eraseCmds), this._dataObj.isUpdate = !0, this._jsonUpdate = this._dataObj.primitiveData(this._updatePredicate), null !== this._dataObj.graphicsCmds.create && this._dataObj.graphicsCmds.create.deleteErasedAndMarkPostedObjs(), this._sendShapshotOnly = e || this._isFirstNotForcedUpdate, this._isFirstNotForcedUpdate = Boolean(e), this._isDirty = !0)
  }
  getUpdate() {
