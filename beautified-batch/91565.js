/**
 * Module 91565 - Auto-beautified from TradingView webpack bundle
 *
 * @module 91565
 * @date 2026-04-23
 * @size 2563 bytes
 ...
 *
 * Dependencies: 11542, 87465, 96935, 97906
 *
 * Exports:
 *   - VolumeFormatter (internal: l)
 *
 * Next Steps:
...
class l {
  ...
  format(e, t) {
    ...
    let o = "";
    Math.abs(e) < 1 && (e = +e.toFixed(this._precision)), e < 0 ? o = "−" : e > 0 && t?.signPositive && (o = "+"), e = Math.abs(e);
    const r = !!(t?.ignoreLocaleNumberFormat ?? this._options.ignoreLocaleNumberFormat);
    let l, c, h = Math.floor(Math.log10(e)) + 1;
    if (h <= this._significantDigits && (e = +e.toFixed(this._precision), h = Math.floor(Math.log10(e)) + 1), h <= this._significantDigits) l = this._formatNumber(e, r, this._formatter);
    else {
      let t = a(h, this._significantDigits);
      const i = Math.pow(10, t.value);
      e = +(e / i).toFixed(this._dimensionPrecision) * i, t = a(Math.floor(Math.log10(e)) + 1, this._significantDigits), l = this._formatNumber(e / Math.pow(10, t.value), r, this._dimensionFormatter), c = t.letter
    }
