/**
 * Module 52746 - Auto-beautified from TradingView webpack bundle
 *
 * @module 52746
 * @date 2026-04-23
 * @size 2835 bytes
 ...
 *
 * Dependencies: 50151, 55803, 72187
 *
 * Exports:
 *   - SeriesData (internal: p)
 *   - barFunction (internal: u)
 *   - barFunctions (internal: h)
 *   - seriesPlotFunctionMap (internal: d)
 *
 * Next Steps:
...
function(e) {
  e[e.Time = 0] = "Time", e[e.Open = 1] = "Open", e[e.High = 2] = "High", e[e.Low = 3] = "Low", e[e.Close = 4] = "Close", e[e.Volume = 5] = "Volume", e[e.Adt = 6] = "Adt"
}(o || (o = {}));
...
class p {
  constructor() {
    this.m_bars = new r.PlotList(d(), _), this.m_nsBars = new r.PlotList(d(), _), this._conflatedChunksBuilder = new a.ConflatedChunksBuilder(this.m_bars, (e => h[e]))
  }
  bars() {
    return this.m_bars
  }
  ...
  search(e, t, i) {
    return this.nsBars().isEmpty() ? this.bars().search(e, t, i) : this.bars().isEmpty() || (0, n.ensureNotNull)(this.nsBars().firstIndex()) <= e ? this.nsBars().search(e, t, i) : this.bars().search(e, t, i)
  }
  valueAt(e) {
