/**
 * Module 43046 - Auto-beautified from TradingView webpack bundle
 *
 * @module 43046
 * @date 2026-04-23
 * @size 4419 bytes
 ...
 *
 * Dependencies: 19844, 50151, 87465
 *
 * Exports:
 *   - migrateMetaInfoAndPropState (internal: p)
 *
 * Next Steps:
...
43046: (e, t, i) => {
    ...
    class a {
      ...
      migratePropState(e) {
        r.includes(e.id) && (e.inputs.length = e.inputs.length ?? e.inputs.in_0, e.inputs.source = e.inputs.source ?? e.inputs.in_1, e.inputs.offset = e.inputs.offset ?? e.inputs.in_2, delete e.inputs.in_0, delete e.inputs.in_1, delete e.inputs.in_2, e.plots[1] = {
          id: "smoothedMA",
          type: "line"
        }, e.styles.smoothedMA = {
          display: 0,
    ...
    class c {
      ...
      migratePropState(e) {
        l.includes(e.id) && (e.inputs.maLength = e.inputs.length ?? e.inputs.maLength, delete e.inputs.length, delete e.inputs.offset, delete e.inputs.source, e.plots[1] = {
          id: "smoothedMA",
          type: "line"
        }, e.styles.smoothedMA = {
          display: 0,
    ...
    const _ = [new class {
      ...
      migrateMetaInfo(e) {
        const t = e,
          i = e;
        if (i._metainfoVersion = 50, void 0 === t.defaults || void 0 === t.defaults.ohlcPlots || void 0 === t.ohlcPlots) return;
        const o = t.ohlcPlots,
    ...
    function p(e, t) {
      ...
      _.forEach((o => {
        (i < 0 || i >= o.targetMetaInfoVersion()) && !r || (o.migrateMetaInfo(e), void 0 !== t && o.migratePropState(t), (0, s.assert)(e._metainfoVersion === o.targetMetaInfoVersion()))
      }))
    }
