/**
 * Module 19979 - Auto-beautified from TradingView webpack bundle
 *
 * @module 19979
 * @date 2026-04-23
 * @size 14331 bytes
 ...
 *
 * Dependencies: 4659, 37236, 51101, 51829
 *
 * Exports:
 *   - Std (internal: h)
 *
  ...
  getPreAndPostMarketTimes(e) {
    ...
    for (let l = 1; l < e.length; l++) {
      ...
      null !== o && this._isInPostMarketSession(a) && !this._isInPostMarketSession(h) && (i.push({
        start: o,
        stop: r
      }), o = null), null === n && this._isInPreMarketSession(h) && (n = c), null === o && this._isInPostMarketSession(h) && (o = c), null !== n && this._isInPreMarketSession(a) && !this._isInPreMarketSession(h) && (t.push({
        start: n,
        stop: r
      }), n = null), r = c, a = h
    }
...
h.max_series_default_size = 10001, h.n = e => e.symbol.index + 1, h.nz = (e, t = 0) => isFinite(e) ? e : t, h.na = function(e) {
    return 0 === arguments.length ? NaN : isNaN(e) ? 1 : 0
  }, h.isZero = e => Math.abs(e) <= 1e-10 ? 1 : 0, h.toBool = e => isFinite(e) && !h.isZero(e), h.eq = (e, t) => h.isZero(e - t), h.neq = (e, t) => c(!h.eq(e, t)), h.ge = (e, t) => c(h.isZero(e - t) || e > t), h.gt = (e, t) => c(!h.isZero(e - t) && e > t), h.lt = (e, t) => c(!h.isZero(e - t) && e < t), h.le = (e, t) => c(h.isZero(e - t) || e < t), h.and = (e, t) => isNaN(e) || isNaN(t) ? NaN : h.isZero(e) || h.isZero(t) ? 0 : 1, h.or = (e, t) => isNaN(e) || isNaN(t) ? NaN : h.isZero(e) && h.isZero(t) ? 0 : 1, h.not = e => isNaN(e) ? NaN : h.isZero(e) ? 1 : 0, h.eps = () => l, h.greaterOrEqual = (e, t, i) => t - e < (i || l), h.lessOrEqual = (e, t, i) => e - t < (i || l), h.equal = (e, t, i) => Math.abs(e - t) < (i || l), h.greater = (e, t, i) => e - t > (i || l), h.less = (e, t, i) => t - e > (i || l), h.compare = (e, t, i) => h.equal(e, t, i) ? 0 : h.greater(e, t, i) ? 1 : -1, h.max = Math.max, h.min = Math.min, h.pow = Math.pow, h.abs = Math.abs, h.log = Math.log, h.log10 = e => Math.log(e) / Math.LN10, h.sqrt = Math.sqrt, h.sign = e => isNaN(e) ? NaN : h.isZero(e) ? 0 : e > 0 ? 1 : -1, h.exp = Math.exp, h.sin = Math.sin, h.cos = Math.cos, h.tan = Math.tan, h.asin = Math.asin, h.acos = Math.acos, h.atan = Math.atan, h.floor = Math.floor, h.ceil = Math.ceil, h.round = Math.round, h.avg = (...e) => {
    if (2 === e.length) return (e[0] + e[1]) / 2;
    let t = 0;
    for (let i = 0; i < e.length; i++) t += e[i];
    return t / e.length
  }, h.open = e => e.symbol.open, h.high = e => e.symbol.high, h.low = e => e.symbol.low, h.close = e => e.symbol.close, h.hl2 = e => (e.symbol.high + e.symbol.low) / 2, h.hlc3 = e => (e.symbol.high + e.symbol.low + e.symbol.close) / 3, h.ohlc4 = e => (e.symbol.open + e.symbol.high + e.symbol.low + e.symbol.close) / 4, h.volume = e => e.symbol.volume, h.updatetime = e => e.symbol.updatetime, h.time = e => e.symbol.bartime(), h.period = e => e.symbol.period, h.tickerid = e => e.symbol.tickerid, h.currencyCode = e => e.symbol.currencyCode, h.unitId = e => e.symbol.unitId, h.ticker = e => e.symbol.ticker, h.interval = e => e.symbol.interval, h.isdwm = e => e.symbol.isdwm(), h.isintraday = e => !e.symbol.isdwm(),
  h.isdaily = e => "D" === e.symbol.resolution, h.isweekly = e => "W" === e.symbol.resolution, h.ismonthly = e => "M" === e.symbol.resolution, h.year = (e, t) => h.timepart(e.symbol, s.YEAR, t), h.month = (e, t) => h.timepart(e.symbol, s.MONTH, t), h.weekofyear = (e, t) => h.timepart(e.symbol, s.WEEK_OF_YEAR, t), h.dayofmonth = (e, t) => h.timepart(e.symbol, s.DAY_OF_MONTH, t), h.dayofweek = (e, t) => h.timepart(e.symbol, s.DAY_OF_WEEK, t), h.hour = (e, t) => h.timepart(e.symbol, s.HOUR_OF_DAY, t), h.minute = (e, t) => h.timepart(e.symbol, s.MINUTE, t), h.second = (e, t) => h.timepart(e.symbol, s.SECOND, t), h.add_days_considering_dst = (e, t, i) => (0, s.add_days_considering_dst)((0, s.get_timezone)(e), t, i), h.add_years_considering_dst = (e, t, i) => (0, s.add_years_considering_dst)((0, s.get_timezone)(e), t, i), h.selectSessionBreaks = (e, t) => {
    ...
    return e && isNaN(i) && (i = h.close(t)), h.max(h.max(h.high(t) - h.low(t), h.abs(h.high(t) - i)), h.abs(h.low(t) - i))
  }, h.atr = (e, t) => {
  ...
  }, h.lowestbars = (e, t, i) => -d(e, t, 0, ((e, t) => h.lt(e, t)), Number.MAX_SAFE_INTEGER).index, h.lowest = (e, t, i) => d(e, t, 0, ((e, t) => h.lt(e, t)), Number.MAX_SAFE_INTEGER).value, h.highestbars = (e, t, i) => -d(e, t, 0, ((e, t) => h.gt(e, t)), Number.MIN_SAFE_INTEGER).index, h.highest = (e, t, i) => d(e, t, 0, ((e, t) => h.gt(e, t)), Number.MIN_SAFE_INTEGER).value, h.cum = (e, t) => {
    const i = t.new_var(),
      s = h.nz(i.get(1)) + e;
    return i.set(s), s
  }, h.accdist = e => {
    ...
    const v = u.get(1),
      ...
      C = _.get(),
      T = _.get(1);
    2 === h.n(s) && (h.greater(C, T) ? (o.set(1), r.set(d.get()), m = v, f = d.get()) : (o.set(-1), r.set(u.get()), m = b, f = u.get()), y = !0, n.set(e), g = e);
    let P = m + g * (f - m);
    return 1 === o.get() ? h.greater(P, u.get()) && (y = !0, o.set(-1), P = Math.max(d.get(), r.get()), r.set(u.get()), n.set(e)) : h.less(P, d.get()) && (y = !0, o.set(1), P = Math.min(u.get(), r.get()), r.set(d.get()), n.set(e)), y || (1 === o.get() ? h.greater(d.get(), r.get()) && (r.set(d.get()), n.set(Math.min(n.get() + t, i))) : h.less(u.get(), r.get()) && (r.set(u.get()), n.set(Math.min(n.get() + t, i)))), 1 === o.get() ? (P = Math.min(P, v), h.n(s) > 2 && (P = Math.min(P, S))) : (P = Math.max(P, b), h.n(s) > 2 && (P = Math.max(P, w))), p.set(P), P
  }, h.alma = (e, t, i, s) => {
  ...
  }, h.zigzag = (e, t, i) => new m(e, t, i).lastPrice(), h.zigzagbars = (e, t, i) => {
    const s = new m(e, t, i);
...
class p {
  constructor(e, t, i, s, o) {
    this._areaRight = e, this._areaLeft = t, this._pivotType = i, this._series = s, this._currentIndex = o.new_var(0), this._currentValue = o.new_var(NaN), this._pivotIndex = o.new_var(-1), this._index = h.n(o), this._isNewBar = o.symbol.isNewBar;
...
class m {
  constructor(e, t, i) {
    ...
    const s = i.new_var(h.high(i)),
      o = i.new_var(h.low(i));
    s.get(2 * t + 1), o.get(2 * t + 1), this._pivotHigh = new p(t, t, _, s, i), this._pivotLow = new p(t, t, u, o, i), this._lastVal = i.new_var(NaN), this._lastIndex = i.new_var(-1), this._lastType = i.new_var(), this._index = h.n(i), this._isBarClosed = i.symbol.isBarClosed;
...
h.vwap = (e, t, i) => {
    const s = i.new_var(),
      o = i.new_var();
    return t && (s.reset_hist(), o.reset_hist()), s.set(h.nz(s.get(1)) + e.get(0) * h.volume(i)), o.set(h.nz(o.get(1)) + h.volume(i)), s.get(0) / o.get(0)
  }, h.vwapBands = (e, t, i, s) => {
    const o = s.new_var(),
      n = s.new_var();
