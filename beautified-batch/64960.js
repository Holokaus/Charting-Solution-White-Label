/**
 * Module 64960 - Auto-beautified from TradingView webpack bundle
 *
 * @module 64960
 * @date 2026-04-23
 * @size 1357 bytes
 ...
 *
 * Exports:
 *   - VerticalLineRenderer (internal: l)
 *
 * Next Steps:
...
class l extends a.BitmapCoordinatesPaneRenderer {
    ...
    hitTest(e) {
      ...
      const t = (0, n.interactionTolerance)().line,
        ...
        o = void 0 === this._data.bottom || e.y - this._data.bottom <= t;
    ...
    _drawImpl(e) {
      ...
      void 0 !== u && (0, r.addExclusionAreaByScope)(e, u), (0, o.drawVerticalLine)(t, c, h, d)
    }
