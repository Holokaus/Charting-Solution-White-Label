/**
 * Module 11417 - Auto-beautified from TradingView webpack bundle
 *
 * @module 11417
 * @date 2026-04-23
 * @size 1959 bytes
...
11417: (e, t, i) => {
    ...
    n.prototype._report = function() {
      if (this.isAvailable) {
        ...
        const s = t.slice(0, e);
        o.logNormal(`Total amount of keys in Local Storage: ${this.length}`), o.logNormal(`Top ${e} keys with longest values: ${JSON.stringify(i)}`), o.logNormal(`Top ${e} longest key names: ${JSON.stringify(s)}`);
        try {
