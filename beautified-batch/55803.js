/**
 * Module 55803 - Auto-beautified from TradingView webpack bundle
 *
 * @module 55803
 * @date 2026-04-23
 * @size 2660 bytes
 ...
 *
 * Exports:
 *   - ConflatedChunksBuilder (internal: r)
 *
 * Next Steps:
...
class r {
  ...
  mergeData(e) {
    const t = this._plots.size(),
      i = this._plots.merge(e);
    return i && null !== this._conflatedChunks.priceSource && (t !== this._plots.size() || i.index !== this._plots.lastIndex() || function(e) {
      let t = !0;
      return e.chunks.forEach((e => {
        t = t && 0 === e.length
      })), t
    }(this._conflatedChunks) ? this._rebuildConflatedChunks(i) : this._updateLatestChunks()), i
  }
  moveData(e) {
  ...
  _rebuildConflatedChunks(e) {
    ...
    if (null === t) return;
    const i = e.index,
      r = this._conflatedChunks.priceSourcesProvider(t),
      a = (e, t, i) => {
        let s = null;
        for (const o of e) {
          const e = r(o.value);
          s && o.index - s.startTime >= i.barsToMerge && (t.push(s), s = null), s ? (s.endTime = o.index, s.high = Math.max(s.high, e), s.low = Math.min(s.low, e), s.close = e) : s = {
            startTime: o.index,
            endTime: o.index,
            open: e,
            high: e,
    ...
    n.forEach((e => {
      const t = (0, s.ensureDefined)(this._conflatedChunks.chunks.get(e.barsToMerge)),
        n = (0, o.lowerbound)(t, i, ((e, t) => e.endTime < t));
      if (0 === n && t.length > 0) {
        const i = t[0].startTime - 1,
          o = (0, s.ensureNotNull)(this._plots.firstIndex()),
          n = this._plots.rangeIterator(o, i),
          r = [];
        a(n, r, e);
        const l = r.concat(t);
        ...
        t.length && (o = t[t.length - 1].endTime + 1);
  ...
  _updateLatestChunks() {
    ...
    n.forEach((i => {
      const o = (0, s.ensureDefined)(this._conflatedChunks.chunks.get(i.barsToMerge)),
        n = t(e.value),
        r = o[o.length - 1];
      r.high = Math.max(r.high, n), r.low = Math.min(r.low, n), r.close = n, r.endTime = e.index
    }))
  }
