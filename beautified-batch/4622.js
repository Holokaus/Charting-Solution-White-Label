/**
 * Module 4622 - Auto-beautified from TradingView webpack bundle
 *
 * @module 4622
 * @date 2026-04-23
 * @size 1656 bytes
 ...
 *
 * Exports:
 *   - findSuitableResolutionToBuildFrom (internal: n)
 *
 * Next Steps:
...
function o(e, t) {
  ...
  return {
    error: !0,
    errorMessage: (s = t.value(), `Misconfiguration error: it is trying to request ${s} but we cannot build it from lower resolution`)
  };
  var s
}
...
function n(e, t) {
  ...
  if ((i.isWeeks() || i.isMonths()) && t.has_weekly_and_monthly) {
    let e = ["1"];
    i.isWeeks() && void 0 !== t.weekly_multipliers && (e = t.weekly_multipliers), i.isMonths() && void 0 !== t.monthly_multipliers && (e = t.monthly_multipliers);
    const s = o(e, i);
    if (!s.error) return s
  }
  if (i.isDWM() && (void 0 === t.has_daily || t.has_daily)) return i.isDays() && void 0 !== t.daily_multipliers ? o(t.daily_multipliers, i) : void 0 === t.daily_multipliers || t.daily_multipliers.includes("1") ? {
    error: !1,
    resolution: "1D"
  } : {
    error: !0,
