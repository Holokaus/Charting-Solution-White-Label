/**
 * Module 53107 - Auto-beautified from TradingView webpack bundle
 *
 * @module 53107
 * @date 2026-04-23
 * @size 4521 bytes
 ...
 *
 * Dependencies: 16329, 22613, 37236, 48943, 50151, 95059
 *
 * Exports:
 *   - MarketStatusModel (internal: u)
 *
 * Next Steps:
...
function d(e, t, i) {
  ...
  e.Open = "market", e.Pre = "pre_market", e.Post = "post_market", e.Close = "out_of_session", e.Holiday = "holiday", e.Delisted = "delisted", e.Expired = "expired"
}(s || (s = {}));
class u {
  constructor(e) {
    this._currentSession = new r.WatchedValue(null), this._delistedByTypespecs = new r.WatchedValue(!1), this._sessionsSpec = null, this._nextSessionEdgeInternal = null, this._nextSessionEdge = new r.WatchedValue(null), this._recalcNextSessionEdgeTimerId = null, this._delay = 0, this._futuresContractExpirationTime = null, this._quotesProvider = e;
    const {
      current_session: t
    } = e.quotes() ?? {};
    t && this._currentSession.setValue(t), this._marketStatus = (0, a.combine)(((e, t, i) => null === e ? e : t ? "delisted" : i ? "expired" : function(e) {
      switch (e) {
        case "market":
          return "market";
        case "pre_market":
    ...
    }(e)), this._currentSession.weakReference(), this._delistedByTypespecs.weakReference(), (this._futuresContractExpirationTime?.expired() ?? new r.WatchedValue(!1)).weakReference()), e.quotesUpdate().subscribe(this, (e => {
  ...
  destroy() {
    this._quotesProvider.quotesUpdate().unsubscribeAll(this), this._quotesProvider.quoteSymbolChanged().unsubscribeAll(this), null !== this._recalcNextSessionEdgeTimerId && clearTimeout(this._recalcNextSessionEdgeTimerId), this._marketStatus.destroy()
  }
  ...
  setSymbolInfo(e) {
    ...
    void 0 !== o && (i = new l.SessionsSpec(e.timezone, o["session-display"] ?? o.session, e.session_holidays, o["session-correction"])), void 0 !== n && (s = new l.SessionsSpec(e.timezone, n["session-display"] ?? n.session, e.session_holidays, n["session-correction"])), this._sessionsSpec = {
      general: t,
      preMarket: i,
      postMarket: s
    ...
    if (null === this._nextSessionEdgeInternal || (this._nextSessionEdgeInternal.timestamp ?? 1 / 0) <= e / 1e3) {
      ...
      if (u === 1 / 0) {
        const e = h(this._delay),
          ...
          a = d((0, n.cal_to_utc)(o, t.alignToNearestSessionStart(r, 1)), (0, n.cal_to_utc)(o, t.alignToNearestSessionEnd(r, 1)), s),
          _ = Math.min(a, l, c);
