/**
 * Module 52859 - Auto-beautified from TradingView webpack bundle
 *
 * @module 52859
 * @date 2026-04-23
 * @size 1993 bytes
 ...
 *
 * Exports:
 *   - alphaToTransparency (internal: r)
 *   - applyAlpha (internal: n)
 *   - applyTransparency (internal: l)
 *   - colorFromBackground (internal: u)
 *   - colorToInteger (internal: g)
 *   - generateColor (internal: o)
 *   - getLuminance (internal: h)
 *   - gradientColorAtPercent (internal: _)
 *   - isHexColor (internal: d)
 *   - resetTransparency (internal: c)
 *   - rgbaFromInteger (internal: p)
 *   - rgbaToInteger (internal: m)
 *   - transparencyToAlpha (internal: a)
 *
 * Next Steps:
...
function o(e, t, i) {
  if (t = t || 0, !d(e)) return i ? (0, s.rgbaToString)((0, s.rgba)((0, s.parseRgb)(e), (0, s.normalizeAlphaComponent)(a(t)))) : e;
...
function c(e) {
  return "transparent" === e ? e : d(e) ? e.slice(0, 7) : (0, s.rgbaToString)((0, s.rgba)((0, s.parseRgb)(e), (0, s.normalizeAlphaComponent)(1)))
}
...
function _(e, t, i) {
  const [o, n, r, a] = (0, s.parseRgba)(e), [l, c, h, d] = (0, s.parseRgba)(t), u = (0, s.rgba)(Math.round(o + i * (l - o)), Math.round(n + i * (c - n)), Math.round(r + i * (h - r)), a + i * (d - a));
