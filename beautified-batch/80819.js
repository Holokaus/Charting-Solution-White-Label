/**
 * Module 80819 - Auto-beautified from TradingView webpack bundle
 *
 * @module 80819
 * @date 2026-04-23
 * @size 2517 bytes
 ...
 *
 * Dependencies: 2383, 2624, 4539, 25672, 33350, 50151, 58221, 69558
 *
 * Exports:
 *   - TrendLineRenderer (internal: _)
 *   - drawArrow (internal: u)
 *
 * Next Steps:
...
function d(e, t, i, s, o) {
  t.save(), t.fillStyle = "#000000", t.beginPath(), t.arc(e.x * o, e.y * o, i * o, 0, 2 * Math.PI, !1), t.fill(), s.strokeWidth && (t.lineWidth = s.strokeWidth, t.stroke()), t.restore()
}
...
class _ {
  ...
  draw(e, t) {
    ...
    e.lineCap = n, e.lineJoin = "round", e.strokeStyle = i.color, e.lineWidth = Math.max(1, Math.floor(i.linewidth * s)), (0, a.setLineStyle)(e, o);
    const r = i.points[0],
      l = i.points[1];
    let d = [];
    ...
    null !== u && i.linewidth > 0 && (0, a.addPixelPerfectLineToPath)(e, u[0].x, u[0].y, u[1].x, u[1].y, t), i.overlayLineEndings && this._drawEnds(e, d, i.linewidth, t), e.stroke(), void 0 !== i.excludeBoundaries && e.restore()
  }
  hitTest(e, t) {
    const i = this._data;
