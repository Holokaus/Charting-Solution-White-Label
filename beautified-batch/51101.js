/**
 * Module 51101 - Auto-beautified from TradingView webpack bundle
 *
 * @module 51101
 * @date 2026-04-23
 * @size 18122 bytes
 ...
 *
 * Dependencies: 10892, 37236, 47312, 50151, 51829, 71149, 77914
 *
 * Exports:
 *   - SessionInfo (internal: r)
 *   - alignExchangeTimeToSessionStartAndReturnUTC (internal: E)
 *   - alignPeriodsBackForDataRequest (internal: I)
 *   - alignPeriodsBackForVisibleRange (internal: A)
 *   - getPeriodsBetweenDates (internal: k)
 *   - isTradingNow (internal: D)
 *   - newBarBuilder (internal: M)
 *
 * Next Steps:
...
51101: (e, t, i) => {
    ...
    class l extends r.BarBuilderBase {
      ...
      indexOfBar(e) {
        return e < this._sessionStartMs ? a.SessionStage.PRE_SESSION : e >= this._sessionEndMs ? a.SessionStage.POST_SESSION : (0, n.toInt)((0, s.time_seconds_diff)(e, this._sessionStartMs) / this._periodSec)
      }
      startOfBar(e) {
      ...
      moveTo(e) {
        ...
        this._sessionStartMs = (0, s.cal_to_utc)(t, i), (0, s.add_minutes)(i, o), this._sessionEndMs = (0, s.cal_to_utc)(t, i)
      }
    ...
    class p extends r.BarBuilderBase {
      ...
      moveTo(e) {
        ...
        this._periodEndDay = h.BusinessDay.fromCalendar(_), (0, s.add_date)(d, -1), d = function(e, t) {
          ...
          return i
        }(this._sessionTgt.spec, d), this._periodLastBarStart = u(r, d, a), (this._periodLastBarStart < this._periodStart || this._periodLastBarStart === this._periodEnd) && (this._periodLastBarStart = this._periodStart)
      }
      endOfBar(e) {
        return e === a.SessionStage.LAST_SESSION_END ? this._getZonedDateTimeOfBorder(a.SessionStage.LAST_SESSION_END).getTime() + 1e3 : ((0, c.assert)(0 === e), this._periodEnd)
      }
      isLastBar(e, t) {
      ...
      indexOfBarInYear(e) {
        ...
        return a = (0, s.get_cal_from_unix_timestamp_ms)(d, l), i < (0, s.get_year)(a) ? (a = this._builder.startOfPeriod(o - 1, i), l = u(this._sessionTgt.spec, a, r), {
    ...
    function m(e, t) {
      const i = e.getWeekIndex(t),
        o = (0, s.get_day_of_week)(t) - e.getEntriesForWeek(i).firstDayOfWeek();
      return o < 0 ? o + 7 : o
    }
    ...
    class S {
      ...
      _getBuilder() {
        return null !== this._builder && this._initialized || (this._session.spec.hasWeekEnds() ? this._builder = this._session.spec.hasHistoryCorrections() ? new v(this._session.spec) : new y(this._session.spec) : this._builder = this._session.spec.hasHistoryCorrections() ? new v(this._session.spec) : new f, this._initialized = !0), this._builder
      }
    }
    class b {
      constructor(e) {
      ...
      indexOfPeriod(e) {
        ...
        return 0 === t && e.getTime() < this.startOfPeriod(0, (0, s.get_year)(e)).getTime() && (t = -1), t
      }
      startOfPeriod(e, t) {
        if (e < 0) {
          t--;
    ...
    class w {
      ...
      startOfPeriod(e, t) {
        ...
        if ((0, s.add_date)(a, r), (0, s.get_year)(a) > t) {
          ...
          if (a.getTime() >= (0, c.ensureNotNull)(s.startOfFirstBarInYear).getTime()) return this.startOfPeriod(0, e)
        }
      ...
      indexOfPeriod(e) {
        ...
        if (e.getTime() < (0, c.ensureNotNull)(o.startOfFirstBarInYear).getTime()) return -1;
        if (0 === t && w.isOnFirstCalendarWeekOfYear(e) || 0 !== t && t === o.firstWeekIndex) return this._calculateLastWeek(e, t, i, o.firstWeekbarsCount) - 1;
        let n = this._numberOfCalendarWeeks(e);
        return n += o.firstWeekbarsCount - o.fullWeeksAdjustment, n += this._calculateWeeksWithExtraBar(t, i, o.firstWeekIndex),
      ...
      _calculateBarWeekStart(e, t, i, o) {
        ...
        if (this.indexOfPeriod((0, c.ensureNotNull)(r.getStartDay())) === o) return (0, s.clone)((0, c.ensureNotNull)(r.getStartDay()));
      ...
      _getStartOfYearData(e, t) {
        ...
        let o = (0, s.get_cal)(d, e, s.JANUARY, 1, 0, 0),
          ...
          r = 0;
        for ((0, s.get_day_of_week)(o) === s.FIRST_DAY_OF_WEEK && (r = 1), i = this._getYearStartDataFromWeek(t, n, o); null === i.startOfFirstBarInYear;) n++, r++, o = this._moveToNextCalendarWeekStart(o), i = this._getYearStartDataFromWeek(t, n, o);
      ...
      _getYearStartDataFromWeek(e, t, i) {
        ...
        if (null !== a) {
          ...
          if (e >= 0) n = (0, s.clone)(i), (0, s.add_date)(n, e), r = 2;
            ...
            e = t.getEntries().firstDayOfWeek() - o, e >= 0 && (n = t.getStartDay(), n && (n = (0, s.clone)(n)), r = 1)
          }
        } else {
          const e = this._spec.getEntriesForWeek(t),
            a = e.firstDayOfWeek() - o;
          a >= 0 && (this._hasWorkingDays(e) || this._hasWorkingDaysNextWeek(t + 1)) && (n = (0, s.clone)(i), (0, s.add_date)(n, a), r = 1)
        }
        return {
      ...
      _positionInsideWeekWithSeveralBars(e, t) {
        ...
        return i = this._spec.getHistoryByIndex(e.entryIndex - 1).getEntries().firstDayOfWeek() - t, i <= 0 ? w.IsInMidSession : w.IsBeforeAnySession
      }
    }
    ...
    class C {
      ...
      _getBuilder() {
        return null == this._builder && (this._builder = this._session.spec.hasHistoryCorrections() ? new w(this._session.spec) : new b(this._session.spec)), this._builder
      }
    }
    class T {
      constructor(e) {
    ...
    function M(e, t, i, s = !1) {
      const n = o.Interval.parse(e),
        r = n.multiplier();
      return n.isMinutes() ? l.minutes(r, t) : n.isSeconds() ? l.seconds(r, t) : n.isTicks() ? new l(1, t) : n.isRange() ? new l(60 * r, t) : new p(t, i ?? null, r, function(e, t) {
        switch (e) {
    ...
    function L(e, t, i, n, a, l, c, h) {
      ...
      if (p) m = 864e5;
        ...
        m = 60 * u.spec.getEntriesForWeek(e).maxTradingDayLength() * 1e3
      }
      let g = 0;
      if (d.isWeeks()) g = 7;
      else {
    ...
    function k(e, t, i, n, a, l, c) {
      ...
      if (h.isDWM()) _ = 864e5;
        ...
        _ = 60 * d.spec.getEntriesForWeek(e).maxTradingDayLength() * 1e3
      }
      let p = 0;
      if (h.isWeeks()) p = 7;
      else {
    ...
    function D(e, t) {
      ...
      return r.isOvernight() && n > r.startOffset() + r.length() && o === r.dayOfWeek() - 1 && (o++, n -= 1440), o === r.dayOfWeek() && n >= r.startOffset() && n < r.startOffset() + r.length()
    }
