/**
 * Module 32503 - Auto-beautified from TradingView webpack bundle
 *
 * @module 32503
 * @date 2026-04-23
 * @size 5531 bytes
 ...
 *
 * Dependencies: 4622, 19979, 46082, 50151, 51101, 51829
 *
 * Exports:
 *   - pivotPointsStandardStudyItem (internal: p)
 *
 * Next Steps:
...
var s, o, n = i(51101),
  ...
  h = i(19979);
! function(e) {
  e[e.TRADITIONAL = 0] = "TRADITIONAL", e[e.FIBONACCI = 1] = "FIBONACCI", e[e.WOODIE = 2] = "WOODIE", e[e.CLASSIC = 3] = "CLASSIC", e[e.DEMARK = 4] = "DEMARK", e[e.CAMARILLA = 5] = "CAMARILLA", e[e.FLOOR = 6] = "FLOOR"
}(s || (s = {})),
function(e) {
...
function _(e, t) {
  ...
  return (s || o || n || e.info && (0, c.findSuitableResolutionToBuildFrom)(i, e.info).error) && h.Std.error("You cannot see this pivot timeframe on this resolution"), i
}
const p = {
    ...
    constructor: class {
      ...
      init(e, t) {
        ...
        const l = t(4);
        let c;
        c = "" === l ? e.new_sym(e.symbol.tickerid, _(e.symbol, this._pivTimeFrame)) : e.new_sym(l, _(e.symbol, o)), this._isValidResolution = !0, (0, r.assert)(c.isdwm(), "a DWM resolution is required to use a multi-day bar builder"), this._barBuilder = (0, n.newBarBuilder)(c.period, e.symbol.session)
      }
      main(e, t, i) {
        ...
        const f = function(e, t, i, s, o, n, r, a) {
          ...
          switch (a) {
            case 0:
              c = (i + s + o) / 3, l.p = c, l.r1 = 2 * c - s, l.s1 = 2 * c - i, l.r2 = c + (i - s), l.s2 = c - (i - s), l.r3 = 2 * c + (i - 2 * s), l.s3 = 2 * c - (2 * i - s), l.r4 = 3 * c + (i - 3 * s), l.s4 = 3 * c - (3 * i - s), l.r5 = 4 * c + (i - 4 * s), l.s5 = 4 * c - (4 * i - s);
              break;
            case 1:
              c = (i + s + o) / 3, l.p = c, l.r1 = c + .382 * u, l.s1 = c - .382 * u, l.r2 = c + .618 * u, l.s2 = c - .618 * u, l.r3 = c + u, l.s3 = c - u;
              break;
            case 2:
              c = (i + s + 2 * e) / 4, l.p = c, l.r1 = 2 * c - s, l.s1 = 2 * c - i, l.r2 = c + u, l.s2 = c - u, l.r3 = i + 2 * (c - s), l.s3 = s - 2 * (i - c), l.r4 = l.r3 + u, l.s4 = l.s3 - u;
              break;
            case 3:
              c = (i + s + o) / 3, l.p = c, l.r1 = 2 * c - s, l.s1 = 2 * c - i, l.r2 = c + u, l.s2 = c - u, l.r3 = c + 2 * u, l.s3 = c - 2 * u, l.r4 = c + 3 * u, l.s4 = c - 3 * u;
              break;
            case 4:
              let n = NaN;
              n = h.Std.equal(t, o) ? i + s + 2 * o : h.Std.greater(o, t) ? 2 * i + s + o : 2 * s + i + o, c = n / 4, l.p = c, l.r1 = n / 2 - s, l.s1 = n / 2 - i;
              break;
            case 5:
              c = (i + s + o) / 3, l.p = c, l.r1 = o + 1.1 * u / 12, l.s1 = o - 1.1 * u / 12, l.r2 = o + 1.1 * u / 6, l.s2 = o - 1.1 * u / 6, l.r3 = o + 1.1 * u / 4, l.s3 = o - 1.1 * u / 4, l.r4 = o + 1.1 * u / 2, l.s4 = o - 1.1 * u / 2;
              break;
            case 6:
              c = (i + s + o) / 3, l.p = c, l.r1 = 2 * c - s, l.s1 = 2 * c - i, l.r2 = c + (i - s), l.s2 = c - (i - s), l.r3 = c - l.s1 + l.r2, l.s3 = 2 * c - (2 * i - s);
              break;
            default:
              throw new Error("Unknown kind")
          }
          return l.startIndex__t = n, l.endIndex__t = r, l
        }(c, u, _, p, m, this._barBuilder.startOfBar(0), this._barBuilder.startOfBar(a.SessionStage.POST_SESSION), this._kindPP);
        return e.select_sym(0), this._showHistoricalPivots || (l.pivots = []), l.pivots.push(f), l.pivots.length > this._historicalPivotsToKeep && l.pivots.shift(), g ? this._createResponse() : null
      }
      _createResponse() {
