/**
 * Module 70859 - Auto-beautified from TradingView webpack bundle
 *
 * @module 70859
 * @date 2026-04-23
 * @size 8188 bytes
 ...
 *
 * Dependencies: 5471, 22033, 28477, 50151, 58978
 *
 * Exports:
 *   - SeriesBarColorer (internal: _)
 *
 * Next Steps:
...
class _ extends r.AbstractBarColorer {
    ...
    applyBarStyle(e, t, i, s) {
      const o = i;
      o.barColor = void 0, o.barBorderColor = void 0, o.barWickColor = void 0, o.isBarHollow = void 0, o.isBarUp = void 0, o.upColor = void 0, o.downColor = void 0, o.isTwoColorBar = void 0, o.isMergedBar = void 0;
    ...
    static upColor(e, t) {
      ...
      switch (s) {
        ...
        case 12:
          return {
            barColor: i.hiloStyle.childs().color.value(), barBorderColor: e.childs().hiloStyle.childs().borderColor.value()
          };
        case 13:
          return {
    ...
    _applyHLCAreaStyle(e, t, i, s, o) {
      const n = this._isUp(e, !1, s, this._series.data().first()?.index !== e) ? _.upColor(o, t) : _.downColor(o, t);
      i.barColor = n.barColor, i.barBorderColor = n.barBorderColor
    }
    _applyBarStyle(e, t, i, s) {
      const o = this._isUp(e, !1, i, s.childs().barStyle.childs().barColorsOnPrevClose.value()) ? _.upColor(s) : _.downColor(s);
      t.barColor = o.barColor, t.barBorderColor = o.barBorderColor
    }
    _applyCandleStyle(e, t, i, s) {
      const o = s.childs(),
        n = 1 === o.style.value() ? o.candleStyle.childs() : 19 === o.style.value() ? o.volCandlesStyle.childs() : o.volFootprintStyle.childs(),
        r = this._isUp(e, !1, i, n.barColorsOnPrevClose.value() && this._series.data().first()?.index !== e),
        a = r ? _.upColor(s) : _.downColor(s);
      t.barColor = a.barColor, t.barBorderColor = a.barBorderColor, t.barWickColor = r ? n.wickUpColor ? n.wickUpColor.value() : n.wickColor.value() : n.wickDownColor ? n.wickDownColor.value() : n.wickColor.value()
    }
    _applyHollowCandleStyle(e, t, i, s) {
      ...
      t.barColor = r.barColor, t.barBorderColor = r.barBorderColor, t.barWickColor = n ? o.wickUpColor ? o.wickUpColor.value() : o.wickColor.value() : o.wickDownColor ? o.wickDownColor.value() : o.wickColor.value();
    ...
    _applyHAStyle(e, t, i, s, o) {
      ...
      i.barColor = a.barColor, i.barBorderColor = a.barBorderColor, i.barWickColor = r ? n.wickUpColor.value() : n.wickDownColor.value()
    }
