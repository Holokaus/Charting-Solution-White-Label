/**
 * Module 12362 - Auto-beautified from TradingView webpack bundle
 *
 * @module 12362
 * @date 2026-04-23
 * @size 4793 bytes
 ...
 *
 * Dependencies: 11542, 14411, 23024, 37103, 48096, 50151, 50279, 81593
 *
 * Exports:
 *   - ChartSaverBase (internal: d)
 *
 * Next Steps:
...
class d {
  constructor(e) {
    this._prevChartState = null, this._chartSavedDelegate = new a.Delegate, this._chartAboutToBeSavedDelegate = new a.Delegate, this._chartSizeLimitExceededDelegate = new a.Delegate, this._isSaveInProcess = !1, this._savingToken = null, this._chartWidgetCollection = e
  }
  ...
  saveChartSilently(e, t, i) {
    ...
    this._isSaveInProcess = !0, this._chartAboutToBeSavedDelegate.fire(), this._saveChart((e => {
      ...
      return h(o, i), s.chartName && (o.name = s.chartName), o.name && 0 !== o.name.length || !s.defaultChartName || (o.name = s.defaultChartName), s.autoSave && (o.autoSave = !0), o
    }), ((t, i) => {
      (0, o.assert)(!this._chartWidgetCollection.readOnly(), "Trying to save layout in read-only mode"), i && this.layoutId() === t.uid && this._chartWidgetCollection.metaInfo.name.setValue(i.name ?? ""), this._prevChartState = i, this._chartSavedDelegate.fire(!0), this._isSaveInProcess = !1, e && e({
        uid: t.uid,
        data: i
  ...
  _getCommonSavingInfo(e) {
    ...
    const n = t.metaInfo,
      r = n.id.value();
    return null !== r && (s.id = r), s.name = n.name.value() || "", s.description = n.description.value() || "", s.is_realtime = s.is_realtime = e ? "0" : "1", s
  }
  ...
  _saveChartImpl(e, t, i, s, o, n) {
    let r;
    r = s => {
      t.uid || t.uid !== this.layoutId() || (t.id = s.result, t.uid = `${s.result}`, this._chartWidgetCollection.metaInfo.id.setValue(t.id), this._chartWidgetCollection.metaInfo.uid.setValue(t.uid)), i(t, e)
  ...
  async _saveChart(e, t, o, r) {
    ...
    if (1 & h) {
      const i = e(d);
      if ((0, s.default)(this._prevChartState, i) && null !== c.id) return this._chartSavedDelegate.fire(!0), void t(c, i);
      0;
      const n = (e, i) => (d || this._chartWidgetCollection.getAll().forEach((e => e.lineToolsSynchronizer()?.markAsValidatedBecauseOfSavingToContent())), t(e, i));
