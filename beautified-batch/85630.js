/**
 * Module 85630 - Auto-beautified from TradingView webpack bundle
 *
 * @module 85630
 * @date 2026-04-23
 * @size 2777 bytes
 ...
 *
 * Dependencies: 2383, 5471, 10555, 13173, 37103, 45801, 50151, 52945, 69708, 93387, 94602
 *
 * Exports:
 *   - SeriesColumnsPaneView (internal: p)
 *
 * Next Steps:
...
class p {
  constructor(e, t) {
    this._items = [], this._invalidated = !0, this._isMarkersEnabled = (0, n.enabled)("source_selection_markers"), this._selectionData = null, this._histogramBase = 0, this._source = e, this._model = t, this._selectionIndexer = new h.SelectionIndexes(t.timeScale())
  }
  update() {
    this._invalidated = !0
  }
  renderer() {
    ...
    return t.append(new u.PaneRendererColumns(e)), this._model.selection().isSelected(this._source) && this._isMarkersEnabled && this._selectionData && t.append(new d.SelectionRenderer(this._selectionData)), t
  }
  _updateImpl() {
    this._items = [];
