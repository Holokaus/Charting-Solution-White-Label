/**
 * Module 36281 - Auto-beautified from TradingView webpack bundle
 *
 * @module 36281
 * @date 2026-04-23
 * @size 7473 bytes
 ...
 *
 * Dependencies: 2383, 6453, 10555, 24640, 33350, 39612, 52859, 58221
 *
 * Exports:
 *   - PriceAxisView (internal: _)
 *
 * Next Steps:
...
class d {
  ...
  draw(e, t, i, s, n) {
    ...
    0 === P.length && (P = M, x = I, M = ""), 0 === C.length && (C = P, T = x, P = M, x = I, M = ""), e.save(), void 0 !== p.globalAlpha && (e.globalAlpha *= p.globalAlpha), e.font = i.font;
    const A = s.yMidCorrection(e, C) * _,
      ...
      D = Boolean(M),
      B = v + y + w,
      V = [Math.ceil(s.measureText(e, C)), E ? Math.ceil(s.measureText(e, P)) : 0, D ? Math.ceil(s.measureText(e, M)) : 0],
    ...
    e.fillStyle = ee;
    const te = 2 * _;
    if (e.textAlign = Z ? "right" : "left", e.textBaseline = "middle", Z ? (Q = X - U, J = X - j - q + H) : (Q = X + U, J = X + j + q - H), this._bodyBox = null, C || m) {
    ...
    })), e.restore()), D && (e.fillStyle = I, e.save(), e.translate(J, (K + Y) / 2 + A + F), (0, l.drawScaled)(e, u, _, (() => {
  ...
  topBottomTotalHeight(e) {
    ...
    const i = e.fontSize / 2 + e.paddingTop + this._commonData.additionalPaddingTop,
      s = (t - .5) * e.fontSize + (t - 1) * e.lineSpacing + e.paddingBottom + this._commonData.additionalPaddingBottom;
    return {
      top: i,
      bottom: s,
      total: i + s
  ...
  _drawPlusIcon(e, t, i, s, o, n, r) {
    ...
    e.fillRect(d + h, o, l, r), e.fillRect(u, s + h, r, l), e.beginPath(), e.arc(u + r / 2, o + r / 2, c / 2, 0, 2 * Math.PI, !1), e.stroke()
  }
...
class _ {
  constructor(e) {
    ...
    }, this._invalidated = !0, this._active = !1, this._axisRenderer = new(e || d)(this._axisRendererData, this._commonRendererData), this._paneRenderer = new(e || d)(this._paneRendererData, this._commonRendererData)
  }
  setActive(e) {
    this._active = e
  }
