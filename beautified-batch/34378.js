/**
 * Module 34378 - Auto-beautified from TradingView webpack bundle
 *
 * @module 34378
 * @date 2026-04-23
 * @size 4499 bytes
 ...
 *
 * Dependencies: 19979, 50151
 *
 * Exports:
 *   - anchoredVWAPStudyItem (internal: r)
 *
 * Next Steps:
    ...
    constructor: class {
      ...
      main(e, t, i) {
        ...
        const r = n.Std.volume(e),
          ...
          d = e.symbol.time;
        null !== d && (null === this._isNewSession && (this._isNewSession = n.Std.createNewSessionCheck(e)), this._isNewSession && this._isNewSession(d) && (this._resetHist(l), this._resetHist(c), this._resetHist(h))), l.set(n.Std.nz(l.get()) + a * r), c.set(n.Std.nz(c.get()) + r), h.set(n.Std.nz(h.get()) + a * a * r);
        const u = l.get() / c.get(),
