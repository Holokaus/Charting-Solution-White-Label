/**
 * Module 14411 - Auto-beautified from TradingView webpack bundle
 *
 * @module 14411
 * @date 2026-04-23
 * @size 2915 bytes
 ...
 *
 * Dependencies: 48096, 67455
 *
 * Exports:
 *   - ChartChangesWatcher (internal: a)
 *   - changedAll (internal: r)
 *
 * Next Steps:
...
var s, o = i(67455),
  n = i(48096);
! function(e) {
  e[e.NothingChanged = 0] = "NothingChanged", e[e.ContentChanged = 1] = "ContentChanged", e[e.LineToolsChanged = 2] = "LineToolsChanged"
}(s || (s = {}));
const r = 3;
class a {
  constructor(e, t, i) {
  ...
  _unsubscribe() {
    this._globalEvents.unsubscribe("chart_loaded", this._handleChartLoaded, this), this._globalEvents.unsubscribe("layout_loaded", this._handleLayoutLoaded, this),
