/**
 * Module 24317 - Auto-beautified from TradingView webpack bundle
 *
 * @module 24317
 * @date 2026-04-23
 * @size 4919 bytes
 ...
 *
 * Dependencies: 2433, 11542, 24633, 49156, 85119, 87465, 93201, 96870
 *
 * Exports:
 *   - darkTheme (internal: ce)
 *   - getStdChartTheme (internal: _e)
 *   - getStdThemeNames (internal: ue)
 *   - lightTheme (internal: le)
 *   - overrideStdTheme (internal: he)
 *   - restoreStdThemes (internal: de)
 *   - translateThemeName (internal: pe)
 *
 * Next Steps:
...
function _e(e) {
  return (0, o.clone)(e === ae.StdTheme.Light ? le : e === ae.StdTheme.Dark ? ce : void 0)
}

function pe(e) {
  return {
    [ae.StdTheme.Light]: s.t(null, {
      context: "colorThemeName"
    }, i(96870)),
    [ae.StdTheme.Dark]: s.t(null, {
      context: "colorThemeName"
    }, i(85119))
  } [e] || e
