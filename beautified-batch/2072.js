/**
 * Module 2072 - Auto-beautified from TradingView webpack bundle
 *
 * @module 2072
 * @date 2026-04-23
 * @size 4016 bytes
...
class n {
  ...
  unsubscribe(e) {
    ...
    for (let s = i.length; s--;) i[s].owner !== this && t !== this || i[s].cb !== e && null !== e || i.splice(s, 1)
  }
  readonly() {
...
93132: (e, t, i) => {
    ...
    class s {
      constructor(e, t) {
        ...
        this.hotkey = i, this.handler = s, this.desc = o, this.element = r, this.isRepeatAccepted = a, this.isDisabled = n ? "function" == typeof n ? n : () => !0 : () => !1
      }
      destroy() {
    ...
    class o {
      constructor(e, t) {
        this._actions = new Map, this._manager = e, this.order = t?.order ?? 0, this.modal = !(!t || !t.modal), t && (this.desc = t.desc), t && t.isDisabled ? "function" == typeof t.isDisabled ? this.isDisabled = t.isDisabled : this.isDisabled = () => !0 : this.isDisabled = () => !1, this._manager.registerGroup(this)
      }
      add(e) {
      ...
      handleHotkey(e, t) {
        ...
        if (!i) return !1;
        for (const s of i)
          if ((!s.element || t.target && s.element.contains(t.target)) && !s.isDisabled(t)) return t.repeat && !s.isRepeatAccepted || (s.handler(t), this._callMatchedHotkeyHandler(e)), t.preventDefault(), !0;
        return !1
      }
      promote() {
