/**
 * Module 59149 - Auto-beautified from TradingView webpack bundle
 *
 * @module 59149
 * @date 2026-04-23
 * @size 6983 bytes
    ...
    var t = [{
      ...
      i = function() {
        ...
        s.prototype.toString = function() {
          return this.value
        }, i(o, s), i(n, s), n.prototype.value = "(", i(r, s), r.prototype.value = ")", i(a, s), i(l, a), l.prototype.value = "+", l.prototype.precedence = 0, l.prototype.commutative = !0, i(c, a), c.prototype.value = "-", c.prototype.precedence = 0, c.prototype.commutative = !1, i(h, a), h.prototype.value = "*", h.prototype.precedence = 1, h.prototype.commutative = !0, i(d, a), d.prototype.value = "/", d.prototype.precedence = 1, d.prototype.commutative = !1, i(u, a), u.prototype.value = "^", u.prototype.precedence = 2, u.prototype.commutative = !1;
        var _ = /^'?(?:([A-Z0-9_]+):)?(.*?)'?$/i,
          p = /[+\-/*]/;
        ...
        function C(e) {
          ...
          for (var t, i = [], s = [], o = 0; o < e.length; o++) {
            var l = e[o];
            if (l instanceof a) s.length && s[s.length - 1].minPrecedence > l.precedence && (s[s.length - 1].minPrecedence = l.precedence);
              ...
              var c = e[(t = s.pop()).openBraceIndex - 1],
                h = e[o + 1];
              h instanceof a && !(h.precedence <= t.minPrecedence) || !(!(c instanceof a) || c.precedence < t.minPrecedence || c.precedence === t.minPrecedence && c.commutative) || (i.unshift(t.openBraceIndex), i.push(o), s.length && s[s.length - 1].minPrecedence > t.minPrecedence && (s[s.length - 1].minPrecedence = t.minPrecedence))
            }
          }
