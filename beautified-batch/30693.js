/**
 * Module 30693 - Auto-beautified from TradingView webpack bundle
 *
 * @module 30693
 * @date 2026-04-23
 * @size 2510 bytes
 ...
 *
 * Dependencies: 36281, 50151, 58221, 69558
 *
 * Exports:
 *   - PriceLineAxisView (internal: l)
 *   - SeriesPriceLineAxisView (internal: c)
 *   - StudyPriceLineAxisView (internal: h)
 *
 * Next Steps:
...
class a {
  ...
  draw(e, t, i, s, a) {
    ...
    e.lineWidth = Math.max(1, Math.floor((0, o.ensureDefined)(this._data.linewidth) * c)), e.lineCap = "butt", (0, r.setLineStyle)(e, void 0 === this._data.linestyle ? n.LINESTYLE_DOTTED : this._data.linestyle), e.strokeStyle = this._commonData.textColor, (0, r.drawHorizontalLine)(e, Math.round(h * c), 0, l.width)
  }
