/**
 * Module 13607 - Auto-beautified from TradingView webpack bundle
 *
 * @module 13607
 * @date 2026-04-23
 * @size 8087 bytes
 ...
 *
 * Dependencies: 4168, 20057, 30947, 39527, 48096, 52706, 53470, 67563, 76220, 90484, 98422
 *
 * Next Steps:
...
13607: (e, t, i) => {
    ...
    m.prototype.destroy = function() {
      ...
      m.prototype.typeFields.portfolio = ["pro_name", "short_name", "exchange", "listed_exchange", "description", "local_description", "language", "sector", "type", "typespecs", "industry", "currency_code", "currency_id", "ch", "chp", "logoid", "currency-logoid", "base-currency-logoid", "earnings_per_share_forecast_next_fq", "earnings_release_next_date", "earnings_release_date", "earnings_per_share_fq", "lp", "fractional", "minmov", "minmove2", "pricescale", "volume", "average_volume", "market_cap_calc", "market_cap_basic", "total_revenue", "earnings_per_share_basic_ttm", "price_earnings_ttm", "beta_1_year", "dps_common_stock_prim_issue_fy", "dividends_yield", "fundamental_currency_code", "rates_mc", "rates_fy", "rates_ttm", "format", "value_unit_id", "unit_id", "measure"], m.prototype.typeFields.notes = ["short_name", "pro_name", "logoid", "currency-logoid", "base-currency-logoid", "symbol-primaryname", "type", "typespecs"], m.prototype.typeFields.estimates = ["fundamental_data", "type", "typespecs", "earnings_per_share_forecast_next_symbol_currency_fq", "earnings_release_next_aligned_date", "earnings_release_next_calendar_date", "earnings_release_next_date"], m.prototype.typeFields.economic = ["reference-last-period", "lp", "currency_code", "value_unit_id", "unit_id", "measure"], m.prototype.typeFields.options = ["ask", "bid", "lp", "volume"], m.prototype.connect = function(e) {
        ...
        _() && (delete e.values.prev_close_price, void 0 !== e.values.regular_close && (e.values.prev_close_price = e.values.regular_close)), i || (i = this._throttledSymbolData[t] = {
        ...
        t.forEach((function(e) {
          this._symbol_data[e] ? s && s.has(e) || this._symbol_data[e].subscribers_count++ : (this._symbol_data[e] = {
            subscribers_count: 1
          }, o.push(e)), s.has(e) || s.set(e, []), s.get(e).push(i), s.get(e).fast = !0, this._symbol_data[e] && this._symbol_data[e].values && i(this._symbol_data[e], this._symbol_data[e])
        ...
        for (var s = this._subscriptions[e], o = [], n = 0; n < t.length; n++) {
          ...
          s && 0 === s.size && delete this._subscriptions[e], this._symbol_data.hasOwnProperty(r) && (s && !s.has(r) && this._symbol_data[r].subscribers_count--, this._symbol_data[r].subscribers_count || (delete this._symbol_data[r], o.push(r)))
        }
        ...
        var o = new Promise((function(t, o) {
          if (i._formatterValuesCache[e]) t(s(i._formatterValuesCache[e]));
            ...
            i.subscribe(n, [e], (function(r) {
              "error" === r.status && (i._waitingForFormatters[e] = null, o("Quotes snapshot is not received")),
                function(e) {
                  return e && null != e.pricescale && null != e.minmov
                }(r.values) && (i._waitingForFormatters[e] = null, i._formatterValuesCache[e] = r.values, t(s(r.values)), i.unsubscribe(n, e))
            }))
          }
        }));
        ...
        var i = new Promise((function(i, s) {
          if (t._snapshotValuesCache[e]) i(t._snapshotValuesCache[e]);
            ...
            t.subscribe(o, [e], (function(n) {
              "error" === n.status && (t._waitingForSnapshot[e] = null, s("Quotes snapshot is not received"));
              var r = n.values;
              r && r.minmov && r.pricescale && (t._waitingForSnapshot[e] = null, t._snapshotValuesCache[e] = r, i(r), t.unsubscribe(o, e))
            }))
          }
        }));
        return this._waitingForSnapshot[e] = i, i
      }, window.TradingView = window.TradingView || {}, window.TradingView.QuoteSessionMultiplexer = m, e && e.exports && (e.exports = m)
