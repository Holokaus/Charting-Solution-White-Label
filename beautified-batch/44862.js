/**
 * Module 44862 - Auto-beautified from TradingView webpack bundle
 *
 * @module 44862
 * @date 2026-04-23
 * @size 5314 bytes
 ...
 *
 * Dependencies: 4359, 9343, 50151
 *
 * Exports:
 *   - applyOverridesToStudy (internal: d)
 *   - applyOverridesToStudyDefaults (internal: u)
 *
 * Next Steps:
...
44862: (e, t, i) => {
    ...
    function h(e, t, i, s) {
      ...
      if ((null !== m ? 1 : 0) + (null !== g ? 1 : 0) + (null !== f ? 1 : 0) + (null !== y ? 1 : 0) + (v ? 1 : 0) > 1) return void a.logWarn(`Study '${e.description}' has ambiguous identifier '${r}'`);
      const S = o[1];
      if (null !== m) {
        if (1 === o.length) return void a.logWarn(`Path of sub-property of '${r}' plot for study '${e.description}' must be not empty`);
        const i = o.slice(1);
        l.applyPlotProperty(e, t, m, i, s)
      } else if (null !== y) l.applyInputValue(t, y, s);
      else if (null !== g) {
        if (void 0 === S) return void a.logWarn(`Property name of '${r}' band for study '${e.description}' must be set`);
        l.applyBandProperty(t, g, S, s)
      } else if (null !== f) {
        if (void 0 === S) return void a.logWarn(`Property name of '${r}' area for study '${e.description}' must be set`);
    ...
    function u(e, t, i) {
      ...
      e.applyPlotProperty = function(e, t, i, n, l) {
        ...
        if ("color" === c) {
          ...
          return void
          function(e, t, i, o, n) {
            void 0 !== e.styles ? null === t && !isNaN(o) && o > 0 ? a.logWarn(`Study plot does not have color #${o}`) : ((0 === o || isNaN(o)) && ((0, s.ensureDefined)(e.styles[i]).color = String(n), o = 0), null !== t && ((0, s.ensureDefined)(t.colors?.[o]).color = String(n))) : a.logWarn("Study does not have styles")
        ...
        void 0 !== e.inputs && e.inputs.hasOwnProperty(t) ? e.inputs[t] = i : a.logWarn(`Study does not have input '${t}'`)
