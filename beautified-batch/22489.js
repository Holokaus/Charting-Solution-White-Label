/**
 * Module 22489 - Auto-beautified from TradingView webpack bundle
 *
 * @module 22489
 * @date 2026-04-23
 * @size 10685 bytes
 ...
 *
 * Dependencies: 1765, 11542, 24317, 24377, 24633, 34840, 45345, 48096, 58978, 85119, 96870
 *
 * Exports:
 *   - DEFAULT_THEME (internal: h)
 *   - getCurrentTheme (internal: g)
 *   - getStdTheme (internal: P)
 *   - getStdThemeNames (internal: C)
 *   - getStdThemedValue (internal: x)
 *   - getTheme (internal: b)
 *   - getThemeNames (internal: w)
 *   - getThemedColor (internal: f)
 *   - isStdThemeName (internal: T)
 *   - isStdThemedDefaultValue (internal: M)
 *   - isThemeExist (internal: L)
 *   - removeTheme (internal: A)
 *   - restoreTheme (internal: y)
 *   - saveTheme (internal: I)
 *   - savedThemeName (internal: v)
 *   - syncTheme (internal: S)
 *   - themeListChanged (internal: E)
 *   - themes (internal: m)
 *   - translateStdThemeName (internal: k)
 *
 * Next Steps:
...
22489: (e, t, i) => {
    ...
    function S() {
      var e;
      e = g().name, (0, n.setValue)("current_theme.name", e, {
        forceFlush: !0
      })
    }
