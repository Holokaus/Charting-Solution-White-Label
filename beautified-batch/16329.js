/**
 * Module 16329 - Auto-beautified from TradingView webpack bundle
 *
 * @module 16329
 * @date 2026-04-23
 * @size 21864 bytes
 ...
 *
 * Dependencies: 16879, 37236, 50151, 71149
 *
 * Exports:
 *   - SessionsSpec (internal: T)
 *
 * Next Steps:
...
class c {
  constructor(e, t, i) {
    (0, o.assert)(Number.isFinite(e) && Number.isFinite(t) && Number.isFinite(i), "Invalid arguments"), this._dayOfWeek = e, this._start = t, this._length = i
  }
  start() {
...
class d {
  constructor(e, t, i, s) {
    this._maxTradingDayLength = null, this._list = e, this._entriesByDay = t, this._firstDayOfWeek = i, this._weekEndsCount = s
  }
  firstDayOfWeek() {
...
class v {
  ...
  _parseHistoryEntries(e, t, i) {
    ...
    for (let t = 0; t < s.length; t++) {
      ...
      if (null !== n && null !== a && a.getTime() < n.getTime()) throw new Error(`history sessions are not listed in ascending order (${n} -> ${a}`);
  ...
  _parseFirstDayOfWeek(e) {
    ...
    if (isNaN(s) && (i = 0, s = parseInt(t[1])), s < n.SUNDAY || s > n.SATURDAY) throw new Error(`bad sessions spec: ${e}`);
  ...
  static _parseDay(e, t, i) {
    if (8 === e.length && m(e.charCodeAt(0)) && m(e.charCodeAt(1)) && m(e.charCodeAt(2)) && m(e.charCodeAt(3)) && m(e.charCodeAt(4)) && m(e.charCodeAt(5)) && m(e.charCodeAt(6)) && m(e.charCodeAt(7))) {
  ...
  static _createSessionEntry(e, t, i, s, r) {
    (0, o.assert)(s >= 0 && s < 7), (0, o.assert)(r >= 0 && r < 7), 0 === i && (i = n.minutesPerDay), s === r && i <= t && (s += 1), (0, o.assert)(s >= r), s > 0 && (t -= s * n.minutesPerDay), r > 0 && (i -= r * n.minutesPerDay);
    const a = i - t;
    return (0, o.assert)(e >= n.SUNDAY && e <= n.SATURDAY), (0, o.assert)(t < n.minutesPerDay), (0, o.assert)(a > 0), new c(e, t, a)
  }
...
class T {
  constructor(e = "Etc/UTC", t = "0000-0000", i = "", s = "", o = !1) {
    const r = new v;
    o ? r.parseSessionsAndValidateDateTime(e, t) : r.parseSessions(e, t), this._entries = r.historyEntries, this._hasHistoryCorrections = r.hasHistoryCorrections, this._presentHistoryEntry = r.historyEntries[r.historyEntries.length - 1], this._timezone = r.timezone, this._timezoneObj = (0, n.get_timezone)(r.timezone),
    ...
    this._borderWeeksIndicesHash = l.borderWeeksIndicesHash, this._yearToWeeksIndicesHash = l.yearToWeeksIndicesHash, this._weekIndicesOfLastHistoryWeek = l.weekIndicesOfLastHistoryWeek, this._presentStartWeekIndex = l.startPresentSessionWeekIndex, this._yearToCalculatedAddedWeekIndicesHash = new Map, "" === i && "" === s && null === this._weekIndicesOfLastHistoryWeek ? this._isThereCorrections = !1 : this._isThereCorrections = !0;
    for (const e of a) {
  ...
  isWeekEnd(e) {
    ...
    let i;
    return i = void 0 === this._borderWeeksIndicesHash.get(t) ? this._getHistoryAndIndexForWeek(t).getEntries() : this.getEntriesForWeek(t), i.isWeekEnd((0, n.get_day_of_week)(e))
  }
  isCalWeekEnd(e) {
  ...
  daysOffFromYearStart(e) {
    ...
    if ((0,
        n.get_day_of_year)(e) + s <= n.LAST_DAY_OF_WEEK + n.FIRST_DAY_OF_WEEK) return this._getDaysOffForWeekInBorders(i, s, o);
  ...
  intradayCanBeBuiltFrom24x7(e) {
    for (const t of this._entries)
      if (!t.getEntries().list().every((t => t.start() % e == 0 && t.length() % e == 0))) return !1;
    return !0
  }
  intradayCanBeBuiltFrom24x7Seconds(e) {
    for (const t of this._entries)
      if (!t.getEntries().list().every((t => 60 * t.start() % e == 0 && 60 * t.length() % e == 0))) return !1;
    return !0
  }
  indexOfSession(e, t, i) {
    ...
    if (0 !== u.list().length) {
      ...
      if (i = -(n.minutesPerDay - i + e * n.minutesPerDay), l = (0, r.lowerbound)(u.list(), new c(u.firstDayOfWeek(), i, 0), S), l < u.list().length) return new h(d, l, [...u.list()])
    }
    for (;;)
      if (d++, i -= n.minutesPerWeek, u = this.getEntriesForWeek(d), 0 !== u.list().length && (l = (0, r.lowerbound)(u.list(), new c(s.firstDayOfWeek(), i, 0), S), !(l >= u.list().length))) return new h(d, l, [...u.list()])
  }
  ...
  hasWeekEnds() {
    for (const e of this._entries)
      if (0 !== e.getEntries().weekEndsCount()) return !0;
    return !1
  }
  getWeekIndicesWithAdditionalWeekBars(e) {
    let t = this._yearToCalculatedAddedWeekIndicesHash.get(e);
    return void 0 === t && (t = this._calculateAddedIndices(e), this._yearToCalculatedAddedWeekIndicesHash.set(e, t)), t
  }
  _prepareSessionsBorderParams() {
    ...
    for (let n = 0; n < this._entries.length - 1; n++) {
      ...
      s = T._getWeekIndexImpl(a), e.set(s, n + 1), this._addToYearHash(t, a, s), this._entriesHash.set(s, new C(null)), (0, o.ensureNotNull)(i)[n] = s
    }
    return {
  ...
  _holidaysFromYearStart(e) {
    ...
    for (const [s, o] of this._selectHolidays(t, e)) {
      const e = s.getDayOfWeek(),
        t = 0 === o.length;
      this._presentHistoryEntry.getEntries().isWeekEnd(e) ? i += t ? 0 : -1 : i += t ? 1 : 0
    }
    return i
  }
  _getDaysOffForWeekInBorders(e, t, i) {
    ...
    for (let e = t; e <= i; e++) o.entriesByDay().has(e) || s++;
    return s
  }
  ...
  _correctTradingDay(e, t, i) {
    ...
    return s.getEntry().dayOfWeek() - t + 7 * Math.trunc(s.weekIndex - e)
  }
  _entrySessionValue(e, t, i, s) {
    ...
    let c = Math.trunc(e.weekIndex - l),
      h = !1;
    if (a < n.SUNDAY && (c <= 0 ? h = !0 : c--, a += 7), (c > 0 && i >= 0 || c < 0 && i < 0) && (0, n.add_date)(t, 7 * c), !r.contains(t)) {
      let e = a - o;
  ...
  _businessDaysToCalendarDays(e, t, i) {
    ...
    for (; o < i;) {
      ...
      for (let e = t; e <= n.SATURDAY; e++)
        if (s++, void 0 !== r.entriesByDay().get(e) && o++, o >= i) return s;
      e++, t = n.SUNDAY
    }
    return s
  }
  _calendarDaysToBusinessDays(e, t, i) {
    ...
    for (; s < i;) {
      const r = this.getEntriesForWeek(e);
      for (let e = t; e <= n.SATURDAY; e++)
        if (s++, void 0 !== r.entriesByDay().get(e) && o++, s >= i) return o;
      e++, t = n.SUNDAY
    }
    return o
  }
  ...
  _alignToNearestSessionValue(e, t, i) {
    ...
    if (_ < 0) {
      ...
      if (0 === e) e--, _ += t.length;
        ...
        for (; _ < 0;) e--, t = this.getEntriesForWeek(e).list(), _ += t.length;
      a = new h(e, _, t)
  ...
  _getEntriesForDay(e) {
    const t = (0, n.get_day_of_week)(e),
      i = this.getEntriesForWeek(this.getWeekIndex(e)).entriesByDay().get(t);
    return void 0 !== i ? i : []
  }
  ...
  _checkTooManyCorrectionsOnWeek() {
    ...
    for (let e = 0; e < this._entries.length - 2; e++) {
      const t = this._entries[e],
        i = this._entries[e + 1];
      if (this.getWeekIndex((0, o.ensureNotNull)(t.getSpecEndDay())) === this.getWeekIndex((0, o.ensureNotNull)(i.getSpecEndDay()))) return !1
    }
    return !0
  }
