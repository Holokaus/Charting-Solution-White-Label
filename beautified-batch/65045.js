/**
 * Module 65045 - Auto-beautified from TradingView webpack bundle
 *
 * @module 65045
 * @date 2026-04-23
 * @size 1806 bytes
 ...
 *
 * Dependencies: 9343, 38486, 79603
 *
 * Exports:
 *   - LineToolCollectedProperty (internal: c)
 *   - LineToolColorsProperty (internal: d)
 *   - LineToolWidthsProperty (internal: h)
 *   - MultipleLineColorsProperty (internal: p)
 *   - MultipleLineWidthsProperty (internal: _)
 *
 * Next Steps:
...
class l extends n.PropertyBase {
  constructor(e, t) {
    super(), this._properties = e, e.forEach(((e, t) => e.subscribe(this, ((e, i) => {
  ...
  value() {
    if (0 === this._properties.length) return r.logError("Incorrect call, should not request value of 0 properties"), "mixed";
    const e = this._properties[0].value();
    return 1 === this._properties.length || this._properties.every((t => t.value() === e)) ? e : "mixed"
  }
  setValueSilently(e) {
    "mixed" !== e && this._properties.forEach((t => t.setValueSilently(e)))
  }
  hasChild(e) {
  ...
  child(e) {
    const t = parseInt(e, 10);
    return !isNaN(t) && t >= 0 && t < this._properties.length ? this._properties[t] : void 0
  }
  destroy() {
    this._properties.forEach((e => e.unsubscribeAll(this))), this._listeners.destroy()
  }
