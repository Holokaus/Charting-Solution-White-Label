/**
 * Module 86228 - Auto-beautified from TradingView webpack bundle
 *
 * @module 86228
 * @date 2026-04-23
 * @size 3287 bytes
 ...
 *
 * Dependencies: 2383, 2624, 6453, 10307, 10555, 18330, 50151, 52859, 58221
 *
 * Exports:
 *   - RectangleRenderer (internal: _)
 *
 * Next Steps:
...
class _ extends u.BitmapCoordinatesPaneRenderer {
    ...
    hitTest(e, t) {
      ...
      if (_ = (0, a.distanceToSegment)(o, h, e), _.distance <= 3) return new c.HitTestResult(c.HitTarget.MovePoint);
    ...
    _drawImpl(e) {
      ...
      const {
        ...
        linewidth: a,
        middleLine: l
      } = this._data, c = (0, n.box)(...this._data.points), u = this._data.linewidth ? Math.max(1, Math.floor(this._data.linewidth * t)) : 0, _ = this._data.fillBackground ? this.getColor() : void 0, p = Math.max(1, Math.floor(t)), m = o ? -a : Math.round(c.min.x * t), g = r ? s.width + a : Math.round(c.max.x * t), f = Math.round(c.min.y * i), y = Math.round(c.max.y * i);
    ...
    _extendAndHitTestLineSegment(e, t, i, s) {
      ...
      if (null !== o) {
        if ((0, a.distanceToSegment)(o[0], o[1], e).distance <= 3) return new c.HitTestResult(c.HitTarget.MovePoint)
      }
      return null
    }
    ...
    _hitTestBackground(e, t, i, s) {
      const o = this._extendAndClipLineSegment(t, i, s);
      return null !== o && (0, r.pointInBox)(e, (0, n.box)(o[0], o[1])) ? new c.HitTestResult(this._data?.backgroundHitTarget ?? c.HitTarget.MovePointBackground) : null
    }
