/**
 * Module 24062 - Auto-beautified from TradingView webpack bundle
 *
 * @module 24062
 * @date 2026-04-23
 * @size 1908 bytes
 ...
 *
 * Dependencies: 4148, 9343
 *
 * Exports:
 *   - PriceRange (internal: n)
 *
 * Next Steps:
...
class n {
  ...
  scaleAroundCenter(e) {
    if (!(0, s.isNumber)(e)) return void o.logDebug("PriceRange.scaleAroundCenter: invalid coeff");
    if (0 === this._maxValue - this._minValue) return;
    const t = .5 * (this._maxValue + this._minValue);
    let i = this._maxValue - t,
      n = this._minValue - t;
    i *= e, n *= e, this._maxValue = t + i, this._minValue = t + n
  }
  shift(e) {
    (0, s.isNumber)(e) ? (this._maxValue += e, this._minValue += e) : o.logDebug("PriceRange.shift: invalid coeff")
  }
  containsStrictly(e) {
  ...
  intersection(e) {
    return this.containPrice(e.minValue()) || this.containPrice(e.maxValue()) || e.containPrice(this._minValue) ? new n(Math.max(this._minValue, e.minValue()), Math.min(this._maxValue, e.maxValue())) : null
  }
  static compare(e, t) {
