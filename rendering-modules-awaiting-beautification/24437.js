// Module 24437 - Rendering Engine Component
// Purpose: WebGL operations
// Original file: 24437.js
// Size: 9.9 KB
...
(e, t, i) => {
  ...
  class _ {
    ...
    processCommands(e) {
      void 0 !== e.erase && this._processEraseCommands(e.erase), void 0 !== e.create && this._processCreateCommands(e
        .create)
    }
    ...
    _processEraseCommands(e) {
      for (const t of e)
        if ("all" === t.action) {
          ...
          (0, d.isRegularPrimiriveName)(t.type) ? this._primitivesCollection[t.type].forEach(e): this
            ._primitivesCollection[t.type].forEach((t => {
              t.forEach(e)
            }))
        } this._hhistsByTimePointIndex = (0, d.splitHHistsByTimePointIndex)(this._primitivesCollection.hhists)
    }
  ...
  class p {
    constructor(e, t) {
      this._primitivesDataById = new Map, this._primitiveById = new Map, this._changed = new n.Delegate, this
        ._cleared = new n.Delegate, this._materializePrimitive = e,
    ...
    _tryMaterialize(e, t) {
      ...
      return null !== i && ((0, s.assert)(!this._primitiveById.has(t.id),
        "primitive with specified id should not exist"), this._primitiveById.set(t.id, i)), i
    }
  }
  ...
  function y(e, t, i = []) {
    for (const o of i) {
      const i = o.styleId,
        n = t.get(i);
      (0, s.assert)(void 0 !== n, "Every style used by graphics primitive should be declared in study metainfo"), n
        .addData(o.data, e)
    }
  }
  const v = {
