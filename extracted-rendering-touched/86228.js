// Module 86228 - Rendering Engine Component
// Purpose: Hit test renderer
// Original file: 86228.js
// Size: 3.2 KB
...
(e, t, i) => {
  ...
  class _ extends u.BitmapCoordinatesPaneRenderer {
    ...
    _drawImpl(e) {
      ...
      const {
        ...
        middleLine: l
          ...
          ._data.linewidth * t)) : 0, _ = this._data.fillBackground ? this.getColor() : void 0, p = Math.max(1, Math
          .floor(t)), m = o ? -a : Math.round(c.min.x * t), g = r ? s.width + a : Math.round(c.max.x * t), f = Math
        .round(c.min.y * i), y = Math.round(c.max.y * i);
    ...
    _extendAndHitTestLineSegment(e, t, i, s) {
      ...
      if (null !== o) {
        if ((0, a.distanceToSegment)(o[0], o[1], e)
          .distance <= 3) return new c.HitTestResult(c.HitTarget.MovePoint)
      }
      return null
    }
