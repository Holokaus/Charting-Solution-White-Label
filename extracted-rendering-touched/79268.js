// Module 79268 - Rendering Engine Component
// Purpose: Pixel manipulation
// Original file: 79268.js
// Size: 7.5 KB
...
(e, t, i) => {
  ...
  class m {
    constructor(e, t, i, o) {
      this._calculatedPrev = {
          ...
          currentBreakProcessed: !1,
          value: null
        }, e.length && ((0, s.assert)(t <= i, "First index must be less or equal to last index"), (0, s.assert)(t < e
          .length, "First index must be less then array length"), (0, s.assert)(i <= e.length,
          "Last index must be less or equal to array length")), this._items = e, this._firstIndexWithRange = t, this
    ...
    next() {
      ...
      do {
        null === this._preallocatedVariable.index ? (this._preallocatedVariable.index = this._firstIndexWithRange,
          this._preallocatedVariable.currentBreakProcessed = !1, e = this._preallocatedVariable.index < this
          ._lastIndexWithRange) : (this._incrementPointer(this._preallocatedVariable), e = this._isValidPointer(this
          ._preallocatedVariable)), e && this._calcVaue(this._preallocatedVariable)
    ...
    nextValue() {
      ...
      do {
        this._incrementPointer(this._calculatedNext), e = this._isValidPointer(this._calculatedNext), e ? this
    ...
    atEnd() {
      ...
      return e < this._lastIndexWithRange && (this._calculatedCurrent.currentBreakProcessed || !this._needBreakBefore(
        e))
    }
    _needBreakBefore(e) {
    ...
    _incrementPointer(e) {
      const t = (0, s.ensureNotNull)(e.index);
      this._needBreakBefore(t) && !this._calculatedCurrent.currentBreakProcessed ? e.currentBreakProcessed = !0 : (e
        .index = t + 1, e.currentBreakProcessed = !1)
    }
    _isValidPointer(e) {
      const t = (0, s.ensureNotNull)(e.index);
      return t < this._lastIndexWithRange || t === this._lastIndexWithRange - 1 && this._needBreakBefore(t) && e
        .currentBreakProcessed
    }
  }
  class g extends c.BitmapCoordinatesPaneRenderer {
    ...
    hitTest(e) {
      const t = (0, a.interactionTolerance)()
      ...
      for (let a = i; a <= s; ++a) {
        const i = this._data.items[a - 1],
          ...
          l = i.center,
          c = s.center;
        if ((0, n.distanceToSegment)(new o.Point(l, i.y), new o.Point(c, s.y), new o.Point(e.x, e.y))
          .distance <= t) return this._data.hittest ? this._data.hittest : new r.HitTestResult(r.HitTarget.Regular)
      }
      return null
    }
    _drawImpl(e) {
      ...
      t.scale(i, s), t.lineCap = "round", t.lineJoin = "round", (0, h.applyColor)(e, this._data.lineColor, 0, 3), t
        .lineWidth = this._data.lineWidth, (0, l.setLineStyle)(t, this._data.lineStyle), (0, a.setValidLineStyle)(t,
          this._data.lineStyle), this._data.simpleMode ? this._drawSimpleMode(e) : this._drawLines(t)
    }
    _drawSimpleMode(e) {
      const {
        context: t,
    ...
    _walkLine(e, t, i, s, o, n, r) {
      ...
      for (; y.next();) {
        if (l = y.currentValue(), c = y.nextValue(), p(l)) {
          ...
          h && p(h) ? (f.lineTo(e, l.y), i && !p(c) && f.lineTo(e, s)) : c && p(c) ? i ? (y.atStart() || f.lineTo(e,
            s), f.lineTo(e, l.y)) : f.moveTo(e, l.y) : i ? (y.atStart() || f.lineTo(e - a, s), f.lineTo(e - a, l
            .y), f.lineTo(e + a, l.y), f.lineTo(e + a, s)) : (f.moveTo(e - a, l.y), f.lineTo(e + a, l.y))
        }
        h = l
      }
      return {
    ...
    _drawLines(e, t) {
      ...
      for (; y.next();) {
        ...
        v = o, b = s, p(S = i) && (p(v) ? r.lineTo(S.center, S.y) : b && p(b) ? r.moveTo(S.center, S.y) : (r.moveTo(
          S.center - n, S.y), r.lineTo(S.center + n, S.y)))
      }
      var v, S, b;
      return r.stroke(), {
