      ...
      _drawImpl(e) {
        ...
        const {
          ...
          middleLine: l
            ...
            ._data.linewidth * t)) : 0, _ = this._data.fillBackground ? this.getColor() : void 0, lineToolManager_p = Math.max(1,
            Math.floor(t)), lineToolManager_m = o ? -a : Math.round(c.min.x * t), lineToolManager_g = r ? s.width + a : Math.round(c.max.x * t), lineToolManager_f =
          Math.round(c.min.y * i), y = Math.round(c.max.y * i);
        (0, d.fillRectWithBorder)(e, lineToolManager_m, lineToolManager_f, lineToolManager_g, y, lineToolManager_p, void 0 === _ ? void 0 : {
          color: _
        }, 0 === u ? void 0 : {
