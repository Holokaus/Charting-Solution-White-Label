...
4753: (e, t, i) => {
    ...
    var s = i(10555),
      ...
      u = i(33350),
      _ = i(12217),
      lineToolManager_p = i(57658);

    function lineToolManager_m(e, t, i, o, n) {
      const r = .5 * (t.x + i.x);
      let a = i.y;
      return t.y > i.y ? (a -= e.height / 2 + o.y, a = Math.max(e.height / 2, a)) : (a += e.height / 2 + o.y, a = Math
        .min(n - e.height / 2, a)), new s.Point(r, a)
    }

    function lineToolManager_g(e, t, i) {
      if (e.isOutOfScreen(t, i)) return null;
      const s = e.getPolygonPoints();
      return 0 === s.length ? null : s
    }

    function lineToolManager_f(e) {
    ...
    function v(e, t, i, s) {
      ...
      for (; e.length;) {
        const r = Math.max(1, (0, _.upperbound)(n, s, ((s, o) => (0, u.measureText)(e.slice(0, o + 1), t, i).width > s),
          0, e.length));
    ...
    function S(e, t, i, s = !0, o) {
      ...
      for (let e = 0; e < n.length; e++) {
        ...
        for (; d < l.length;) {
          ...
          const lineToolManager_p = v(n, t, i, o);
          for (let e = 0; e < lineToolManager_p.length; e += 1) {
            const t = lineToolManager_p[e];
            _ -= t.length;
            const i = {
              text: t,
              hidden: e > 0,
              wrappedLinePart: c,
              wrappedLineEnd: d === l.length - 1 && e === lineToolManager_p.length - 1
            };
            i.hidden && s || r.push(i)
          }
          h = "", d += 1
    ...
    function w(e) {
      return void 0 !== e.boxPaddingVert ? e.boxPaddingVert * A(e) : void 0 !== e.boxPadding ? e.boxPadding * A(e) : M(
        e) / 3
    }

    function C(e) {
      return void 0 !== e.boxPaddingHorz ? e.boxPaddingHorz * A(e) : void 0 !== e.boxPadding ? e.boxPadding * A(e) : M(
        e) / 3
    }
    ...
    class k {
      constructor(e, t) {
        this._data = null, this._textWidthCache = new lineToolManager_p.TextWidthCache, this._internalData = null, this._boxSize =
          ...
          ._centerTextRotationPoint = null, this._rotationPoint = null, this._hitTest = t || new l.HitTestResult(l
            .HitTarget.MovePoint, {
      ...
      setData(e) {
        null !== e ? ((0, o.assert)(!e.decorator || void 0 === e.wordWrapWidth,
          ...
          void 0 === e.text && (e.text = ""), e.horzTextAlign || (e.horzTextAlign = e.horzAlign), ! function(e, t) {
            ...
            var i, s;
            return e.text === t.text && e.decorator === t.decorator && e.vertAlign === t.vertAlign && e
              .horzAlign === t.horzAlign && e.horzTextAlign === t.horzTextAlign && e.font === t.font && e
              .offsetX === t.offsetX && e.offsetY === t.offsetY && e.bold === t.bold && e.italic === t.italic && e
              .fontsize === t.fontsize && e.fontSize === t.fontSize && e.backgroundRoundRect === t
              .backgroundRoundRect && e.forceTextAlign === t.forceTextAlign && e.wordWrapWidth === t
              .wordWrapWidth && e.forceCalculateMaxLineWidth === t.forceCalculateMaxLineWidth && e.lineHeight === t
              .lineHeight && e.lineSpacing === t.lineSpacing && e.scale === t.scale && e.boxPadding === t
              .boxPadding && e.boxPaddingVert === t.boxPaddingVert && e.boxPaddingLeft === t.boxPaddingLeft && e
              .boxPaddingRight === t.boxPaddingRight && e.boxPaddingHorz === t.boxPaddingHorz && e.angle === t
              .angle && e.maxHeight === t.maxHeight && e.outlineBorder?.width === t.outlineBorder?.width && e
              .outlineBorder?.color === t.outlineBorder?.color
          }(this._data, e) ? (this._data = e, this._internalData = null, this._boxSize = null, this._polygonPoints =
      ...
      hitTest(e) {
        return null === this._data || void 0 === this._data.points || 0 === this._data.points.length ? null : (0, n
          .pointInPolygon)(e, this.getPolygonPoints()) ? this._hitTest : null
      }
      ...
      draw(e, t) {
        ...
        }(a, t), lineToolManager_f = this._data.borderWidth || Math.max(d / 12, 1), y = Math.round(lineToolManager_f * n), v = y / 2;
        if (this._data.backgroundColor || this._data.borderColor) {
          ...
          if (this._data.backgroundRoundRect) {
            ...
            s && ((0, c.drawRoundRect)(e, _, lineToolManager_m, lineToolManager_p - _, lineToolManager_g - lineToolManager_m, o * n), e.closePath(), e.fillStyle = s, e.fill(), t && (
              e.restore(), t = !1)), i && ((0, c.drawRoundRect)(e, _ - v, lineToolManager_m - v, lineToolManager_p - _ + y, lineToolManager_g - lineToolManager_m + y, o * n + y), e
              .closePath(), e.strokeStyle = i, e.lineWidth = y, e.stroke(), t && e.restore())
          } else {
            const {
              borderColor: i,
              backgroundColor: s
            } = this._data;
            s && (e.fillStyle = s, e.fillRect(_, lineToolManager_m, lineToolManager_p - _, lineToolManager_g - lineToolManager_m), t && (e.restore(), t = !1)), i && (e.strokeStyle =
              i, e.lineWidth = y, e.beginPath(), e.moveTo(_ - v, lineToolManager_m - v), e.lineTo(_ - v, lineToolManager_g + v), e.lineTo(lineToolManager_p + v, lineToolManager_g +
                v), e.lineTo(lineToolManager_p + v, lineToolManager_m - v), e.lineTo(_ - v, lineToolManager_m - v), e.closePath(), e.stroke(), t && e.restore())
          }
        }
        this._drawSelectionIfNeeded(e, t), e.fillStyle = this._data.color;
        const S = (_ + Math.round(a.textHorizStart * n)) / n,
          b = .05 * d;
        let w = (lineToolManager_m + Math.round((a.textVertStart + b) * r)) / r;
        ...
        if (this._data.decorator?.draw(e, t, this._data, a), this._data.outlineBorder) {
          const {
            ...
            x: _ - o,
            y: lineToolManager_m - o,
            w: lineToolManager_p - _ + 2 * o,
            h: lineToolManager_g - lineToolManager_m + 2 * o
          }, a = new Path2D;
          a.rect(r.x - s, r.y - s, r.w + 2 * s, r.h + 2 * s), a.rect(r.x, r.y, r.w, r.h), e.fillStyle = i, e.fill(a,
            "evenodd")
        }
        e.restore()
      }
      ...
      _getInternalData() {
        ...
        const e = (0, o.ensureNotNull)(this._data),
          ...
          lineToolManager_m = 0 === e.text.length ? 0 : _?.decoratorAndTextMargin ?? 0,
        ...
        let S;
        const b = (0, r.isRtl)(),
          C = b && !lineToolManager_g,
          x = C ? t + s - d - lineToolManager_p : t + h;
        switch ((0, o.ensureDefined)(e.horzTextAlign)) {
          case a.HorizontalAlign.Left:
            S = "start", y = x + lineToolManager_f, b && (e.forceTextAlign ? S = "left" : (y = C ? x - lineToolManager_m : t + s - d, S = "right"));
            break;
          case a.HorizontalAlign.Center:
            S = "center";
            const i = s - h - d - lineToolManager_f;
            y = C ? x - lineToolManager_m - i / 2 : x + lineToolManager_f + i / 2;
            break;
          case a.HorizontalAlign.Right:
            S = "end", y = C ? x - lineToolManager_m : t + s - d, b && e.forceTextAlign && (S = "right")
        }
        return this._internalData = {
          ...
          textBoxWidth: l,
          textBoxHeight: c,
          textLeft: t + h + (C ? 0 : lineToolManager_f),
          textRight: t + s - d - (C ? lineToolManager_f : 0),
          textTop: i + u,
          textBottom: i + n - u,
          textHorizStart: y - t,
          textVertStart: v - i,
          ...
          const e = this.getLinesInfo(),
            ...
            i = function(e, t) {
              const i = e.decorator?.geometry(e),
                s = Math.round(t + T(e) + P(e) + (i?.width ?? 0) + (0 === e.text.length ? 0 : i
