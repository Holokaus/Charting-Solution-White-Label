...
43501: (e, t, i) => {
    ...
    class lineToolManager_p extends d.MediaCoordinatesPaneRenderer {
      constructor() {
      ...
      hitTest(e) {
        ...
        const {
          ...
          topLineWidth: i,
          bottomLineWidth: s
        } = this._data, o = (0, c.interactionTolerance)().series + (i + s) / 4, n = (0, h.lowerbound)(t, e, ((e,
          t) => e.center <= t.x)), a = Math.max(1, n - 1), d = Math.min(t.length - 1, n + 1);
        for (let i = a; i <= d; ++i) {
          const s = t[i - 1],
            n = t[i],
            {
              distance: a
            } = (0, l.distanceToSegment)((0, r.point)(s.center, s.y), (0, r.point)(n.center, n.y), (0, r.point)(e.x,
              e.y));
      ...
      _drawImpl(e) {
            ...
            for (let n = 0; n < e.length; n++) {
              ...
              if ((0, c.coordinateIsValid)(h.y) && (l.y > t && h.y < t || l.y < t && h.y > t))
                if (Math.abs(l.center - h.center) < 1) {
                  ...
                  const e = (0, a.intersectLineSegments)((0, r.point)(l.center, l.y), (0, r.point)(h.center, h.y), (
        ...
        y.lineCap = "round", y.lineJoin = "round", 0 !== v.length && (y.beginPath(), y.moveTo(v[0].center, i), this
          ._makeLine(y, v, !0, 0), y.closePath(), y.fillStyle = this._makeLinearGradient(y, l, h, i - s, i), y
          .fill(), y.beginPath(), this._makeLine(y, v, !1, 0), y.lineWidth = lineToolManager_p, y.strokeStyle = d, (0, _
            .setLineStyle)(y, lineToolManager_g), y.stroke()), 0 !== S.length && (y.beginPath(), y.moveTo(S[0].center, i), this
          ._makeLine(y, S, !0, 1), y.closePath(), y.fillStyle = this._makeLinearGradient(y, o, n, i, i + s), y
          .fill(), y.beginPath(), this._makeLine(y, S, !1, 1), y.lineWidth = lineToolManager_m, y.strokeStyle = u, (0, _
            .setLineStyle)(y, lineToolManager_f), y.stroke())
      }
      _makeLine(e, t, i, s) {
        if (null === this._data) return;
        ...
        for (let n = o; n < h; n++) {
          ...
          if ((0, c.coordinateIsValid)(h.y)) {
            ...
            if (l && (0, c.coordinateIsValid)(l.y)) e.lineTo(h.center, h.y), i && !(0, c.coordinateIsValid)(d.y) &&
              e.lineTo(h.center, r);
            else if (d && (0, c.coordinateIsValid)(d.y)) i ? (n !== o && e.lineTo(h.center, r), e.lineTo(h.center, h
              .y)) : e.moveTo(h.center, h.y);
            else if (i) {
              if (0 === n) continue;
              n !== o && e.lineTo(h.center - a, r), e.lineTo(h.center - a, h.y), e.lineTo(h.center + a, h.y), e
                .lineTo(h.center + a, r)
    ...
    var lineToolManager_m = i(45801),
      lineToolManager_g = i(73773);
    class lineToolManager_f extends lineToolManager_g.SeriesSingleLinePaneView {
      ...
      renderer() {
        ...
        return e.append(this._renderer), this._model.selection().isSelected(this._source) && this
          ._isMarkersEnabled && this._selectionData && e.append(new lineToolManager_m.SelectionRenderer(this._selectionData)), e
      }
      _updateImpl() {
        super._updateImpl();
        ...
        this._topFillColor1 = (0, o.generateColor)(t.topFillColor1.value(), i), this._topFillColor2 = (0, o
          ...
          ._barSpacing = this._model.timeScale().barSpacing(), this._bottom = e.height(), this
