...
36281: (e, t, i) => {
    ...
    class d {
      ...
      draw(e, t, i, s, n) {
        ...
        const priceDataSource_p = this._commonData,
          priceDataSource_m = void 0 !== r.labelIcon,
          priceDataSource_g = i.paddingTop + priceDataSource_p.additionalPaddingTop,
          priceDataSource_f = i.paddingBottom + priceDataSource_p.additionalPaddingBottom,
          {
            paddingOuter: y,
            paddingInner: v,
            fontSize: S,
        ...
        let C = r.text,
          T = r.textColor || priceDataSource_p.textColor,
          P = r.secondLine || "",
          x = priceDataSource_p.secondLineTextColor || T,
          M = r.thirdLine || "";
        const I = priceDataSource_p.thirdLineTextColor || T;
        0 === P.length && (P = M, x = I, M = ""), 0 === C.length && (C = P, T = x, P = M, x = I, M = ""), e.save(),
          void 0 !== priceDataSource_p.globalAlpha && (e.globalAlpha *= priceDataSource_p.globalAlpha), e.font = i.font;
        const A = s.yMidCorrection(e, C) * _,
          L = S + priceDataSource_g + priceDataSource_f,
          k = (r.labelIconMinWidth ?? 0) * priceDataSource_u,
          E = Boolean(P),
          D = Boolean(M),
          B = v + y + w,
        ...
        const O = Math.round((S + i.lineSpacing) * _),
          ...
          W = Math.max(1, Math.floor(b * priceDataSource_u)),
          H = r.separatorVisible ? W : 0,
          z = r.borderVisible ? W : 0,
          U = priceDataSource_m ? Math.max(N, k) : Math.round((Math.max(...V) + B) * priceDataSource_u),
          j = Math.round(w * priceDataSource_u),
          G = d.width,
          q = Math.ceil(v * priceDataSource_u),
          $ = Math.round((priceDataSource_p.fixedCoordinate ?? priceDataSource_p.coordinate) * _) - Math.floor(.5 * _),
          K = Math.floor($ + R / 2 - N / 2),
          Y = K + N,
          Z = "right" === n,
          X = void 0 !== r.xCoord ? Math.round(r.xCoord * priceDataSource_u) + (Z ? 1 : -1) * Math.round(U / 2) : Z ? G - H : H;
        let J, Q = X;
        const ee = r.backgroung ?? priceDataSource_p.background;
        e.fillStyle = ee;
        const te = 2 * _;
        if (e.textAlign = Z ? "right" : "left", e.textBaseline = "middle", Z ? (Q = X - U, J = X - j - q + H) : (Q =
            X + U, J = X + j + q - H), this._bodyBox = null, C || priceDataSource_m) {
          const t = D ? N + F : E ? N + O : N,
            i = priceDataSource_p.borderColor ?? ee,
          ...
          if (((i, n, a) => {
              if (Z) {
                ...
                const l = (0, o.point)(Q / priceDataSource_u, K / _),
                  c = l.add((0, o.point)(U / priceDataSource_u, t / _));
                ...
                const l = (0, o.point)(X / priceDataSource_u, K / _),
                  c = l.add((0, o.point)(U / priceDataSource_u, t / _));
                this._bodyBox = (0, o.box)(l, c)
              }
            })(ee, i, priceDataSource_p.borderStyle), priceDataSource_m) {
            if (0 === r.labelIcon) this._drawPlusIcon(e, X, Q, K, $, Y, R);
            return void e.restore()
          }
          e.save(), e.translate(J, (K + Y) / 2 + A), (0, l.drawScaled)(e, priceDataSource_u, _, (() => {
            e.fillStyle = T, e.fillText(C, 0, 0)
          })), e.restore()
        }
        E && (e.fillStyle = x, e.save(), e.translate(J, (K + Y) / 2 + A + O), (0, l.drawScaled)(e, priceDataSource_u, _, (() => {
          e.fillText((0, a.startWithLTR)(P), 0, 0)
        })), e.restore()), D && (e.fillStyle = I, e.save(), e.translate(J, (K + Y) / 2 + A + F), (0, l.drawScaled)(
          e, priceDataSource_u, _, (() => {
      ...
      _drawPlusIcon(e, t, i, s, o, n, r) {
        ...
        const h = Math.floor((a - l) / 2),
          d = Math.min(t, i),
          priceDataSource_u = d + Math.floor(a / 2 - r / 2);
        e.fillRect(d + h, o, l, r), e.fillRect(priceDataSource_u, s + h, r, l), e.beginPath(), e.arc(priceDataSource_u + r / 2, o + r / 2, c / 2, 0,
    ...
    class _ {
      ...
      generateTextColor(e) {
        return (0, priceDataSource_u.colorFromBackground)(e)
      }
      coordinate() {
