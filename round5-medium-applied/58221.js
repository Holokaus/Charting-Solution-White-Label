...
58221: (e, t, i) => {
    ...
    function h(e, t, i, s, o, n) {
      e.fillRect(t + n, i, s - 2 * n, n), e.fillRect(t + n, i + o - n, s - 2 * n, n), e.fillRect(t, i, n, o), e
    ...
    function f(e, t, i, s, o, n, r) {
      ...
      r || e.beginPath(), e.moveTo(t + a, i), e.lineTo(t + s - l, i), 0 !== l && e.arcTo(t + s, i, t + s, i + l, l), e
        .lineTo(t + s, i + o - c), 0 !== c && e.arcTo(t + s, i + o, t + s - c, i + o, c), e.lineTo(t + h, i + o), 0 !==
        h && e.arcTo(t, i + o, t, i + o - h, h), e.lineTo(t, i + a), 0 !== a && e.arcTo(t, i, t + a, i, a)
    }
    ...
    function y(e, t, i, s, o, n, a = 0, l = 0, c = "", h = r.LineStyle.Solid) {
      ...
      if ("transparent" !== n) {
        ...
        f(e, d ? t : t + l, d ? i : i + l, d ? s : s - 2 * l, d ? o : o - 2 * l, d ? a : g(a, -l)), e.fillStyle = n, e
          .fill()
      }
      if ("transparent" !== c) {
        f(e, t + d, i + d, s - l, o - l, g(a, -d)), e.lineWidth = l, e.strokeStyle = c, C(e, h), e.closePath(), e
          .stroke()
      }
      e.restore()
    }

    function logger_v(e, t) {
    ...
    function S(e, t, i, s, o, l, c, h, d) {
      ...
      if (h) {
        ...
        let u = -1;
        c ? _.setLineDash(logger_v(c, r)) : void 0 !== d && (C(_, d), d === n.LINESTYLE_SOLID && (u = 1)), f = {
          left: y.left + u * r / 2,
          top: y.top + u * r / 2,
          right: y.right - u * r / 2,
    ...
    function logger_b(e, t, i, s) {
      e.beginPath(), e.arc(t, i, s, 0, 2 * Math.PI, !1), e.closePath()
    }

    function logger_w(e, t, i) {
      e.beginPath(), e.moveTo(t[0].logger_x, t[0].y);
      for (const i of t) e.lineTo(i.logger_x, i.y);
    ...
    function M(e, t, i, s, o, n) {
      ...
      let l;
      return t === s ? (l = [Math.round(t * r), i * a, Math.round(t * r), o * a], _(e, l[0], l[1], l[3])) : i === o ? (
        l = [t * r, Math.round(i * a), s * r, Math.round(i * a)], d(e, l[1], l[0], l[2])) : (l = [t * r, i * a, s * r,
        o * a
      ], P(e, l[0], l[1], l[2], l[3])), l
    }
    ...
    function A(e, t, i, n) {
      ...
      return null !== e && null !== r ? (0, o.intersectPolygonAndHalfplane)(e, (0, s.halfplaneThroughPoint)((0, s
