// Module 12362 - Rendering Engine Component
// Purpose: ChartWidget drawing
// Original file: 12362.js
// Size: 4.7 KB
  ...
  class d {
    ...
    saveChartSilently(e, t, i) {
      ...
      this._isSaveInProcess = !0, this._chartAboutToBeSavedDelegate.fire(), this._saveChart((e => {
        ...
        (0, o.assert)(!this._chartWidgetCollection.readOnly(), "Trying to save layout in read-only mode"), i &&
          this.layoutId() === t.uid && this._chartWidgetCollection.metaInfo.name.setValue(i.name ?? ""), this
          ._prevChartState = i, this._chartSavedDelegate.fire(!0), this._isSaveInProcess = !1, e && e({
            uid: t.uid,
            data: i
    ...
    _getCommonSavingInfo(e) {
      const t = this._chartWidgetCollection,
        i = this._chartWidgetCollection.chartsSymbols()[t.activeChartWidget.value()
          .id()],
        s = {
          ...(o = i, {
            ...o,
    ...
    async _saveLineToolsToStorage() {
      if (l.enabled("saveload_separate_drawings_storage")) {
        this.layoutId();
        0;
        const [e, t] = this._chartWidgetCollection.getAll()
          .reduce(((e, t) => {
    ...
    _invalidateAllLineTools() {
      this._chartWidgetCollection.getAll()
        .forEach((e => e.lineToolsSynchronizer()
          ?.invalidateAll()))
    }
    _saveChartImpl(e, t, i, s, o, n) {
      ...
      r = s => {
        ...
        }, e.name ? c.backend.saveChart(e.name, e.short_name, e.resolution, e, t)
        .then(r)
        .catch((async e => {
    ...
    async _saveChart(e, t, o, r) {
      ...
      if (1 & h) {
        ...
        if ((0, s.default)(this._prevChartState, i) && null !== c.id) return this._chartSavedDelegate.fire(!0),
          void t(c, i);
        0;
        const n = (e, i) => (d || this._chartWidgetCollection.getAll()
          .forEach((e => e.lineToolsSynchronizer()
