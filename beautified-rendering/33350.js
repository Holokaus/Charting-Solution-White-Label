// Module 33350 - Rendering Engine Component
// Purpose: Canvas bitmap/pixel operations
// Original file: 33350.js
// Size: 3.1 KB
...
(e, t, i) => {
  ...
  function b(e, t) {
    return "center" === e.textAlign ? 0 : (0,
        a.isRtl)() ? "start" === e.textAlign || "right" === e.textAlign ? t : 0 : "start" === e.textAlign || "left" ===
      e.textAlign ? 0 : t
  }

  function w(e) {
    e.style.userSelect = "none", e.style.webkitUserSelect = "none", e.style.msUserSelect = "none", e.style
      .MozUserSelect = "none", e.style.webkitTapHighlightColor = "transparent"
  }
  ...
  function M(e, t, i) {
    return x || function() {
      ...
      e.width = 0, e.height = 0, (0, l.isMac)() && (e.style.display = "none", document.body.append(e)), x = (0, o
        .ensureNotNull)(e.getContext("2d")), x.textBaseline = "alphabetic", x.textAlign = "center"
