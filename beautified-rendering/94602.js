// Module 94602 - Rendering Engine Component
// Purpose: Render utilities
// Original file: 94602.js
// Size: 0.9 KB
...
(e, t, i) => {
  ...
  class s {
    ...
    draw(e, t) {
      for (let i = 0; i < this._renderers.length; i++) e.save(), e.globalAlpha = this._globalAlpha, this._renderers[i]
        .draw(e, t), e.restore()
    }
    drawBackground(e, t) {
