// Module 36281 - Rendering Engine Component
// Purpose: Renderer core - render/draw/hitTest
...
(e, t, i) => {
  ...
  class d {
    ...
    draw(e, t, i, s, n) {
      ...
      e.fillStyle = ee;
      const te = 2 * _;
      if (e.textAlign = Z ? "right" : "left", e.textBaseline = "middle", Z ? (Q = X - U, J = X - j - q + H) : (Q = X +
          U, J = X + j + q - H), this._bodyBox = null, C || m) {
      ...
      })), e.restore()), D && (e.fillStyle = I, e.save(), e.translate(J, (K + Y) / 2 + A + F), (0, l.drawScaled)(e,
        u, _, (() => {
    ...
    hitTest(e) {
      return function(e, t) {
        const i = (0, r.lastMouseOrTouchEventInfo)()
          .isTouch ? 20 : 0,
          s = e.hitTestData;
    ...
    _drawPlusIcon(e, t, i, s, o, n, r) {
      ...
      e.fillRect(d + h, o, l, r), e.fillRect(u, s + h, r, l), e.beginPath(), e.arc(u + r / 2, o + r / 2, c / 2, 0, 2 *
        Math.PI, !1), e.stroke()
    }
  ...
  class _ {
    ...
    floatCoordinate() {
      return this._updateRendererDataIfNeeded(), this._commonRendererData.floatCoordinate ?? this._commonRendererData
        .coordinate
    }
    update(e) {
      this._invalidated = !0
