    ...
    JSServer.studyLibrary = [{
      ...
      constructor: function() {
        this.init = function(e, t) {
          ...
          const s = this._context.new_var(o.ohlc4(this._context)).adopt(this._context.new_var(this._context
            .symbol.time), i, 1);
      ...
      constructor: function() {
        this.f_0 = function(e) {
          ...
          this.main = function(e, t) {
            return this._context = e, this._input = t, this._context.setMinimumAdditionalDepth(this._input(0) +
      ...
      constructor: function() {
        this.f_0 = function(e, t, i, s) {
          ...
          return this._context = e, this._input = t, [this.f_0(o.close(this._context), o.open(this._context), o
      ...
      constructor: function() {
        this.f_0 = function(e, t, i, s) {
          ...
          this._context = e, this._input = t;
          var i = this._input(0),
            s = this.f_0(o.close(this._context), o.high(this._context), o.low(this._context), o.volume(this
              ._context)),
            n = this._context.new_var(s),
            r = o.sum(n, i, this._context),
      ...
      constructor: function() {
        this.init = function(e, t) {
          ...
          this._context = e, this._input = t, this._context.setMinimumAdditionalDepth(this.period + this
            .rocLookback);
      ...
      constructor: function() {
        ...
        this.f_1 = function(e, t, i) {
          ...
          var i = t.get(0),
            s = t.get(1);
          return e = i === s ? 0 : i > s ? o.nz(e) <= 0 ? 1 : o.nz(e) + 1 : o.nz(e) >= 0 ? -1 : o.nz(e) - 1,
      ...
      constructor: function() {
        this.f_0 = function(e, t) {
          ...
          return "Exponential" === this._input(3) ? s = o.ema(i, this._input(0), this._context) : "Weighted" ===
            this._input(3) && (s = o.wma(i, this._input(0), this._context)), [this.f_0(s, this._input(1) / 100),
              s, this.f_1(s, this._input(2) / 100)
            ]
        }
      }
    }, {
      ...
      constructor: function() {
        this.init = function(e, t) {
          ...
          this._context = e, this._input = t;
          for (var i, s, n = this._context.new_var(o.close(this._context)), r = 0, a = 0, l = 0; l < this
            .period; l++) r += l + 1, a += n.get(l);
          i = r / this.period, s = a / this.period;
          var c = 0,
            h = 0,
            d = 0;
          for (l = 0; l < this.period; l++) d += Math.pow(s - n.get(l), 2), h += (i - l - 1) * (s - n.get(l)),
            c += Math.pow(i - l - 1, 2);
      ...
      constructor: function() {
        this.init = function(e, t) {
          this._context = e, this._input = t, this.period = this._input(0), this.errorDeviation = this._input(
      ...
      constructor: function() {
        this.f_0 = function(e, t) {
          ...
          "EMA" === l ? u = o.ema(p, n, this._context) : "WMA" === l ? u = o.wma(p, n, this._context) :
            "SMA" === l && (u = o.sma(p, n, this._context)), "EMA" === l ? _ = o.ema(p, r, this._context) :
      ...
      constructor: function() {
        this.init = function(e, t) {
          ...
          return i = s > this._context.new_var(s).get(1) ? 1 : 0, [100 * o.sma(this._context.new_var(i), this
      ...
      constructor: function() {
        this.f_0 = function(e, t, i) {
          ...
          return "EMA" === i ? h = o.ema(d, s, this._context) : "WMA" === i ? h = o.wma(d, s, this._context) :
            "SMA" === i && (h = o.sma(d, s, this._context)), [c, h]
        }
      }
    }, {
      name: "Parabolic SAR",
      ...
      constructor: function() {
        this.init = function(e, t) {
          this._context = e, this._input = t, this.period = this._input(0), this.invertedPeriod = 1 / this
          ...
          for (var e = this._context.new_var(o.close(this._context)), t = o.sum(e, this.period, this._context),
              i = 0, s = 0, n = 0; n < this.period; n++) {
            var r = e.get(n);
      ...
      constructor: function() {
        this.init = function(e, t) {
          ...
          for (var e = this._context.new_var(o.close(this._context)), t = this._context.new_var(e.symbol.time),
              i = Math.sqrt((t.get(0) - t.get(1)) / 864e5 / this.daysPerYear), s = Math.log(o.close(this
                ._context) / e.get(1)), n = this._context.new_var(s / i), r = this._context.new_var(Math.pow(n,
      ...
      constructor: function() {
        this.init = function(e, t) {
          this._context = e, this._input = t, this.period = this._input(0), this.marketClosedPercentage = this
          ...
          l -= (Math.log(4) - 1) * this.square(s.get() - e.get()), this.marketClosedPercentage > 0 && (l = .12 *
            this.square(e.get() - s.get(1)) / this.marketClosedPercentage + .88 * l / (1 - this
      ...
      constructor: function() {
        this.init = function(e, t) {
          ...
          return this.tr = Math.max(e, t, i), "Exponential" === this.maMethod ? this.atr = o.ema(this._context
          ...
          if (this.bars.push(o.close(this._context)), 1 === this.count) this.atr = o.high(this._context) - o
            ...
            var e = o.high(this._context) - o.low(this._context),
              t = o.high(this._context) - this.bars[this.bars.length - 2],
              i = this.bars[this.bars.length - 2] - o.low(this._context);
            this.atr += Math.max(e, t, i), o.close(this._context) > this.sic && (this.sic = o.close(this
              ._context))
          } else if (this.count === this.period) {
            e = o.high(this._context) - o.low(this._context), t = o.high(this._context) - this.bars[this.bars
              .length - 2], i = this.bars[this.bars.length - 2] - o.low(this._context);
            this.atr += Math.max(e, t, i), this.atr *= 1 / this.period, o.close(this._context) > this.sic && (
      ...
      constructor: function() {
        this.f_1 = function(e) {
          ...
          switch (t) {
            ...
            case "Quarter":
              return function(t, i) {
                return Math.floor(o.month(e, t) / 3) !== Math.floor(o.month(e, i) / 3) || o.year(e, t) !== o
                  .year(e, i)
              };
            case "Year":
              return function(t, i) {
          ...
          return s.set(o.nz(s.get(1)) + o[i](this._context) * o.volume(this._context)), n.set(o.nz(n.get(1)) + o
            .volume(this._context)), o.na(r.get(0)) ? (e.symbol.isLastBar && o.error(
            "To calculate the VWAP indicator, more data is needed. Zoom out or scroll left to load more historical data.",
            "VWAP is waiting for more data"), [NaN]) : [s.get(0) / n.get(0)]
        }
      }
    }, {
      name: "VWMA",
      ...
      constructor: function() {
        this.f_0 = function() {
          for (var e = this._input(0), t = this._context.new_var(o.high(this._context)), i = !0, s = !0, n = !0,
              r = !0, a = !0, l = !0, c = 1; c <= e; c++) i = o.and(i, o.lt(t.get(e - c), t.get(e))), s = o.and(
              s, o.lt(t.get(e + c), t.get(e))), n = o.and(n, o.and(o.le(t.get(e + 1), t.get(e)), o.lt(t.get(e +
              c + 1), t.get(e)))),
            r = o.and(r, o.and(o.le(t.get(e + 1), t.get(e)), o.and(o.le(t.get(e + 2), t.get(e)), o.lt(t.get(e +
              c + 2), t.get(e))))), a = o.and(a, o.and(o.le(t.get(e + 1), t.get(e)), o.and(o.le(t.get(e + 2), t
              .get(e)), o.and(o.le(t.get(e + 3), t.get(e)), o.lt(t.get(e + c + 3), t.get(e)))))), l = o.and(l, o
              .and(o.le(t.get(e + 1), t.get(e)), o.and(o.le(t.get(e + 2), t.get(e)), o.and(o.le(t.get(e + 3), t
                .get(e)), o.and(o.le(t.get(e + 4), t.get(e)), o.lt(t.get(e + c + 4), t.get(e)))))));
          var h = o.or(s, o.or(n, o.or(r, o.or(a, l)))),
            ...
            f = 1,
            y = 1;
          for (c = 1; c <= e; c++) _ = o.and(_, o.gt(u.get(e - c), u.get(e))), p = o.and(p, o.gt(u.get(e + c), u
              .get(e))), m = o.and(m, o.and(o.ge(u.get(e + 1), u.get(e)), o.gt(u.get(e + c + 1), u.get(e)))),
            g = o.and(g, o.and(o.ge(u.get(e + 1), u.get(e)), o.and(o.ge(u.get(e + 2), u.get(e)), o.gt(u.get(e +
              c + 2), u.get(e))))), f = o.and(f, o.and(o.ge(u.get(e + 1), u.get(e)), o.and(o.ge(u.get(e + 2), u
              .get(e)), o.and(o.ge(u.get(e + 3), u.get(e)), o.gt(u.get(e + c + 3), u.get(e)))))), y = o.and(y, o
              .and(o.ge(u.get(e + 1), u.get(e)), o.and(o.ge(u.get(e + 2), u.get(e)), o.and(o.ge(u.get(e + 3), u
                .get(e)), o.and(o.ge(u.get(e + 4), u.get(e)), o.gt(u.get(e + c + 4), u.get(e)))))));
      ...
      constructor: function() {
        this.init = function(e, t) {
          this._context = e, this._input = t, this._symbolSupports1DResolution = !this._context.symbol.info
          ...
          this._symbolSupports1DResolution || o.error(
              `Daily bars are not available for ${this._context.symbol.info.name}`), this._context = e, this
