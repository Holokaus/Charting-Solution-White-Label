...
19979: (e, t, i) => {
    ...
    h.max_series_default_size = 10001, h.n = e => e.symbol.index + 1, h.nz = (e, t = 0) => isFinite(e) ? e : t, h.na =
      ...
      .isZero(e - t), h.neq = (e, t) => c(!h.eq(e, t)), h.ge = (e, t) => c(h.isZero(e - t) || e > t), h.gt = (e, t) =>
      c(!h.isZero(e - t) && e > t), h.lt = (e, t) => c(!h.isZero(e - t) && e < t), h.le = (e, t) => c(h.isZero(e - t) ||
        e < t), h.and = (e, t) => isNaN(e) || isNaN(t) ? NaN : h.isZero(e) || h.isZero(t) ? 0 : 1, h.or = (e, t) =>
      isNaN(e) || isNaN(t) ? NaN : h.isZero(e) && h.isZero(t) ? 0 : 1, h.not = e => isNaN(e) ? NaN : h.isZero(e) ? 1 :
      0, h.eps = () => l, h.greaterOrEqual = (e, t, i) => t - e < (i || l), h.lessOrEqual = (e, t, i) => e - t < (i ||
        l), h.equal = (e, t, i) => Math.abs(e - t) < (i || l), h.greater = (e, t, i) => e - t > (i || l), h.less = (e,
        t, i) => t - e > (i || l), h.compare = (e, t, i) => h.equal(e, t, i) ? 0 : h.greater(e, t, i) ? 1 : -1, h.max =
      Math.max, h.min = Math.min, h.pow = Math.pow, h.abs = Math.abs, h.log = Math.log, h.log10 = e => Math.log(e) /
      Math.LN10, h.sqrt = Math.sqrt, h.sign = e => isNaN(e) ? NaN : h.isZero(e) ? 0 : e > 0 ? 1 : -1, h.exp = Math.exp,
      ...
      .close, h.hl2 = e => (e.symbol.high + e.symbol.low) / 2, h.hlc3 = e => (e.symbol.high + e.symbol.low + e.symbol
        .close) / 3, h.ohlc4 = e => (e.symbol.open + e.symbol.high + e.symbol.low + e.symbol.close) / 4, h.volume = e =>
      e.symbol.volume, h.updatetime = e => e.symbol.updatetime, h.time = e => e.symbol.bartime(), h.period = e => e
      .symbol.period, h.tickerid = e => e.symbol.tickerid, h.currencyCode = e => e.symbol.currencyCode, h.unitId = e =>
      e.symbol.unitId, h.ticker = e => e.symbol.ticker, h.interval = e => e.symbol.interval, h.isdwm = e => e.symbol
      .isdwm(), h.isintraday = e => !e.symbol.isdwm(),
      ...
      "M" === e.symbol.resolution, h.year = (e, t) => h.timepart(e.symbol, s.YEAR, t), h.month = (e, t) => h.timepart(e
        .symbol, s.MONTH, t), h.weekofyear = (e, t) => h.timepart(e.symbol, s.WEEK_OF_YEAR, t), h.dayofmonth = (e, t) =>
      h.timepart(e.symbol, s.DAY_OF_MONTH, t), h.dayofweek = (e, t) => h.timepart(e.symbol, s.DAY_OF_WEEK, t), h.hour =
      (e, t) => h.timepart(e.symbol, s.HOUR_OF_DAY, t), h.minute = (e, t) => h.timepart(e.symbol, s.MINUTE, t), h
      .second = (e, t) => h.timepart(e.symbol, s.SECOND, t), h.add_days_considering_dst = (e, t, i) => (0, s
      ...
      }, h.lowestbars = (e, t, i) => -d(e, t, 0, ((e, t) => h.lt(e, t)), Number.MAX_SAFE_INTEGER).index, h.lowest = (e,
        t, i) => d(e, t, 0, ((e, t) => h.lt(e, t)), Number.MAX_SAFE_INTEGER).value, h.highestbars = (e, t, i) => -d(e,
        t, 0, ((e, t) => h.gt(e, t)), Number.MIN_SAFE_INTEGER).index, h.highest = (e, t, i) => d(e, t, 0, ((e, t) => h
        .gt(e, t)), Number.MIN_SAFE_INTEGER).value, h.cum = (e, t) => {
        const i = t.new_var(),
          s = h.nz(i.get(1)) + e;
        return i.set(s), s
      }, h.accdist = e => {
        ...
        .get()), n.set(e)) : h.less(P, d.get()) && (y = !0, o.set(1), P = Math.min(u.get(), r.get()), r.set(d.get()),
          n.set(e)), y || (1 === o.get() ? h.greater(d.get(), r.get()) && (r.set(d.get()), n.set(Math.min(n.get() + t,
    ...
    class p {
      constructor(e, t, i, s, o) {
        this._areaRight = e, this._areaLeft = t, this._pivotType = i, this._series = s, this._currentIndex = o
    ...
    class m {
      constructor(e, t, i) {
        ...
        this._index > 1 && this.addPivot(n, r, a), this.processPivot(this._pivotHigh), this.processPivot(this
          ._pivotLow)
      }
      addPivot(e, t, i) {
