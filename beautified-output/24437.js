...
24437: (e, t, i) => {
    ...
    class _ {
      ...
      processCommands(e) {
        void 0 !== e.erase && this._processEraseCommands(e.erase), void 0 !== e.create && this._processCreateCommands(
          e.create)
      }
      ...
      _processEraseCommands(e) {
        for (const t of e)
          if ("all" === t.action) {
            for (const e of d.regularPrimitiveNames) this._primitivesCollection[e].forEach((e => e
          .clearPrimitives()));
            for (const e of d.groupedPrimitiveNames) this._primitivesCollection[e].forEach((e => {
