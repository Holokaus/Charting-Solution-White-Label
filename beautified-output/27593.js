...
27593: (e, t, i) => {
    ...
    class u {
      ...
      getXYCoordinate(e, t, i) {
        ...
        for (let s = h.length - 1; s >= 0; --s) {
          ...
          if ((a.adapter().alignedTimePointIndex() ?? t.timePointToIndex(a.adapter().getTime(), 1)) !== i || a
    ...
    class p extends o.LineDataSource {
      constructor(e, t, s, o) {
        super(e, t ?? p.createProperties(e.backgroundTheme().spawnOwnership()), s, o), this._adapter = new _(this,
