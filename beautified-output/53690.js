...
53690: (e, t, i) => {
    ...
    class h extends l.VolumeByPriceExpr {
      constructor(e, t, i, s, o, n, r, a, l, h, d) {
        super(e, t, i, n, new c.GraphicsList, r, !0, a, l, (() => h), d, s, o, !1), this._firstBarTime = s, this
          ._lastBarTime = o
      }
      update(e) {
    ...
    class f extends o.VolumeProfileBase {
      ...
      init(e, t) {
        ...
        i.getObjsContainer("hhists").push(new d.Container("histBars2", this._hists)),
          ...
          this._lastBarTime = t(4), this._vaVolumePercent = t(5), this.verifyRowSizeInput(this._rowSize, this
            ._rowsLayout), this._originalResolution = r.Interval.parse(e.symbol.interval + e.symbol.resolution);
        ...
        0 === this._firstBarTime && 0 === this._lastBarTime ? this._basicResolution = this._originalResolution :
          this._basicResolution = this.findBasicResolutionForFromTo(this._originalResolution, this._firstBarTime, n,
            (0, s.ensureDefined)(e.symbol.info)), this._hasSecondarySymbol = !this._originalResolution.isEqualTo(
            this._basicResolution), this._hasSecondarySymbol && e.new_sym(e.symbol.tickerid, this._basicResolution
            .value());
        ...
        this._vbPCheckHaveVolumeExpr = new p.VbPCheckHaveVolumeExpr(this), this._volumeByPriceExpr = new h((0, o
              .numOfSubHists)(this._volume), e, this, this._firstBarTime, n, this._hists, this._pocLines, this
      ...
      main(e, t, i) {
        this._hasSecondarySymbol && e.select_sym(1), this._timeSeries = e.new_unlimited_var(), this._openSeries = e
          .new_unlimited_var(), this._highSeries = e.new_unlimited_var(), this._lowSeries = e.new_unlimited_var(),
          this._closeSeries = e.new_unlimited_var(), this._volumeSeries = e.new_unlimited_var();
        const o = {
          type: "composite",
          data: []
        };
        if (i && i.period === this._basicResolution.value() && (this._timeSeries.set(g.Std.time(e)), this
            ._openSeries.set(g.Std.open(e)), this._highSeries.set(g.Std.high(e)), this._lowSeries.set(g.Std.low(e)),
            this._closeSeries.set(g.Std.close(e)), this._volumeSeries.set(g.Std.volume(e)), e.symbol.isFirstBar && e
            .symbol.isLastBar || (this._developingPocSeries.addHist(g.Std.time(e)), this._developingVAHighSeries
              .addHist(g.Std.time(e)), this._developingVALowSeries.addHist(g.Std.time(e))), this
            ._vbPCheckHaveVolumeExpr.update(0, e.symbol.isLastBar), this._volumeByPriceExpr.update(0), this
