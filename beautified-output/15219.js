    ...
    class m {
      ...
      updateStudyState(e, t, i) {
        ...
        for (const i of this._clientMigrations) {
          ...
          Object.keys(s).length === Object.keys(e.inputs).length ? e.inputs = s : u.logWarn(
      ...
      static patchPropsStateAndMetaInfo(e, t, i) {
        ...
        if (t.isTVScript && t.version < 60 && ("Script$TV_EARNINGS@tv-scripting" !== t.id &&
          ...
          .transparency && (e.styles.vol.transparency = e.transparency || 87),
          "PivotPointsStandard@tv-basicstudies" === t.id && (0 === o.inputs.length ? (e.inputs = {
            kind: "Traditional",
        ...
        if (t.version < 60) {
          const e = ["TV_DIVIDENDS", "TV_SPLITS", "TV_EARNINGS"],
            i = 6;
          for (let s = 0; s < e.length; s++) t.id.startsWith("Script$" + e[s] + "@tv-scripting") && (o.fullId =
