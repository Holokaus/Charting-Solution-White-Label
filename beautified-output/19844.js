...
19844: (e, t, i) => {
    ...
    class S {
      ...
      state() {
        const e = {};
        for (const [t, i] of Object.entries(this)) "useVersionFromMetaInfo" !== t && this.hasOwnProperty(t) && (e[t] =
          (0, o.default)(i), "id" === t && (e[t] += "-" + this.version));
        return e
      }
      symbolInputId() {
      ...
      isPlotForceOverlay(e) {
        ...
        return !!t?.forceOverlay || i && (0, l.isOhlcPlot)(i) && this.ohlcPlots?.[i.target]?.forceOverlay || !!this
          .ohlcPlots?.[e]?.forceOverlay
      }
      hasForceOverlayPlots() {
        return this.plots.some((e => this.isPlotForceOverlay(e.id))) || Object.values(this.ohlcPlots ?? {}).some((e =>
          !!e?.forceOverlay))
      }
      ...
      static isSourceInput(e) {
        return Boolean(e.id && (("source" === e.id || "src" === e.id) && ("text" === e.type || "source" === e.type) ||
          "source" === e.type))
      }
      ...
      static canBeChild(e) {
        ...
        if (!e) return !1;
        if (e.extra && !S.isAllowedSourceInputsCount(e.extra.sourceInputsCount) || !0 === e.canNotBeChild || !1 === e
          .canBeChild || _.has(e.id)) return !1;
        let t = 0;
      ...
      static getChildSourceInputTitles(e, t, i) {
        ...
        if (t.plots && t.plots.length && e.options && e.options.length)
          for (const o of e.options) {
            ...
            n && m.has(n.type) && (s[o] = t.styles && t.styles[n.id] && t.styles[n.id]?.title || n.id, i && (s[o] =
              i + ": " + s[o]))
          }
        return s
      }
      ...
      static parseIdString(e) {
        return function(e) {
          const t = {};
          if (-1 === e.indexOf("@")) t.shortId = e, t.packageId = "tv-basicstudies", t.id = e + "@" + t.packageId, t
            .version = 1;
          else {
            const i = e.split("@");
            t.shortId = i[0];
            const s = i[1].split("-");
            if (3 === s.length) t.packageId = s.slice(0, 2).join("-"), t.id = t.shortId + "@" + t.packageId, t
              .version = parseInt(s[2]);
            else if (1 === s.length && "decisionbar" === s[0]) t.packageId = "les-" + s[0], t.id = t.shortId + "@" +
              t.packageId, t.version = 1;
            else {
      ...
      static getPackageName(e) {
        const t = /^[^@]+@([^-]+-[^-]+)/.exec(e || "");
        t?.[1] || (0, a.getPersistentLogger)()?.addPersistentLogEntry(
          `getStudyPackageName: study id ${e} with stack ${(new Error).stack}`, r.LOGLEVEL.INFO,
          "chart.StudyMetaInfo");
      ...
      static getStudyIdWithLatestVersion(e, t) {
        ...
        let s = i;
        return i.indexOf("Portfolio@tv-scripting") >= 0 ? s += t ? "!" : "" : "ReplayStrategy@tv-scripting" === s ?
          s += "-581!" : i.indexOf("@tv-scripting") >= 0 ? s += "-101!" : i.endsWith("CP@tv-basicstudies") ? s +=
          "-" + Math.min(e.version, 207) : i.endsWith("CP@tv-chartpatterns") ? s += "-" + Math.min(e.version, 9) : i
          .endsWith("@tv-volumebyprice") || t ? s += "-" + e.version + "!" : s += "-" + e.version, s
      }
      static overrideDefaults(e) {
        0 !== e.length && (0, d.applyOverridesToStudyDefaults)(this.savedStudiesOverrides, e, (e => window.TradingView
          .defaultProperties[S.getStudyPropertyRootName(e)] || null))
      }
