...
78861: (e, t, i) => {
    ...
    function be() {
      ...
      M.setValue(m(e) ? e : "cursor"), M.subscribe((e => {
        ...
        (0, _.trackEvent)("Chart cursors", e), e && "performance" !== e && !f(e) && d.setValue(
          "chart.cursorPreference", e)
      })), S = new a.DefaultProperty({
        defaultName: "drawings"
      }), b = (0, r.createPrimitiveProperty)(!1), w = (0, r.createPrimitiveProperty)(!1), C = (0, r
        .createPrimitiveProperty)(!1), T = (0, r.createPrimitiveProperty)(!d.getBool("BarsMarksContainer.visibile", !
        0)), P = (0, r.createPrimitiveProperty)(!1), M.subscribe((e => {
