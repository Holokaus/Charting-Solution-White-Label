...
16659: (e, t, i) => {
    ...
    class r {
      constructor(e = 0, t = 1.3) {
        this._cache = new Map, this._lastItem = null, this._firstItem = null, this._size = e, this._sizeLimited = e >
      ...
      set(e, t) {
        ...
        return void 0 !== s && (n(s), s === this._firstItem && (this._firstItem = s.nextItem)), this._cache.set(e, i),
      ...
      delete(e) {
        ...
        return void 0 !== t && (n(t), t === this._lastItem && (this._lastItem = t.prevItem), t === this._firstItem &&
          (this._firstItem = t.nextItem)), this._cache.delete(e)
      }* entries() {
