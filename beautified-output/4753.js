      ...
      draw(e, t) {
        ...
        if (this._data.backgroundColor || this._data.borderColor) {
          ...
          if (this._data.backgroundRoundRect) {
            ...
            s && ((0, c.drawRoundRect)(e, _, m, p - _, g - m, o * n), e.closePath(), e.fillStyle = s, e.fill(), t && (
              e.restore(), t = !1)), i && ((0, c.drawRoundRect)(e, _ - v, m - v, p - _ + y, g - m + y, o * n + y), e
            ...
            s && (e.fillStyle = s, e.fillRect(_, m, p - _, g - m), t && (e.restore(), t = !1)), i && (e.strokeStyle =
              i, e.lineWidth = y, e.beginPath(), e.moveTo(_ - v, m - v), e.lineTo(_ - v, g + v), e.lineTo(p + v, g +
                v), e.lineTo(p + v, m - v), e.lineTo(_ - v, m - v), e.closePath(), e.stroke(), t && e.restore())
          }
        }
