...
45530: (e, t, i) => {
    ...
    class c extends a.PriceAxisView {
      ...
      _updateRendererData(e, t, i) {
        ...
        if (!(void 0 !== r && r.visible && r.visible.value() && r.showPrice && r.showPrice.value() && this
        ...
        i.background = h, i.textColor = this.generateTextColor(h), i.coordinate = s.priceToCoordinate(c, a), e
          .text = s.formatPrice(c, a, {
    ...
    async function _(e, t, i) {
      ...
      for (const r of n) {
        ...
        null !== n ? (s.push(n.regularPaneView), n.forceOverlayPaneView && o.push(n.forceOverlayPaneView)) : d.has(
          r) || h.logWarn(`${r} is not supported by this build of graphics subsystem, skipping`)
      }
      return {
        regularPaneViews: s,
