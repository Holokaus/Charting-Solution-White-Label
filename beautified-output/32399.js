    ...
    class h extends l.SeriesSingleLinePaneView {
      renderer() {
        ...
        const e = this._source.properties().childs(),
          t = e.style.value();
        let i, l = !1;
        2 === t ? i = e.lineStyle.childs() : 14 === t ? (i = e.lineWithMarkersStyle.childs(), l = !0) : 15 === t ?
          i = e.steplineStyle.childs() : 18 === t && (i = e.tpoStyle.childs());
        ...
        let _, p;
        if (_ = 15 === t ? new r.PaneRendererStepLine(u) : new n.PaneRendererLine(u), this._model.selection()
    ...
    class h {
      constructor(e, t) {
        this._bars = [], this._invalidated = !0, this._isMarkersEnabled = (0, o.enabled)("source_selection_markers"),
          this._selectionData = null, this._source = e, this._model = t, this._selectionIndexer = new n
