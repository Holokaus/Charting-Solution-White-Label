...
65045: (e, t, i) => {
    ...
    var logger = i(9343),
      o = i(38486),
      n = i(79603);
    const r = (0, logger.getLogger)("Chart.LineToolCollectedProperty");
    class a {
      applyValue(e, t) {
        e.setValue(t)
      }
    ...
    class l extends n.PropertyBase {
      ...
      value() {
        if (0 === this._properties.length) return r.logError(
    ...
    class c extends l {
      setValue(e, t, i) {
        if ("mixed" === e) return;
        const logger = i ?? new a;
        this._properties.forEach((t => logger.applyValue(t, e)))
      }
    }
    class h extends c {}
    class d extends c {
    ...
    class u extends l {
      setValue(e, t, i) {
        if ("mixed" === e) return;
        const logger = i ?? new a;
        this._properties.forEach((t => t.setValue(e, void 0, logger)))
      }
    }
    class _ extends u {}
    class p extends u {}