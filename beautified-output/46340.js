    ...
    class g {
      constructor(e, t) {
        this._isMarkersEnabled = (0, n.enabled)("source_selection_markers"), this._hlcAreaCache = new m, this
          ...
          ._renderer = new d.CompositeRenderer, this._invalidated = !0, this._source = e, this._model = t, this
          ._selectionIndexer = new a.SelectionIndexes(t.timeScale())
      }
      update() {
        this._invalidated = !0
      }
      ...
      _updateImpl() {
        ...
        for (let e = a; e < y; e++) {
          ...
          g)) && (p = i, m = s, g = o, this._highPoints.push(s), this._closePoints.push(i), this._lowPoints.push(o),
        ...
        t.pricesArrayToCoordinates(this._highPoints.data(), n, this._highPoints.length()), t.pricesArrayToCoordinates(
          this._closePoints.data(), n, this._closePoints.length()), t.pricesArrayToCoordinates(this._lowPoints
        .data(), n, this._lowPoints.length()), e.fillBarBorders(this._barsBorders.data(), {
          startItemIndex: 0,
        ...
        for (let e = 0; e < A; e++) {
          ...
          r && a && l && (C.addPoints1Point(n, i), C.addPoints2Point(n, t), P.addPoints1Point(n, t), P
            .addPoints2Point(n, s), x.push({
              y: i,
              ...o
            }), M.push({
              y: t,
