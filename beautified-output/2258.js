    ...
    class b extends c.PriceDataSource {
      constructor(e, t, i, s, o = null) {
        super(e), this._priceStep = .01, this._origState = null, this._descriptor = null, this._status = {
          ...
          ._alwaysShowInLegend = void 0 !== s, this._isOverlay = s, this._studyMetaInfo = o;
      ...
      titleInParts() {
        const e = [this._title];
        return this._showPineVersionInStatusLine.value() && e.push((0, n.ensureDefined)(this._studyMetaInfo?.pine)
          .version), e
      }
      inputsInParts() {
        return null
