...
67135: (e, t, i) => {
    ...
    class c extends n.DataSource {
      constructor(e, t) {
        super(t), this._formatterChanged = new r.Delegate, this._priceStepChanged = new r.Delegate, this
          ._currencyChanged = new r.Delegate, this._unitChanged = new r.Delegate, this._priceRangeReadyChanged =
          new r.Delegate, this._dataRangeUpdated = new r.Delegate, this._priceStep = null, this._signature = new o
          .WatchedValue(null), this._priceRangeReady = !0, this._model = e
      }
      base() {
        return 0
      }
      ...
      disablePriceRangeReady() {
        ...
        null === e || e.isAutoScale() || e.mainSource() !== this || (this._priceRangeReady = !1, e
          .recalculatePriceRangeOnce()), this._priceRangeReadyChanged.fire(!1)
      }
      statusView() {
        return null
      }
      ...
      _onIndexDiffsApplied(e) {
        const [t, i] = (0, assertionUtils.ensureNotNull)(this._plotsDataRange());
        let o = 1 / 0,
          n = -1 / 0;
