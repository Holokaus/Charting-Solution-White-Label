    ...
    function r(e, t, i) {
      ...
      if (r.lineNumber === l.lineNumber) {
        ...
        for (let s = r.lineNumber; s <= l.lineNumber; s += 1) {
          ...
          const p = a(_.text, u);
          let S, b, w = !1;
          "center" === e.textAlign ? (S = o ? r.x : f ? m + p / 2 : m - p / 2, b = d ? l.x : f ? m - p / 2 : m + p /
            2) : "right" === e.textAlign || f && "start" === e.textAlign || !f && "end" === e.textAlign ? (S = o ? r.x :
              h - p, b = d ? l.x : h, w = !0) : (S = o ? r.x : c, b = d ? l.x : c + p);
          let C = Math.min(S, b),
            T = Math.max(S, b);
