...
24062: (e, t, i) => {
    ...
    class n {
      ...
      shift(e) {
        (0, s.isNumber)(e) ? (this._maxValue += e, this._minValue += e) : o.logDebug(
      ...
      intersection(e) {
        return this.containPrice(e.minValue()) || this.containPrice(e.maxValue()) || e.containPrice(this._minValue) ?
          new n(Math.max(this._minValue, e.minValue()), Math.min(this._maxValue, e.maxValue())) : null
      }
      static compare(e, t) {
