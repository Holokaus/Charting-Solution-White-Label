    ...
    class W {
      ...
      finish(e) {
        ...
        return s = t, (i = e).length !== s.length ? {
          ...
          const o = s[i];
          return e.indexesChanged = e.indexesChanged || t.index !== o.index, e.pricesChanged = e
    ...
    class U extends P.DataSource {
      constructor(e, t, i, s) {
        if (super(s), this.isLineTool = !0, this.version = 1, this.toolname = "", this.customization = {
          ...
          .hasChild("interval") || this._properties.addChild("interval", new C.Property(e.mainSeries().interval())),
        ...
        this._properties.childs().visible.subscribe(this, (e => {
            ...
            e.value() ? e.value() && t && a.emit("drawing_event", this._id.value(), "show") : (this._model
              .selection().isSelected(this) && this._model.selectionMacro((e => {
          ...
          this._model.chartApi().isConnected().spawn(), this._sessionConnected.subscribe((e => {
      ...
      endMoving(e, t, i) {
        ...
        .id())), r) : (s && this._points.forEach((e => e.interval = this._model.mainSeries().interval())), this
      ...
      endChanging(e, t, i) {
        ...
        s.indexesChanged && this._changeStatesStack.isEmpty() ? (this._normalizePoints(), t || this
          ...
          a.emit("drawing_event", this._id.value(), "points_changed"), this._updateAdjustedToSplitTimeValue();
      ...
      calcIsActualInterval() {
        ...
        this._isActualInterval = (0, y.isActualInterval)(w.Interval.parse(i.interval()), t.childs()
          ...
          ._model.selectionMacro((e => e.removeSourceFromSelection(this))), this._isActualInterval !== e && this
      ...
      setOwnerSource(e) {
        if (null !== this._ownerSource && (this._ownerSource.currencyChanged().unsubscribeAll(this), this
          ...
          this._symbolSourceSymbolInfo = (0,
              ...
              ._boundCalcIsActualSymbol), this.setPriceScale(e.priceScale()), e.currencyChanged().subscribe(this,
              this.calcIsActualCurrency), e.unitChanged().subscribe(this, this.calcIsActualUnit), this
            .calcIsActualSymbol(), this._migrateZOrder(), this._updateAlertCreationAvailable()
        }(0, I.isSymbolSource)(e) && (e.symbolResolved().subscribe(this, this._boundCalcIsActualSymbol), e
      ...
      state(e) {
        ...
        return s.isSelectionEnabled = this.isSelectionEnabled(), s.userEditEnabled = this.userEditEnabled(), this
          .linkKey().value() && (s.linkKey = this.linkKey().value()), delete s.state.points, e && (s.indexes = this
            ._points), this.isFixed() && (s.positionPercents = this._positionPercents || this
          .calcPositionPercents()), "version" in this && 1 !== this.version && (s.version = this.version), s
      }
      updateAllViews(e) {
      ...
      restoreExternalPoints(e, t) {
        try {
          if (this._timePoint = (0, p.deepCopy)(e.points), t.indexesChanged) {
            if (this.properties().childs().interval.setValue(e.interval), !this.isActualSymbol()) return void this
              ._clearServerPoints();
            this.createServerPoints()
          } else {
      ...
      applyTemplate(e) {
        this._onTemplateApplying.fire(e), this._applyTemplateImpl(e), this.calcIsActualSymbol(), this
      ...
      createServerPoints() {
        ...
        this._model.chartApi().createPointset(this._currentPointsetIdWithPrefix(), "turnaround", this
          ._currentPointsetAndSymbolId.symbolId, t, e, this.onData.bind(this))
      }
      finish() {}
      realign() {
      ...
      enableCurrentIntervalVisibility() {
        ...
        void 0 !== e && (e = (0, y.mergeIntervalVisibilitiesDefaults)(e), (0, y
            .makeIntervalsVisibilitiesVisibleAtInterval)(e, this._model.mainSeries().intervalObj().value()), this
          .properties().childs().intervalsVisibilities.mergeAndFire(e))
      }
      clonePositionOffset() {
        return this.isFixed() ? {
          barOffset: 0,
      ...
      _migrateZOrder() {
        ...
        e.zOrderVersion.value() < 2 && (this.ownerSource() === this.model().mainSeries() && this.setZorder(this
          .zorder() - this.model().mainSeries().obsoleteZOrder()), e.zOrderVersion.setValueSilently(2))
      }
      _preparePoint(e, t) {
        const i = e;
      ...
      _updateSignaturesPaneViews() {
        ...
        if (null !== e || 0 !== this._signaturesPaneViews.size) {
          for (const [t, i] of this._signaturesPaneViews) t.signature().value() !== e && (i.forEach((e => e.destroy
      ...
      static _configureProperties(e) {
        if (this._addCollectedProperties(e), e.hasChild("symbolStateVersion") || e.addProperty("symbolStateVersion",
          ...
          e.hasChild("frozen") || e.addProperty("frozen", !1), e.hasChild("symbol") || e.addProperty("symbol", ""),
          e.hasChild("currencyId") || e.addProperty("currencyId", null), e.hasChild("unitId") || e.addProperty(
            "unitId", null), e.hasChild("adjustedToSplitTime") || e.addProperty("adjustedToSplitTime", null), e
          .hasChild("intervalsVisibilities")) {
          const t = (0, r.merge)((0, r.clone)(v.intervalsVisibilitiesDefaults), e.childs().intervalsVisibilities
            .state());
        ...
        ].forEach((t => e.addExcludedKey(t, 5))), e.hasChild("singleChartOnly") && e.removeProperty(
          "singleChartOnly"), e.hasChild("font") && e.removeProperty("font")
      }
      static _addCollectedProperties(e) {
        e.hasChild("linewidth") && e.addChild("linesWidths", new B.LineToolWidthsProperty([(0, n.ensureDefined)(e
            ...
            .LineToolColorsProperty([(0, n.ensureDefined)(e.child("linecolor"))])), e.hasChild("backgroundColor") &&
          e.addChild("backgroundsColors", new B.LineToolColorsProperty([(0, n.ensureDefined)(e.child(
            "backgroundColor"))])), e.hasChild("textColor") && e.addChild("textsColors", new B
            .LineToolColorsProperty([(0, n.ensureDefined)(e.child("textColor"))])), e.hasChild("linestyle") && e
          .addChild("linesStyles", new B.LineToolCollectedProperty([(0, n.ensureDefined)(e.child("linestyle"))])), [
