...
29970: (e, t, i) => {
    ...
    function a(e, t) {
      const [i, s, o] = e, [n, a, l] = t, c = (Math.sqrt(s ** 2 + o ** 2) + Math.sqrt(a ** 2 + l ** 2)) / 2, h = .5 * (
          1 - Math.sqrt(Math.pow(c, 7) / (Math.pow(c, 7) + 6103515625))), d = (1 + h) * s, u = (1 + h) * a, _ = Math
        .sqrt(d * d + o * o), p = Math.sqrt(u * u + l * l), m = 0 === o && 0 === d ? 0 : r(Math.atan2(o, d)), g = 0 ===
        l && 0 === u ? 0 : r(Math.atan2(l, u)), f = n - i, y = p - _;
      let v;
      const S = _ * p;
      ...
      e[e.Pow25In7 = 6103515625] = "Pow25In7", e[e.LWeight = 1] = "LWeight", e[e.CWeight = 1] = "CWeight", e[e.HWeight =
        1] = "HWeight"
    }(s || (s = {}));
    const l = [127, 127, 127];
    ...
    function p(e) {
      const [t, i, s] = e, o = t / 255, n = i / 255, r = s / 255, a = 100 * (o > .04045 ? Math.pow((o + .055) / 1.055,
        2.4) : o / 12.92), l = 100 * (n > .04045 ? Math.pow((n + .055) / 1.055, 2.4) : n / 12.92), c = 100 * (r >
    ...
    function g(e) {
      const [t, i, s] = e, o = t / 95.047, n = i / 100, r = s / 108.883, a = o > .008856 ? Math.pow(o, 1 / 3) : 7.787 *
        o + 16 / 116, l = n > .008856 ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116;
