...
78176: (e, t, i) => {
    ...
    function M(e, t, i, n) {
      ...
      return t.startsWith("study_") && l.inputs && delete l.inputs.symbol, "linetoolicon" === t && e && (l.icon = (0, w
          .defaults)(t).icon), "linetooemoji" === t && e && (l.emoji = (0, w.defaults)(t).emoji), "linetoolsticker" ===
        t && e && (l.sticker = (0, w.defaults)(t).sticker), l = (0, s.default)(l), x(l, i), (0, o.default)(a, l), a
    }
    let I = !1;
    ...
    class F extends C.Property {
      constructor(e) {
        ...
        super(void 0, x), this._themedColors = [], this._restoreFactoryDefaultsEvent = new S.Delegate, this
          ...
          ._excludedStateKeys = c, this._nonThemedDefaultsKeys = i, this._themedDefaultsKeys = s, this
          ._allDefaultsKeys = i || s ? [...i ?? [], ...s ?? []] : void 0, this._excludedDefaultsKeys = n, this
      ...
      restoreFactoryDefaults() {
        ...
        x(e, this._excludedDefaultsKeys), this.mergeAndFire(e), this._defaultName.startsWith("study_") && !this
      ...
      saveDefaults() {
        ...
        if (this._saveNonDefaultUserPreferencesOnly) {
          ...
          if (e = R(E(t, this._nonThemedDefaultsKeys), E(i, this._nonThemedDefaultsKeys, this
      ...
      _userSettings() {
        ...
        if (!e) return;
        return E((0, b.extractStateWithSchema)(e, this._schema, 1), this._allDefaultsKeys, this
      ...
      _fireMergeAndFireChangedProps(e) {
        this._forbidSavingDefaults = !0, super._fireMergeAndFireChangedProps(e), this._forbidSavingDefaults = !1, e
          .some((e => this._propertyAffectsDefaults(e.pathToRootProperty()))) && this.saveDefaults()
      }
      ...
      _propertyAffectsDefaults(e) {
        return (this._ignoreAllowSavingDefaults || I) && !this._defaultName.startsWith("replayStudyStrategy") && (!
          ...
          ._allDefaultsKeys && this._allDefaultsKeys.includes(e) || !this._allDefaultsKeys && !this
          ._excludedDefaultsKeys?.includes(e)) && (0, C.isPrimitiveType)(this.childByPath(e)?.value())
      }
    }