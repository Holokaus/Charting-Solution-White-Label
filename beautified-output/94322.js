...
94322: (e, t, i) => {
    ...
    function p() {
      ...
      if (r.activePointSelectionMode.value() === r.SelectPointMode.Replay) t = i = !1;
        ...
        t = e && ((0, a.isLineToolName)(s) || r.isToolEditingNow.value() || (0, r.toolIsMeasure)(s) || o), i = (0, r
          .properties)().childs().magnet.value()
      }
      h.setValue(!i && t ? n.MagnetMode.StrongMagnet : (0, r.properties)().childs().magnetMode.value()), c.setValue(t ?
        !i : i)
    }
    ...
    function S(e) {
      (0, s.allowSavingDefaults)(!0), (0, r.properties)().childs().magnetMode.setValue(e), (0, r.properties)().childs()
        .magnet.setValue(!0), (0, s.allowSavingDefaults)(!1)
    }

    function b(e) {
      (0, s.allowSavingDefaults)(!0), (0, r.properties)().childs().magnetSnapsToIndicators.setValue(e), (0, s
        .allowSavingDefaults)(!1)
    }(0, r.runOnDrawingStateReady)((() => {
      (0, r.properties)().childs().magnet.subscribe(null, p), (0, r.properties)().childs().magnetMode.subscribe(
          null, p), (0, r.properties)().childs().magnetSnapsToIndicators.subscribe(null, m), u.subscribe(p), _
        .subscribe(p), r.tool.subscribe(p), r.isToolEditingNow.subscribe(p), p(), m()
    }))