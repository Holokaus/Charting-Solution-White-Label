    ...
    class h extends l.PaneRendererSeriesBase {
      constructor(e) {
        super(), this._scaleCoeff = 1, this._borderVisible = !1, this._wickVisible = !1, this._bodyVisible = !0,
          ...
          ._isPriceScaleInverted = !1, e && this.setData(e)
      }
      setData(e) {
        this._bars = e.bars, this._scaleCoeff = e.scaleCoeff ?? 1, this._borderVisible = e.borderVisible, this
          ._bodyVisible = e.bodyVisible, this._wickVisible = e.wickVisible, this._borderColor = e.borderColor, this
          ._wickColor = e.wickColor, this._hittest = e.hittest, this._isPriceScaleInverted = e.isPriceScaleInverted
      }
      hitTest(e) {
      ...
      _drawWicks(e, t) {
        ...
        this._bars.forEach(((n, r) => {
          ...
          h <= d && (l !== _ && (l = Math.round(l - .5 * d)), c = c !== p ? Math.round(l - .5 * d) + d - 1 :
              p - 1), l !== _ && e.fillRect(f, _, v, l - _), p - c - 1 && e.fillRect(f, c + 1, v, p - c - 1),
            s = y
        }))
      }
      _drawBorder(e, t) {
        ...
        this._bars.forEach(((n, a) => {
          if (n.borderColor !== i && (e.fillStyle = n.borderColor ? n.borderColor : (0, o.ensureDefined)(this
          ...
          const p = u - l + 1;
          c <= _ ? e.fillRect(l, Math.round(h - .5 * _), p, _) : p > 2 * _ ? (0, r.fillRectInnerBorder)(e, l,
            h, u - l + 1, d - h + 1, _) : e.fillRect(l, h, p, d - h + 1), s = u
        }))
      }
      _drawCandles(e, t) {
        let i = "";
        this._bars.forEach(((s, o) => {
          ...
          if (!(this._borderVisible && u <= 2 * d) || s.hollow) {
            ...
            if (s.hollow) e.fillStyle = s.color, h <= d ? e.fillRect(l, Math.round(n - .5 * d), u, d) : (0, r
              .fillRectInnerBorder)(e, l, n, c - l + 1, a - n + 1, d);
            else {
