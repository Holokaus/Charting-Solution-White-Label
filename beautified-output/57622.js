...
57622: (e, t, i) => {
    ...
    function o(e, t, i) {
      ...
      return 0 === e.length || (function(e, t) {
        ...
        t.slope = (e.length * n - i * s) / (e.length * o - i * i), t.average = s / e.length, t.intercept = t
          .average - t.slope * i / e.length + t.slope
        ...
        o.stdDev = Math.sqrt(a / (0 === u ? 1 : u)), o.pearsons = s.Std.isZero(l) || s.Std.isZero(c) ? 0 : h / Math
    ...
    const n = {
      ...
      constructor: class {
        ...
        _updateData(e, t, i, s, o, n, r, a) {
          ...
          this._data.downLine.startPrice = h, this._data.downLine.endPrice = h + a.slope * l, this._data
            .pearsons = a.pearsons, this._data.startIndex__t = n, this._data.endIndex__t = r
        }
      }
    }