    ...
    class o {
      constructor(e, t, i, o, n) {
        this._onChange = new delegate.Delegate, this._handleChange = () => {
          ...
          }, this._crossTabEvents = e, this._jsonKeyValueStore = t, this.CROSSTAB_EVENT_NAME = i, this
          .JSON_STORE_KEY = o, this.defaultStoreValue = this._serialize(n), this._subscribe()
      }
      get() {
      ...
      set(e, t) {
        ...
        this._jsonKeyValueStore.setJSON(this.JSON_STORE_KEY, i, t), this._crossTabEvents.emit(this
          .CROSSTAB_EVENT_NAME), this._onChange.fire(e)
      }
      getOnChange() {
