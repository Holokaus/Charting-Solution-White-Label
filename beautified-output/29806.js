...
29806: (e, t, i) => {
    ...
    async function n(e) {
      ...
      if (!(0, s.isObject)(t) || "function" == typeof t) throw new Error(
      ...
      return (0, s.hasProperty)(t, "data") && (i.data = t.data), (0, s.hasProperty)(t, "graphicsCmds") && (i
        .graphicsCmds = function(e) {
          ...
          if ((0, s.hasProperty)(e, "create"), (0, s.hasProperty)(e, "erase")) {
            ...
            for (const e of t) {
              if (!(0, s.isObject)(e) || !(0, s.hasProperty)(e, "action")) throw new Error(
                "Command should be an object with 'action' property");
              (0, o.assert)("all" === e.action || "one" === e.action,
