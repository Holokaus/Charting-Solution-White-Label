...
3885: (e, t, i) => {
    ...
    function x(e, t, i, s, o) {
      ...
      e[e.Open = 0] = "Open", e[e.High = 1] = "High", e[e.Low = 2] = "Low", e[e.Close = 3] = "Close", e[e.Source = 4] =
        "Source", e[e.LastPrice = 5] = "LastPrice", e[e.Change = 6] = "Change", e[e.Volume = 7] = "Volume", e[e
    ...
    class M {
      ...
      getValues(e) {
        ...
        if (t) i[5].value = null == y ? f.notAvailable : M(y), i[5].visible = !0, I = this._getChangeColor(S?.change,
          ...
          i[0].visible = !t && s, i[1].visible = !t, i[2].visible = !t, i[8].visible = void 0 !== T || v, i[6]
            .visible = void 0 !== S;
      ...
      _getChangeColor(e, t) {
        ...
        const s = void 0 === e || e >= 0 ? _.SeriesBarColorer.upColor(this._series.properties()) : _.SeriesBarColorer
