...
4249: (e, t, i) => {
    ...
    class l extends a.SeriesSingleLinePaneView {
      renderer() {
        ...
        return l.append(new o.PaneRendererArea(a)), this._model.selection().isSelected(this._source) && this
          ._isMarkersEnabled && this._selectionData && l.append(new r.SelectionRenderer(this._selectionData)), l
      }
    }