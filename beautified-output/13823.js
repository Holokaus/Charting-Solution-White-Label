...
13823: (e, t, i) => {
    ...
    class r {
      constructor(e, t) {
        this._minTick = NaN, this._minPrice = NaN, this._maxPrice = NaN, this._low = NaN, this._high = NaN, this
          ._startPrice = NaN, this._indexLowVbP = NaN, this._indexHighVbP = NaN, this._rowSize = e, this._type = t
      }
      init(e, t, i, s, o) {
    ...
    function _(e) {
      ...
      e.VolumeUpDown = "Up/Down", e.VolumeTotal = "Total", e.VolumeDelta = "Delta", e.NumberOfRows = "Number Of Rows", e
    ...
    class p {
      findBasicResolutionForFromTo(e, t, i, s) {
        ...
        return o.enabled("charting_library_debug_mode") && console.log(
          `${(new Date).toISOString()} Selected resolution ${a.value()} for (${e.value()}, ${t}, ${i})`), a
      }
