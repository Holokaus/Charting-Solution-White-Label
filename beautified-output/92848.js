    ...
    function l(e, t) {
      if (1 === t.length && (0, n.isStudy)(t[0])) {
        ...
        return {
          ...
          sources: [{
            source: (0, assertionUtils.ensureNotNull)(e.state()),
            type: "study"
          }]
        }
      }
      ...
      })), i.sources.length > 0 ? (1 === i.sources.length ? i.title = t[0].title(o.TitleDisplayTarget.StatusLine) : i
        .title = "Drawings", i) : null
    }