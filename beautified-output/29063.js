...
29063: (e, t, i) => {
    ...
    function l(e, t = "x") {
      let i = !1;
      return "x" !== t && "both" !== t || (i = i || e.offsetWidth < e.scrollWidth), "y" !== t && "both" !== t || (i =
        i || e.offsetHeight < e.scrollHeight), i
    }
    ...
    function h(e) {
      let t = "x";
      return e.matches(".apply-overflow-tooltip--direction_both") ? t = "both" : e.matches(
    ...
    function d(e) {
      ...
      const s = Array.from(e.childNodes).reduce(((e, t) => (t.nodeType === Node.TEXT_NODE && e.push(t.textContent ||
        ""), e)), []).join("").trim();
      return s ? {
        type: "text",
        data: s
    ...
    const b = (e = document.documentElement, t) => document.createTreeWalker(e, NodeFilter.SHOW_ELEMENT, (e => t => {
      ...
      const i = t;
      return (0, S.isInertRoot)(i) ? NodeFilter.FILTER_REJECT : (0, S.isVisibilityVisible)(i) && i.matches(e) ?
    ...
    class T {
      constructor() {
        this._handleMouseDown = () => {
          ...
          this._forwardTab = void 0, [9, y.Modifiers.Shift + 9].includes((0, y.hashFromEvent)(e)) && (this
            ._forwardTab = !e.shiftKey)
        }, this._handleFocus = e => {
          const t = e.target;
    ...
    function L(e) {
      window.TVSettings && window.TVSettings.sync(window.user.settings), window.is_authenticated ? (e || (
        ...
        .profile_data_filled && ((0, o.trackEvent)("Conversion", "First login"), delete window.user
          .profile_data_filled)) : availableOffersWrapper.runOrUpdate((e => {
    ...
    A = window.loginStateChange ? window.loginStateChange : window.loginStateChange = new p.Delegate, A.subscribe(null,
      L), s.TVXWindowEvents.on("loginStateChange", (e => {
