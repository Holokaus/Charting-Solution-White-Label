...
52746: (e, t, i) => {
    ...
    function(e) {
      e[e.Time = 0] = "Time", e[e.Open = 1] = "Open", e[e.High = 2] = "High", e[e.Low = 3] = "Low", e[e.Close = 4] =
        "Close", e[e.Volume = 5] = "Volume", e[e.Adt = 6] = "Adt"
    }(o || (o = {}));
    const l = ["open", "high", "low", "close", "hl2", "hlc3", "ohlc4"];
    var c;
    ! function(e) {
      e[e.FirstPrice = 0] = "FirstPrice", e[e.LastPrice = 1] = "LastPrice", e[e.LastValuePrice = 2] = "LastValuePrice"
    }(c || (c = {}));
    const h = {
      open: e => e[1],
      high: e => e[2],
    ...
    class p {
      constructor() {
        this.m_bars = new r.PlotList(d(), _), this.m_nsBars = new r.PlotList(d(), _), this._conflatedChunksBuilder =
          new a.ConflatedChunksBuilder(this.m_bars, (e => h[e]))
      }
      bars() {
        return this.m_bars
      }
      ...
      clone() {
        const e = new p;
        return e.lastProjectionPrice = this.lastProjectionPrice, e.boxSize = this.boxSize, e.reversalAmount = this
          .reversalAmount, e.m_bars = this.m_bars.clone(), e.m_nsBars = this.m_bars.clone(), e
      }
      isEmpty() {
      ...
      search(e, t, i) {
        return this.nsBars().isEmpty() ? this.bars().search(e, t, i) : this.bars().isEmpty() || (0, n.ensureNotNull)(
          this.nsBars().firstIndex()) <= e ? this.nsBars().search(e, t, i) : this.bars().search(e, t, i)
      }
      valueAt(e) {
      ...
      plotValueToTimePointIndex(e, t, i) {
        if (i === s.FromRight) {
          ...
          return null !== o ? o.index : this.m_bars.firstIndex()
        }
        if (i === s.FromLeft) {
          const i = (i, s) => {
              const o = s[t];
          ...
          return null !== o ? o.index : this.m_bars.lastIndex()
        }
