...
51101: (e, t, i) => {
    ...
    class p extends r.BarBuilderBase {
      constructor(e, t, i, s, o = !1) {
        super(), this._periodStart = -Number.MAX_VALUE, this._periodEnd = -Number.MAX_VALUE, this
          ...
          ._periodEndDay = new h.BusinessDay(0, 0, 0), this._period = i, this._sessionTgt = e, this._builder = s,
      ...
      endOfBar(e) {
        return e === a.SessionStage.LAST_SESSION_END ? this._getZonedDateTimeOfBorder(a.SessionStage
    ...
    class b {
      ...
      startOfPeriod(e, t) {
        ...
        const i = (0, s.get_cal)(d, t, s.JANUARY, 1),
          o = m(this._spec, i),
          n = 0 === o ? 7 * e : 7 * (e + 1) - o;
        return n > (0, s.days_per_year)((0, s.get_year)(i)) ? this.startOfPeriod(0, t + 1) : ((0, s.add_date)(i, n),
          i)
      }
    }
    class w {
      ...
      _calculateBarWeekStart(e, t, i, o) {
        ...
        if (this.indexOfPeriod((0, c.ensureNotNull)(r.getStartDay())) === o) return (0, s.clone)((0, c.ensureNotNull)(
          r.getStartDay()));
        const a = this._spec.getHistoryByIndex(n.entryIndex - 1).getEntries().firstDayOfWeek() - (0, s
            .get_day_of_week)(e),
          l = (0, s.clone)(e);
      ...
      _getYearStartDataFromWeek(e, t, i) {
        ...
        if (null !== a) {
          ...
          if (e >= 0) n = (0, s.clone)(i), (0, s.add_date)(n, e), r = 2;
            ...
            e = t.getEntries().firstDayOfWeek() - o, e >= 0 && (n = t.getStartDay(), n && (n = (0, s.clone)(n)), r =
              1)
          }
        } else {
      ...
      _positionInsideWeekWithSeveralBars(e, t) {
        ...
        return i = this._spec.getHistoryByIndex(e.entryIndex - 1).getEntries().firstDayOfWeek() - t, i <= 0 ? w
    ...
    function M(e, t, i, s = !1) {
      const n = o.Interval.parse(e),
        r = n.multiplier();
      return n.isMinutes() ? l.minutes(r, t) : n.isSeconds() ? l.seconds(r, t) : n.isTicks() ? new l(1, t) : n
      .isRange() ? new l(60 * r, t) : new p(t, i ?? null, r, function(e, t) {
          switch (e) {
