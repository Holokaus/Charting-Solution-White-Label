...
54405: (e, t, i) => {
    ...
    class l extends a.SeriesCandlesPaneView {
      renderer() {
        ...
        return l.append(new r.PaneRendererCandles(a)), this._model.selection().isSelected(this._source) && this
          ._isMarkersEnabled && this._selectionData && l.append(new n.SelectionRenderer(this._selectionData)), l
      }
    }