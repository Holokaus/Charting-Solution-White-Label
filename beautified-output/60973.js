...
60973: (e, t, i) => {
    ...
    var ke = function(e) {
      ...
      if (void 0 === TradingView.defaultProperties) {
        ...
        TradingView.defaultProperties = {
          ...
          linetoolganncomplex: {
            ...
            fanlines: [ke(O, !1, w, 8, 1), ke(J, !1, w, 5, 1), ke(Pe, !1, w, 4, 1), ke(ye, !1, w, 3, 1), ke(z, !0,
              w, 2, 1), ke(me, !0, w, 1, 1), ke(ue, !0, w, 1, 2), ke(ue, !1, w, 1, 3), ke(D, !1, w, 1, 4), ke(F,
              !1, w, 1, 5), ke(O, !1, w, 1, 8)],
            arcs: [ke(ye, !0, w, 1, 0), ke(ye, !0, w, 1, 1), ke(ye, !0, w, 1.5, 0), ke(z, !0, w, 2, 0), ke(z, !0, w,
              2, 1), ke(me, !0, w, 3, 0), ke(me, !0, w, 3, 1), ke(ue, !0, w, 4, 0), ke(ue, !0, w, 4, 1), ke(D, !
              0, w, 5, 0), ke(D, !0, w, 5, 1)]
          },
          linetoolgannfixed: {
            fillBackground: !1,
            arcsBackground: {
      ...
      void 0 === TradingView.defaultProperties["study_TPOPeriodic@tv-volumebyprice"] && (TradingView
        .defaultProperties["study_TPOPeriodic@tv-volumebyprice"] = Ne), void 0 === TradingView.defaultProperties[
        ...
        "study_VbPVisible@tv-volumebyprice"] && (TradingView.defaultProperties[
        "study_VbPVisible@tv-volumebyprice"] = Oe(!1));
      const Fe = {
        styles: {
          developingPoc: {
            color: ""
      ...
      if (void 0 === TradingView.defaultProperties["study_VbPFixed@tv-volumebyprice"] && (TradingView
          .defaultProperties["study_VbPFixed@tv-volumebyprice"] = Fe), void 0 === TradingView.defaultProperties[
      ...
      if (s)
        for (var n in s) {
          var r = n.split("."),
            a = c(r[0]),
            l = void 0 !== o && o === r[0];
          0 !== r.length && l && (a = c((r = r.slice(1))[0])), 0 !== r.length && e.hasOwnProperty(a) ? h(e, r, s[n]) ||
            d(n) : l && d(n)
        }
