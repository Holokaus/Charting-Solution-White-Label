...
86821: (e, t, i) => {
    ...
    r.prototype.addMigration = function(e, t, i) {
      var s = o.parse(e),
        n = o.parse(t);
      s.isGreater(this._maxFromVers) && (this._maxFromVers = s), n.isGreater(this._maxToVers) && (this._maxToVers =
        n), this._migrs.push({
          fromVers: s,
          toVers: n,
          rules: i
      ...
      for (var o = s(i), r = e; r.isLess(t);) {
        ...
        if (null == a) break;
        if (n.logNormal("Migrating study inputs from " + a.fromVers + " to " + a.toVers + " version, studyId: " + this
      ...
      return r > e && n.logNormal("Study inputs migration is done, studyId: " + this._studyId + ", inputs: " + JSON
        .stringify(o)), o
      ...
      var i = e[t.inputId];
      if ("resetToDefVal" === t.action) return e[t.inputId] = t.defVal, n.logNormal("Input " + t.inputId + "=" + i +
      ...
      if ("convertVal" === t.action) {
        ...
        if ("float" === t.inputTypeFrom && "integer" === t.inputType) return e[t.inputId] = Math.round(e[t.inputId]),
          n.logNormal("Input " + t.inputId + "=" + i + " converted to value " + e[t.inputId]), e;
      ...
      if ("adjustValIfNeeded" !== t.action) throw new Error("Unknown action " + t.action + " for rule with type " + t
        .type);
      var i = e[t.inputId];
      return i < t.minVal ? e[t.inputId] = t.minVal : i > t.maxVal && (e[t.inputId] = t.maxVal), n.logNormal(
      ...
      var i = e[t.inputId];
      return t.options.indexOf(i) < 0 && (e[t.inputId] = t.defVal, n.logNormal("Input " + t.inputId + "=" + i +
        " reset to default value " + t.defVal)), e
    }, e.exports = r