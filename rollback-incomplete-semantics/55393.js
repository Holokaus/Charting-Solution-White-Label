...
55393: (watchedValue_e, watchedValue_t, i) => {
    "use strict";
    i.d(watchedValue_t, {
      LineToolBrushBase: () => r
    });
      ...
      addPoint(watchedValue_e, watchedValue_t, i) {
        ...
        if (this._lastPoint = null, this._points.length > 0) {
          const watchedValue_t = this._points[this._points.length - 1],
            i = (0, watchedValue_s.ensureNotNull)(this.pointToScreenPoint(watchedValue_t));
          if ((0,
              watchedValue_s.ensureNotNull)(this.pointToScreenPoint(watchedValue_e)).subtract(i).length() < 2) return this._finished
        }
        return super.addPoint(watchedValue_e), this._finished
      }
      restorePoints(watchedValue_e, watchedValue_t, i) {
        super.restorePoints(watchedValue_e, watchedValue_t, i), this._finished = !0
      }
    }